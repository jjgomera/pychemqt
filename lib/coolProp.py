...
class CoolProp(object):
    """Clase que define una corriente mediante CoolProp"""
    kwargs = {"fluido": None,
              "fraccion": [1],
    ...
    def calculable(self):
        ...
        if self.kwargs["T"] and self.kwargs["P"]:
            ...
            self._thermo=u"TQ"
        elif self.kwargs["P"] and self.kwargs["x"]!=None:
            self._thermo=u"PQ"
