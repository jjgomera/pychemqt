...
############################################################
########     Funciones de cálculo de los parámetros de las ecuaciones de estado   ########
############################################################
import os

from scipy import exp, log, log10, tan, sin, sinh, cosh, tanh, arctan, arccos, roots, sqrt, r_
from scipy.constants import pi, Avogadro, epsilon_0, R
from scipy.optimize import fsolve

import unidades, compuestos, config
...
def virial_B_Tsonopoulos(componente, T):
    ...
    f2=1/Tr**6
    f3=-1/Tr**8
    f=f0+componente.f_acent*f2+a*f2+b*f3
    return f*R_atm*componente.Tc/componente.Pc.atm
    
def virial_C_Orbey_vera(componente, T):
    Tr=T/componente.Tc
    g0=0.01407+0.02432/Tr**2.8-0.00313/Tr**10.5
    g1=-0.02676+0.01770/Tr**2.8+0.04/Tr**3-0.003/Tr**6-0.00228/Tr**10.5
    g=g0+componente.f_acent*g1
    return g*R_atm*componente.Tc/componente.Pc.atm
