...
class R1234yf(MEoS):
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.74697e1, 0.27915e1, -0.21312e1, -0.29531e1], "exp": [1.0, 1.5, 1.8, 3.8]}
#    _liquid_Density={ "eq": 1, "ao": [0.19083e1, -0.21383e1, 0.93653e1, -0.98659e1, 0.35859e1], "exp": [0.32, 0.56, 0.8, 1.0, 1.3]}
#    _vapor_Density={ "eq": 3, "ao": [-0.23511e1, -0.11515e2, -0.53984e1, -0.37937e2], "exp": [0.355, 2.45, 1.0, 5.1]}
    ...
    thermo0={"eq": 1,
                ...
                "nb": [0.223071e-2, -0.278314e-1, 0.149657e-1, 0.0, -0.252976e-3, 0.0, 0.188873e-1, -0.608795e-2, 0.0, 0.0],
