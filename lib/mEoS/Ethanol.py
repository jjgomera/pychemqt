...
class Ethanol(MEoS):
    """Ecuación de estado de multiparametros para el etanol
    ...
    helmholtz1={
        ...
        "nr1":  [0.114008942201e2, -0.395227128302e2, 0.413063408370e2, -0.188892923721e2, 0.472310314140e1, -0.778322827052e-2 , 0.171707850032, -0.153758307602e1, 0.142405508571e1, 0.132732097050, -0.114231649761, 0.327686088736e-5, 0.495699527725e-3, -0.701090149558e-4, -0.225019381648e-5],
        "d1": [1, 1, 1, 1, 1, 1, 2, 2, 2, 3, 3, 6, 7, 8, 8],
        "t1": [-0.5, 0, 0.5, 1.5, 2, 5, -0.5, 1, 2, 0, 2.5, 6, 2, 2, 4],

        "nr2": [-0.255406026981, -0.632036870646e-1, -0.314882729522e-1, 0.256187828185e-1, -0.308694499382e-1, 0.722046283076e-2, 0.299286406225e-2, 0.972795913095e-3],
        "d2": [1, 3, 3, 6, 7, 8, 2, 7],
    ...
    helmholtz2={
        ...
        "nr1":  [-2.95455387, 1.95055493, -1.31612955, -1.47547651e-2, 1.39251945e-4, 5.04178939e-1],
        "d1": [1, 1, 1, 3, 7, 2],
        "t1": [1.5, 0.25, 1.25, 0.25, 0.875, 1.375],

        "nr2": [2.52310166e-1, 1.97074652, 8.73146115e-1, 4.27767205e-2, 9.68966545e-2, -8.39632113e-1, -7.71828521e-2, 1.63430744e-2],
        "d2": [1, 1, 2, 5, 1, 1, 4, 2],
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.81829e1, -0.62767, -0.33289e1, -0.35278e1, 0.93103e1], "exp": [1, 1.5, 3, 5.6, 7.]}
    _liquid_Density={ "eq": 1, "ao": [0.11818e1, -0.36120e1, 0.54325e1, -0.47789, -0.17766e-1], "exp": [0.098, 0.22, 0.35, 0.7, 2.0]}
    _vapor_Density={ "eq": 3, "ao": [-0.93315, -0.40761e2, 0.63250e2, -0.45195e2, 0.15114e1, -0.56666e2], "exp": [0.09, 1.07, 1.3, 1.7, 4.0, 5.0]}
    ...
    visco0={"eq": 1, "omega": 1,
                ...
                "t_packed": [0, 0.5],
                "n_poly": [1.31194057e-1, -8.05700894e-2, -3.82240694e-1, 1.53811778e-1, 0.0, -1.10578307e-1, -2.37222995e1],
    ...
    thermo0={"eq": 1,
                ...
                "nb": [0.266894e-1, 0.0, -0.482953e-1, 0.414022e-1, 0.172939e-1, -0.977825e-2, 0.0, 0.0, 0.0, 0.0],
