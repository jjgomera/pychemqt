...
class pH2(MEoS):
    """Ecuación de estado de multiparametros para el hidrógeno (parahidrogeno)
    ...
    CP1={"ao": 2.5, 
        "an": [], "pow": [], 
        "ao_exp": [4.30256, 13.0289, -47.7365, 50.0013, -18.6261, 0.993973, 0.536078], "exp": [499, 826.5, 970.8, 1166.2, 1341.4, 5395, 10185], 
        "ao_hyp": [], "hyp": []}
    CP2={"ao": 2.4995169, 
        "an": [-0.11125185e-2, 0.27491461e-3, -0.10005269e-4, 0.22695404e-8, -0.21031029e-12],"pow": [1, 1.5, 2, 3, 4], 
        "ao_exp": [0.12353388e2, -0.17777676e2, 0.64309174e1, 0.73347521e1], "exp": [598, 778, 1101, 6207], 
        "ao_hyp": [],"hyp": []}
    ...
    _sublimation={"eq": 2, "Tref": 1, "Pref": 0.133332237, "a1": [4.009857354, -90.77568949], "exp1": [0, -1], "a2": [], "exp2": [], "a3": [2.48983094], "exp3": [1]}
    _vapor_Pressure={ "eq": 5, "ao": [-0.487767e1, 0.103359e1, 0.826680, -0.129412], "exp": [1.0, 1.5, 2.65, 7.4]}
    _liquid_Density={ "eq": 1, "ao": [-0.13509, 0.40739e1, -0.53985e1, 0.55230e1, -0.23643e1], "exp": [0.15, 0.44, 0.7, 0.99, 1.31]}
    _vapor_Density={ "eq": 3, "ao": [-0.57545e1, 0.38153e1, -0.12293e2, 0.15095e2, -0.17295e2, -0.34190e2], "exp": [0.53, 0.7, 1.7, 2.4, 3.3, 10]}
    ...
    def _visco0(self):
        ...
        def DILV(T):
            ...
            return suma*100
        def EXCESV(rho, T):
            c=[-0.1099981128e2, 0.1895876508e2, -0.3813005056e3, 0.5950473265e2, 0.1099399458e1, 0.8987269839e1, 0.1231422148e4, 0.311]
