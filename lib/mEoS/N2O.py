...
class N2O(MEoS):
    """Ecuación de estado de multiparametros para el oxido nitroso
    ...
    helmholtz1={
        ...
        "nr2": [0.13122, 0.46032, -0.0036985, -0.23263, -0.00042859, -0.042810, -0.023038],
        "d2": [1, 2, 5, 1, 1, 4, 2],
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.69078e1, 0.26620e1, -0.22386e1, -0.38002e1, 0.76922], "exp": [1.0, 1.5, 1.9, 4.8, 5.8]}
    _liquid_Density={ "eq": 1, "ao": [0.67919e1, -0.16069e2, 0.25632e2, -0.20755e2, 0.71963e1], "exp": [0.47, 0.72, 1.0, 1.3, 1.6]}
    _vapor_Density={ "eq": 3, "ao": [-0.31287e1, -0.77651e2, 0.21442e3, -0.47809e3, 0.75185e3, -0.46279e3], "exp": [0.409, 1.91, 2.33, 3.0, 3.6, 4.0]}
