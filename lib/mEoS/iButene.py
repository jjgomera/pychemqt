...
class iButene(MEoS):
    """Ecuación de estado de multiparametros para el isobuteno
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.68973e1, 0.12475e1, -0.25441e1, -0.29282e1, 0.15778e1], "exp": [1., 1.5, 3.16, 6.2, 7.0]}
    _liquid_Density={ "eq": 1, "ao": [0.62591e2, -0.20805e3, 0.33243e3, -0.29555e3, 0.11148e3], "exp": [0.65, 0.8, 0.98, 1.16, 1.3]}
    _vapor_Density={ "eq": 3, "ao": [-0.31841e1, -0.64014e1, -0.93817e1, -0.11160e2, -0.52298e2, -0.12195e3], "exp": [0.431, 1.29, 3.3, 3.54, 7.3, 15.8]}
