...
class oH2(MEoS):
    """Ecuación de estado de multiparametros para el hidrógeno (ortohidrogeno)
    ...
    CP1={"ao": 2.5, "an": [], "pow": [], "ao_exp": [2.54151, -2.3661, 1.00365, 1.22447], "exp": [856, 1444, 2194, 6968], "ao_hyp": [], "hyp": []}
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.488684e1, 0.105310e1, 0.856947, -0.185355], "exp": [1.0, 1.5, 2.7, 6.2]}
    _liquid_Density={ "eq": 1, "ao": [0.43911e1, -0.75872e1, 0.10402e2, -0.72651e1, 0.18302e1], "exp": [0.53, 0.93, 1.35, 1.8, 2.4]}
    _vapor_Density={ "eq": 3, "ao": [-0.31463e1, -0.16183e2, 0.31803e2, -0.21961e3, 0.43123e3, -0.25591e3], "exp": [0.491, 2.1, 2.9, 4.4, 5.0, 5.5]}
