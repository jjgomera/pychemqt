...
class Acetone(MEoS):
    """Ecuación de estado de multiparametros para la acetona
    ...
    helmholtz1={
        ...
        "nr2": [-0.039663, 0.72085, 0.0092318, -0.17217, -0.14961, -0.076124, -0.018166],
        "d2": [1, 2, 5, 1, 1, 4, 2],
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.76214e1, 0.17441e1, -0.20514e1, -0.26644e1, -0.69437], "exp": [1, 1.5, 2.57, 4.43, 15.]}
    _liquid_Density={ "eq": 1, "ao": [0.11118e2, -0.29507e2, 0.35255e2, -0.14712e2, 0.95560], "exp": [0.456, 0.626, 0.8, 1.0, 2.47]}
    _vapor_Density={ "eq": 3, "ao": [-0.25200e1, -0.66065e1, -0.25751e2, 0.78120e1, -0.53778e2, -0.11684e3], "exp": [0.36, 1.05, 3.2, 4.0, 6.5, 14.0]}
