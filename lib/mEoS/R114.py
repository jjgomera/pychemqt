...
class R114(MEoS):
    """Ecuación de estado de multiparametros para el R114
    ...
    helmholtz1={
        ...
        "nr1": [-0.340776521414, 0.323001398420, -0.424950537596e-1, 0.107938879710e1, -0.199243619673e1, -0.155135133506, -0.121465790553, -0.165038582393e-1, -0.186915808643, 0.308074612567, 0.115861416115, 0.276358316589e-1, 0.108043243088, 0.460683793064e-1, -0.174821616881, 0.317530854287e-1],
        "d1": [0, 0, 0, 1, 1, 1, 1, 1, 2, 2, 2, 3, 3, 4, 4, 5],
        "t1": [3, 4, 5, 0, 1, 2, 3, 4, 0, 1, 2, 0, 1, 0, 1, 1],

        "nr2": [0.340776521414, -0.323001398420, 0.424950537596e-1, -0.166940100976e1, 0.408693082002e1, -0.241738963889e1],
        "d2": [0, 0, 0, 2, 2, 2],
        "t2": [3, 4, 5, 3, 4, 5],
        "c2": [2]*6,
        "gamma2": [1.21103865]*6}
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.72195e1, 0.16357e1, -0.14576e1, -0.69580e1, 0.57181e1], "exp": [1.0, 1.5, 2.2, 4.8, 6.2]}
    _liquid_Density={ "eq": 1, "ao": [0.43023, 0.22722e2, -0.27118e2, 0.13247e2, -0.90529e1], "exp": [0.095, 0.93, 1.1, 2.0, 3.0]}
    _vapor_Density={ "eq": 3, "ao": [-0.46609, -0.68355e1, -0.16715e3, 0.15805e5, -0.31859e5, 0.21548e5], "exp": [0.09, 0.76, 4.0, 6.5, 7.0, 8.0]}
