...
class Kr(MEoS):
    """Ecuación de estado de multiparametros para el kripton
...
#    id=971
    ...
    helmholtz2={
        ...
        "nr1": [-0.402218741560, 0.679250544381, -0.1878869802860, 0.603399982935, -0.177297564389e1, 0.581208430222, -0.733585469788, 0.164651929067, -0.319923148922e-1, 0.333278228743, 0.219652478083e-1, 0.751994891628e-1, -0.212109737251, -0.645185506524e-2, 0.409175610200e-1, 0.169416098754e-2],
        "d1": [0, 0, 0, 1, 1, 1, 1, 1, 2, 2, 2, 3, 3, 4, 4, 5],
        "t1": [3, 4, 5, 0, 1, 2, 3, 4, 0, 1, 2, 0, 1, 0, 1, 1],

        "nr2": [0.402218741560, -0.679250544381, 0.187886980286, 0.108265263587, -0.137102675805, -0.110549803007],
        "d2": [0, 0, 0, 2, 2, 2],
        "t2": [3, 4, 5, 3, 4, 5],
        "c2": [2, 2, 2, 2, 2, 2],
        "gamma2": [1]*6,
    ...
    _dielectric={"eq": 3, "Tref": 273.16, "rhoref": 1000.,
                            ...
                            "a2": [6.485, 13.48, -82.51, -170.4], "expt2": [0, 1, 0, 1], "expd2": [2, 2, 2.7, 2.7]}
    _melting={"eq": 1, "Tref": Tt, "Pref": 101.325, "a1": [-2345.757, 1.080476685], "exp1": [0, 1.6169841], "a2": [], "exp2": [], "a3": [], "exp3": []}
    _sublimation={"eq": 3, "Tref": Tt, "Pref": 73.197, "a1": [], "exp1": [], "a2": [-11.5616], "exp2": [1], "a3": [], "exp3": []}
    _vapor_Pressure={ "eq": 5, "ao": [-0.59697e1, 0.12673e1, -0.95609, -0.35630e2, 0.56884e2], "exp": [1.0, 1.5, 2.95, 9.3, 10.4]}
    _liquid_Density={ "eq": 1, "ao": [0.20593e2, -0.65490e2, 0.94407e2, -0.69678e2, 0.22810e2], "exp": [0.62, 0.84, 1.07, 1.34, 1.6]}
    _vapor_Density={ "eq": 3, "ao": [-0.64163e1, 0.89956e1, -0.10216e2, -0.13477e2, -0.21152e3, 0.21375e3], "exp": [0.525, 0.77, 1.04, 3.2, 8.3, 9.0]}
