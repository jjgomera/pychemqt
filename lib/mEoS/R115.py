...
class R115(MEoS):
    """Ecuación de estado de multiparametros para el R115
    ...
    helmholtz1={
        ...
        "nr2": [0.988385, 1.13878 , -0.0215633, -0.630230 , 0.0167901, -0.149412, -0.0271153],
        "d2": [1, 2, 5, 1, 1, 4, 2],
    ...
    helmholtz2={
        ...
        "nr1": [-0.377294477051, -0.695891789165e-1, 0.206972205161, 0.266609543946, -0.117158857583e1, 0.817521154071, -0.978729789251, -0.174482448760, 0.143598704796e1, -0.265460417723e1, 0.165212655822e1, -0.588257570097, 0.738774518022, 0.296779702685, -0.534330750773, 0.659766160237e-1],
        "d1": [0, 0, 0, 1, 1, 1, 1, 1, 2, 2, 2, 3, 3, 4, 4, 5],
        "t1": [3, 4, 5, 0, 1, 2, 3, 4, 0, 1, 2, 0, 1, 0, 1, 1],

        "nr2": [0.377294477051, 0.695891789165e-1, -0.206972205161, -0.350603135603, 0.108682541098e1, -0.619304197853],
        "d2": [2]*6,
        "t2": [3, 4, 5, 3, 4, 5],
        "c2": [0, 0, 0, 2, 2, 2],
        "gamma2": [1.50553819]*6}
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.77016e1, 0.43462e1, -0.40020e1, -0.65510e1, 0.39278e1], "exp": [1.0, 1.5, 1.9, 5.2, 6.0]}
    _liquid_Density={ "eq": 1, "ao": [0.18245e2, -0.57373e2, 0.78511e2, -0.50979e2, 0.14361e2], "exp": [0.556, 0.75, 0.95, 1.2, 1.5]}
    _vapor_Density={ "eq": 3, "ao": [-0.35696e1, -0.83593e1, -0.34007e3, 0.40114e3, 0.84442e2, -0.22137e3], "exp": [0.421, 1.5, 4.7, 5.0, 5.4, 6.0]}
