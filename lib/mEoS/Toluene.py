...
class Toluene(MEoS):
    ...
    _vapor_Pressure = {
        "eq": 3,
        "n": [-7.45201, 2.03681, -1.43777, -3.51652, -1.75818],
        "t": [1.0, 1.5, 2.13, 4.0, 12.0]}
    _liquid_Density = {
        "eq": 1,
        "n": [14.0531, -32.5072, 35.1091, -16.0694, 2.38699],
        "t": [0.54, 0.72, 0.93, 1.2, 2.0]}
    _vapor_Density = {
        "eq": 2,
        "n": [-2.97587, -5.34939, -19.1781, -24.0058, -32.4034, -140.645],
        "t": [0.425, 1.06, 3.0, 6.3, 7.0, 15.0]}
