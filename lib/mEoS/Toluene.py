...
class Toluene(MEoS):
    """Ecuación de estado de multiparametros para el tolueno
    ...
    CP2={  "ao": -0.321892/8.3143*92.142,
                "an": [0.579338e-2/8.3143*92.142, -0.348446e-5/8.3143*92.142, 0.143577e-8/8.3143*92.142, -0.71935e-12/8.3143*92.142],
                "pow": [1, 2, 3, 4],
                "ao_exp": [], "exp": [],
                "ao_hyp": [],"hyp": []}
    ...
    helmholtz2={
        ...
        "nr1": [-0.343905499875, 0.737562743137, -0.158601557810, 0.113243121503e1, -0.253681929563e1, 0.104584338973e1, -0.115732119380e1, 0.176205273278, -0.242942016719, 0.398925293195, 0.193881828889, 0.199426230143, -0.306598708746, -0.114697533947e-1, 0.230068676459e-1, 0.658341220591e-2],
        "d1": [0, 0, 0, 1, 1, 1, 1, 1, 2, 2, 2, 3, 3, 4, 4, 5],
        "t1": [3, 4, 5, 0, 1, 2, 3, 4, 0, 1, 2, 0, 1, 0, 1, 1],

        "nr2": [0.343905499875, -0.737562743137, 0.15860155781, 0.40707928397, -0.68140614165, 0.110425925004],
        "d2": [0, 0, 0, 2, 2, 2],
        "t2": [3, 4, 5, 3, 4, 5],
        "c2": [2]*6,
        "gamma2": [0.841]*6}
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-7.45201, 2.03681, -1.43777, -3.51652, -1.75818], "exp": [1.0, 1.5, 2.13, 4.0, 12.0]}
    _liquid_Density={ "eq": 1, "ao": [14.0531, -32.5072, 35.1091, -16.0694, 2.38699], "exp": [0.54, 0.72, 0.93, 1.2, 2.0]}
    _vapor_Density={ "eq": 3, "ao": [-2.97587, -5.34939, -19.1781, -24.0058, -32.4034, -140.645], "exp": [0.425, 1.06, 3.0, 6.3, 7.0, 15.0]}
    ...
    visco0={"eq": 1, "omega": 1, 
                ...
                "n_poly": [0.157560701809e2, 0.658234203776e2, -0.909162962259e2, -0.806740654754e2, 0.395093273404e1, 0.867277691823e-1, -0.928414042924e-2, 0.982264892850e-5, -0.785434913708e-3, 0.169683455336e-7],
                "t_poly": [-0.2843, -2.4238, -2.7667, -3.0019, -3.2869, -6.0789, -6.1564, -6.8541, -5.5123, -4.1175],
    ...
    thermo0={"eq": 1,
                ...
                "nb": [-0.318905053658e1, 0.258544682121e2, -0.263059677817e2, -0.691196173614, 0.542428651638e-1, -0.326501347819],
                ...
                "Xio": 0.33442441e-9, "gam0": 0.55e-1, "qd": 0.71763799e-9 , "Tcref": 1183.5}
