...
class R113(MEoS):
    """Ecuación de estado de multiparametros para el R113
    ...
    helmholtz1={
        ...
        "nr1": [0.8432092286, -0.2019185967e1, 0.2920612996, 0.5323107661e-1, 0.3214971931e-2, 0.4667858574e-4, -0.1227522799e-5],
        "d1": [1, 1, 2, 3, 4, 8, 8],
        "t1": [0.5, 1.5, 1.5, -0.5, 2, 0, 3],

        "nr2": [0.8167288718, -0.1340790803e1, 0.4065752705, -0.1534754634, -0.2414435149e-1 , -0.2113056197e-1, -0.3565436205e-1, 0.1364654968e-2, -0.1251838755e-1, -0.1385761351e-2, 0.7206335486e-3],
    ...
    helmholtz2={
        ...
        "nr1": [0.10519071e1, -0.28724742e1, 0.41983153, 0.87107788e-1, 0.24105194e-3],
        "d1": [1, 1, 1, 3, 7],
        "t1": [0.25, 1.25, 1.5, 0.25, 0.875],

        "nr2": [0.70738262, 0.93513411, -0.96713512e-2, -0.52595315, 0.22691984e-1, -0.14556325, -0.2741995e-1],
        "d2": [1, 2, 5, 1, 1, 4, 2],
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.73838e1, 0.32594e1, -0.27761e1, -0.37758e1, -0.19921], "exp": [1.0, 1.5, 1.8, 4.3, 6.2]}
    _liquid_Density={ "eq": 1, "ao": [0.15785e1, 0.12404e1, -0.66933, 0.49775e1, -0.55253e1], "exp": [0.3, 0.7, 2.0, 4.0, 5.0]}
    _vapor_Density={ "eq": 3, "ao": [-0.26225e1, -0.60753e1, -0.15768e2, -0.42361e2, -0.79071e1, -0.31966e3], "exp": [0.379, 1.13, 2.9, 6.0, 7.0, 15.0]}
    ...
    visco0={"eq": 1, "omega": 1, 
                    ...
                    "n_packed": [3.16369563558749, -0.8901733752064137e-1, 0.1000352946668359], 
                    "t_packed": [0, 1, 2], 
