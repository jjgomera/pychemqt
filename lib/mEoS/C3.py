...
class C3(MEoS):
    """Ecuación de estado de multiparametros para el propano
    ...
    CP5={  "ao": -5.4041204338,
                "an": [3.1252450099e6, -1.1415253638e5, 1.4971650720e3, 3.9215452897e-2, -2.1738913926e-5, 4.8274541303e-9],
                "pow": [-3, -2, -1.001, 1, 2, 3],
    ...
    helmholtz1={
        ...
        "nr1":  [0.42910051e-1, 0.17313671e1, -0.24516524e1, 0.34157466, -0.46047898],
        "d1": [4, 1, 1, 2, 2],
        "t1": [1, 0.33, 0.8, 0.43, 0.9],

        "nr2": [-0.66847295, 0.20889705, 0.19421381, -0.22917851, -0.60405866, 0.66680654e-1],
        "d2": [1, 3, 6, 6, 2, 3],
        "t2": [2.46, 2.09, 0.88, 1.09, 3.25, 4.62],
        "c2": [1, 1, 1, 1, 2, 2],
        "gamma2": [1]*6,

        "nr3": [0.17534618e-1, 0.33874242, 0.22228777, -0.23219062, -0.92206940e-1, -0.47575718, -0.17486824e-1],
        "d3": [1, 1, 1, 2, 2, 4, 1],
    ...
    helmholtz2={
        ...
        "nr1":  [.21933784906951e1, -.38432884604893e1, .56820219711755, .11235233289697, -.13246623110619e-1, .14587076590314e-1, .19654925217128e-1],
        "d1": [1, 1, 1, 2, 3, 4, 4],
        "t1": [0.50, 1.00, 1.50, 0.00, 0.50, 0.50, 0.75],

        "nr2": [.73811022854042, -.85976999811290, .14331675665712, -.23280677426427e-1, -.98713669399783e-4, .45708225999895e-2, -.27766802597861e-1, -.10523131087952, .97082793466314e-1, .20710537703751e-1, -.54720320371501e-1, .64918009057295e-3, .74471355056336e-2, -.27504616979066e-3, -.77693374632348e-2, -.17367624932157e-2 ],
    ...
    MBWR={
        ...
        "b": [None, -0.2804337729e-2, 0.1180666107e1, -0.3756325860e2, 0.5624374521e4, -0.9354759605e6, -0.4557405505e-3, 0.1530044332e1, -0.1078107476e4, 0.2218072099e6, 0.6629473971e-4, -0.6199354447e-1, 0.6754207966e2, 0.6472837570e-2, -0.6804325262, -0.9726162355e2, 0.5097956459e-1, -0.1004655900e-2, 0.4363693352, -0.1249351947e-1, 0.2644755879e6, -0.7944237270e8, -0.7299920845e4, 0.5381095003e9, 0.3450217377e2, 0.9936666689e4, -0.2166699036e1, -0.1612103424e6, -0.3633126990e-2, 0.1108612343e2, -0.1330932838e-3, -0.3157701101e-1, 0.1423083811e1]}
    ...
    GERG={
        ...
        "nr1":  [0.10403973107358e1, -0.28318404081403e1, 0.84393809606294, -0.76559591850023e-1, 0.94697373057280e-1, 0.24796475497006e-3],
        "d1": [1, 1, 1, 2, 3, 7],
        "t1": [0.25, 1.125, 1.5, 1.375, 0.25, 0.875],

        "nr2": [0.27743760422870, -0.43846000648377e-1, -0.26991064784350, -0.69313413089860e-1, -0.29632145981653e-1, 0.14040126751380e-1 ],
        "d2": [2, 5, 1, 4, 3, 4],
    ...
    helmholtz4={
        ...
        "nr1":  [2.698378e-1, -1.339252, -2.273858e-2, 2.414973e-1, -3.321461e-2, 2.203323e-3, 5.935588e-5, -1.137457e-6],
        "d1": [1, 1, 2, 2, 3, 5, 8, 8],
        "t1": [-0.25, 1.5, -0.75, 0, 1.25, 1.5, 0.5, 2.5],

        "nr2": [-2.379299, 2.337373, 1.242344e-3, -7.352787e-3, 1.965751e-3, -1.402666e-1, -2.093360e-2, -2.475221e-4, -1.482723e-2, -1.303038e-2, 3.634670e-5],
    ...
    helmholtz5={
        ...
        "nr1":  [0.10403973e1, -0.28318404e1, 0.8439381, -0.76559592e-1, 0.94697373e-1, 0.24796475e-3],
        "d1": [1, 1, 1, 2, 3, 7],
        "t1": [0.25, 1.125, 1.5, 1.375, 0.25, 0.875],

        "nr2": [0.2774376, -0.43846001e-1, -0.26991065, -0.69313413e-1, -0.29632146e-1, 0.14040127e-1],
        "d2": [2, 5, 1, 4, 3, 4],
        "t2": [0.625, 1.75, 3.625, 3.625, 14.5, 12.],
        "c2": [1, 1, 2, 2, 3, 3],
        "gamma2": [1]*6}
    ...
    _dielectric={"eq": 4, "Tref": 273.16, "rhoref": 1000.,
                            ...
                            "a2": [172.75, 505.67, -388.21, -2078.8], "expt2": [0, 1, 0, 1], "expd2": [2, 2, 2.35, 2.35]}
    _melting={"eq": 1, "Tref": Tt, "Pref": 0.00000017, "a1": [-4230000000000, 4230000000001], "exp1": [0, 1.283], "a2": [], "exp2": [], "a3": [], "exp3": []}
    _vapor_Pressure={ "eq": 5, "ao": [-6.7722, 1.6938, -1.3341, -3.1876, 0.94937], "exp": [1, 1.5, 2.2, 4.8, 6.2]}
    _liquid_Density={ "eq": 1, "ao": [1.82205, 0.65802, 0.21109, 0.083973], "exp": [0.345, 0.74, 2.6, 7.2]}
    _vapor_Density={ "eq": 3, "ao": [-2.4887, -5.1069, -12.174, -30.495, -52.192, -134.89], "exp": [0.3785, 1.07, 2.7, 5.5, 10., 20.]}
    ...
    visco0={"eq": 1, "omega": 1,
                ...
                "t_packed": [0, 0.5],
                "n_poly": [0.359873030195e2, -0.180512188564e3, 0.877124888223e2, -0.105773052525e3, 0.205319740877e3, -0.129210932610e3, 0.589491587759e2, -0.129740033100e3, 0.766280419971e2, -0.959407868475e1, 0.210726986598e2, -0.143971968187e2, -0.161688405374e4, ],
    ...
    visco1={"eq": 2, "omega": 2,
                ...
                "F": [0, 0, 1.12, 359.],
                "E": [-14.113294896, 968.22940153, 13.686545032, -12511.628378, 0.0168910864, 43.527109444, 7659.45434720],
                "rhoc": 5.0}
    ...
    thermo0={"eq": 1,
                ...
                "nb": [-3.69500e-2, 4.82798e-2, 1.48658e-1, -1.35636e-1, -1.19986e-1, 1.17588e-1, 4.12431e-2, -4.36911e-2, -4.86905e-3, 6.16079e-3],
                "tb": [0, 1]*5,
    ...
    thermo1={"eq": 2, "omega": 2,
                ...
                "E": [0.3113890422e-2, -0.225755973, 0.5674370999e2, -0.7840963643e-4, 0.2291785465e-1, -0.2527939890e1, -0.6265334654e-1, 0.2518064809e1],
