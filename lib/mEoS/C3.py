...
class C3(MEoS):
    ...
    Fi5 = {"ao_log": [1, 3.021340195],
           "pow": [0, 1],
           "ao_pow": [-4.992828913, 4.290868000],
           "ao_exp": [1.048289299, 3.052931786, 11.41993237, 5.039954185],
           "titao": [2.890619390, 4.463727599, 8.143131355, 10.48770680]}
    ...
    astina = {
        "__type__": "Helmholtz",
        "__name__": "Helmholtz equation of state for propane of Astina (2007)",
        "__doi__": {"autor": "Astina, I.M., Firmansyah, J.",
                    "title": "Thermodynamic Property Model of Wide-Fluid "
                             "Phase Propane",
                    "ref": "ITB J.Eng.Sci. 39(1) (2007) 43-65",
                    "doi": "10.5614/itbj.eng.sci.2007.39.1.4"},

        "R": 8.314472,
        "cp": Fi5,
        "ref": "IIR",
        "Tc": 369.825, "rhoc": 218.5/M, "Tt": 85.48,

        "Tmin": 85.48, "Tmax": 620.0, "Pmax": 800000.0, "rhomax": 40.,

        "nr1": [4.351478882, -5.303338979, 8.778030399e-1, -4.698521308e-2,
                4.011015086e-2, -6.253587025e-1, 1.283811450e-1,
                1.039006296e-2, 1.735220995e-4],
        "d1": [1, 1, 1, 1, 1, 2, 3, 4, 7],
        "t1": [0.5, 0.75, 1.4, 3.7, 3.875, 1.375, 0.5, 1.5, 1],

        "nr2": [-8.445284479e-1, -5.604721398e-3, 1.041801469e-1,
                -1.741341952e-5, -2.824024467e-1, 1.086225331e-4,
                -4.532304594e-2, -1.462184694e-2, -1.564259451e-4],
        "d2": [1, 2, 4, 8, 1, 3, 4, 3, 12],
        "t2": [1.25, 5, 1.75, 3.75, 3.5, 9.4, 3.6, 19, 13],
        "c2": [1, 1, 1, 1, 2, 2, 2, 3, 3],
        "gamma2": [1]*9}

    eq = lemmon, younglove, buecker, GERG, miyamoto, shortSpan, sun, astina
    _PR = [-0.2124, -14.8203]
    ...
    visco1 = {"__name__": "Vogel (1998)",
              ...
              "Tref_res": 369.82, "rhoref_res": 5*44.0956,
