...
class Cyclohexane(MEoS):
    """Ecuación de estado de multiparametros para el ciclohexano
    ...
    helmholtz1={
        ...
        "nr1": [0.8425412659, -0.3138388327e1, 0.1679072631e1, -0.153819249, 0.1984911143, -0.144532594, 0.3746346428e-3, 0.1861479616e-3, 0.1745721652e-3],
        "d1": [1, 1, 1, 2, 3, 3, 7, 6, 6],
        "t1": [0, 1.5, 2.5, 1.5, 1, 2.5, 2, 0.5, 3],

        "nr2": [-0.6427428062, 0.2280757615, -0.1868116802e1, -0.1028243711e1, 0.5821457418, -0.255891152, 0.1276844113e-1, -0.5158613166e-2, 0.6334794755e-1, -0.6014686589e-1, 0.4439056828, -0.6264920642, 0.2132589969e1, -0.3620300991e-2, 0.2534453992, 0.1669144715e-1, 0.3985052291e-2],
    ...
    helmholtz2={
        ...
        "nr1": [0.10232354e1, -0.29204964e1, 0.10736630e1, -0.19573985, 0.12228111, 0.28943321e-3],
        "d1": [1, 1, 1, 2, 3, 7],
        "t1": [0.25, 1.125, 1.5, 1.375, 0.25, 0.875],

        "nr2": [0.27231767, -0.4483332e-1, -0.38253334, -0.89835333e-1, -0.24874965e-1, 0.10836132e-1],
        "d2": [2, 5, 1, 4, 3, 4],
    ...
    _melting={"eq": 1, "Tref": 1, "Pref": 1000, "a1": [0.1329969885, -374.255624], "exp1": [1.41, 0], "a2": [], "exp2": [], "a3": [], "exp3": []}
    _vapor_Pressure={ "eq": 5, "ao": [-0.70408e1, 0.19110e1, -0.18308e1, -0.16218e2, 0.20237e2], "exp": [1., 1.5, 2.13, 5.9, 7.2]}
    _liquid_Density={ "eq": 1, "ao": [0.17177, 0.25797e3, -0.73723e3, 0.11669e4, -0.13041e4, 0.62129e3], "exp": [0.093, 1.14, 1.34, 1.67, 2.0, 2.2]}
    _vapor_Density={ "eq": 3, "ao": [-0.12016, -0.57983e1, -0.95451e2, 0.22937e3, -0.22100e3, 0.34023e2], "exp": [0.102, 0.63, 3.0, 3.6, 4.2, 4.5]}
