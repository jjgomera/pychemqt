...
class nC10(MEoS):
    """Ecuación de estado de multiparametros para el n-decano
    ...
    _dielectric={"eq": 3, "Tref": 273.16, "rhoref": 1000.,
                            ...
                            "a2": [220.15, -316.3, -88358, 53511], "expt2": [0, 1, 0, 1], "expd2": [2, 2, 3, 3]}
    _vapor_Pressure={ "eq": 5, "ao": [-0.87738e1, 0.40864e1, -0.40775e1, -0.64910e1, 0.15598e1], "exp": [1.0, 1.5, 1.93, 4.14, 4.7]}
    _liquid_Density={ "eq": 1, "ao": [0.92435e1, -0.16288e2, 0.20445e2, -0.17624e2, 0.73796e1], "exp": [0.535, 0.74, 1.0, 1.28, 1.57]}
    _vapor_Density={ "eq": 3, "ao": [-0.50378e1, -0.34694e1, -0.15906e2, -0.82894e2, 0.29336e2, -0.10985e3], "exp": [0.4985, 1.33, 2.43, 5.44, 5.8, 11.0]}
    ...
    thermo0={"eq": 1,
                ...
                "nb": [-0.294394e-1, 0.150509e-1, 0.499245e-1, 0.0, -0.142700e-1, -0.138857e-1, 0.150828e-2, 0.433326e-2, 0.0, 0.0],
