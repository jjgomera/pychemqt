...
class C1Linolenate(MEoS):
    """Ecuación de estado de multiparametros para el metilciclohexano

    >>> metilciclohexano=C1Linolenate(T=300, P=0.1)
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.14239e2, 0.85361e1, -0.29678e2, 0.29106e2, -0.16922e2], "exp": [1.0, 1.5, 2.86, 3.5, 4.6]}
    _liquid_Density={ "eq": 1, "ao": [0.16258e2, -0.19465e3, 0.14231e4, -0.22420e4, 0.10012e4], "exp": [0.681, 1.26, 1.58, 1.7, 1.8]}
    _vapor_Density={ "eq": 3, "ao": [-0.11463e2, 0.45192e2, -0.65779e2, -0.18386e4, 0.40689e4, -0.25124e4], "exp": [0.65, 1.55, 1.8, 6.6, 7.2, 7.8]}
    ...
    thermo0={"eq": 1,
                ...
                "nb": [-0.41010600e-1, 0.32844300e-1, -0.41850600e-2, 0.0, 0.0, 0.60665700e-1, -0.49840700e-1, 0.12175200e-1, 0.0, 0.0],
