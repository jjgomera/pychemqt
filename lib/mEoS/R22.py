...
class R22(MEoS):
    """Ecuación de estado de multiparametros para el R22
    ...
    CP1={  "ao": 4.00526140446,
                ...
                "pow": [1],
                "ao_exp": [1]*9,
                "exp": [4352.3095, 1935.1591, 1887.67936, 1694.88284, 1605.67848, 1162.53424, 857.51288, 605.72638, 530.90982],
                "ao_hyp": [],"hyp": []}
    ...
    helmholtz1={
        ...
        "nr1": [0.695645445236e-1, 0.252275419999e2, -0.202351148311e3, 0.350063090302e3, -0.223134648863e3, 0.488345904592e2, 0.108874958556e-1, 0.590315073614, -0.689043767432, 0.284224445844, 0.125436457897, -0.113338666416e-1, -0.631388959170e-1, 0.974021015232e-2, -0.408406844722e-3, 0.741948773570e-3, 0.315912525922e-3, 0.876009723338e-5, -0.110343340301e-3, -0.705323356879e-4],
        "d1": [1, 1, 1, 1, 1, 1, 1, 2, 2, 2, 3, 3, 4, 5, 6, 7, 7, 7, 8, 8],
        "t1": [-1, 1.75, 2.25, 2.5, 2.75, 3, 5.5, 1.5, 1.75, 3.5, 1, 4.5, 1.5, 0.5, 4.5, 1, 4, 5, -0.5, 3.5],

        "nr2": [0.235850731510, -0.192640494729, 0.375218008557e-2, -0.448926036678e-4, 0.198120520635e-1, -0.356958425255e-1, 0.319594161562e-1, 0.260284291078e-5, -0.897629021967e-2, 0.345482791645e-1, -0.411831711251e-2, 0.567428536529e-2 , -0.563368989908e-2, 0.191384919423e-2, -0.178930036389e-2],
    ...
    helmholtz2={
        ...
        "nr1": [0.29599201810, -0.1151392173e1, 0.5259746924, -0.6644393736, 0.1723481086, -0.1158525163e-3, 0.3803104348e-3, 0.4119291557e-5],
        "d1": [1, 1, 2, 2, 2, 5, 7, 8],
        "t1": [0, 1.5, 0, 0.5, 1.5, 3, 0, 2.5],

        "nr2": [-0.2267374456, 0.1433024764e-1, -0.1392978451, -0.1172221416, 0.2003394173, -0.2097857448, 0.1284497611e-1, 0.1724693488e-2, -0.5663447308e-3, 0.1485459957e-4, -0.5691734346e-3, 0.8341057068e-2, -0.2526287501e-1, 0.1185506149e-2],
    ...
    helmholtz3={
        ...
        "nr1": [0.96268924, -0.25275103e1, 0.31308745, 0.72432837e-1, 0.21930233e-3],
        "d1": [1, 1, 1, 3, 7],
        "t1": [0.25, 1.25, 1.5, 0.25, 0.875],

        "nr2": [0.33294864, 0.63201229, -0.32787841e-2, -0.33680834, -0.22749022e-1, -0.87867308e-1, -0.21108145e-1],
        "d2": [1, 2, 5, 1, 1, 4, 2],
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.70780e1, 0.17211e1, -0.16379e1, -0.37952e1, 0.86937], "exp": [1.0, 1.5, 2.2, 4.8, 6.2]}
    _liquid_Density={ "eq": 1, "ao": [0.18762e1, 0.68216, 0.41342e-1, 0.22589, 0.15407], "exp": [0.345, 0.74, 1.2, 2.6, 7.2]}
    _vapor_Density={ "eq": 3, "ao": [-0.23231e1, -0.59231e1, -0.16331e2, -0.49343e2, -0.25662e2, -0.89335e2], "exp": [0.353, 1.06, 2.9, 6.4, 12.0, 15.0]}
