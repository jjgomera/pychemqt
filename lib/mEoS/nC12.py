...
class nC12(MEoS):
    """Ecuación de estado de multiparametros para el n-dodecano
    ...
    _surface={"sigma": [0.351971e-1, 0.629282e-1, -0.556479e-1], "exp": [1.25, 2.25, 3.25]}
    _vapor_Pressure={ "eq": 5, "ao": [-0.94217e1, -0.41890e1, 0.54999e1, -0.67789e1, -0.17161e1], "exp": [1.0, 1.5, 1.359, 3.56, 9.2]}
    _liquid_Density={ "eq": 1, "ao": [0.92236, 0.92047, 0.55713e1, -0.92253e1, 0.51763e1], "exp": [0.21, 0.49, 1.08, 1.49, 1.9]}
    _vapor_Density={ "eq": 3, "ao": [-0.17859e1, -0.75436e1, -0.22848e2, -0.81355e2, 0.92283e2 , -0.21725e3], "exp": [0.298, 0.91, 2.8, 6., 9., 11.]}
    ...
    visco0={"eq": 1, "omega": 1,
                ...
                "t_packed": [0, 0.5],
                "n_poly": [-0.471703e-1, 0.827816e-2, 0.298429e-1, -0.134156e-1, -0.503109],
                "t_poly": [-1, -1, -2, -2, 0],
                "d_poly": [2, 3, 2, 3, 1],
                "g_poly": [0, 0, 0, 0, -1],
                "c_poly": [0, 0, 0, 0, 1],
    ...
    thermo0={"eq": 1,
                ...
                "nb": [0.693347e-1, -0.280792e-1, -0.331695e-1, 0.173922e-2, 0.676165e-2, 0.309558e-2, 0.0, 0.0, 0.0, 0.0],
