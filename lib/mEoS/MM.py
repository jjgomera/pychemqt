...
class MM(MEoS):
    ...
    # _vapor_Pressure = {
        # "eq": 3,
        # "n": [-0.86671e1, 0.11649e2, -0.11484e2, -0.53256e1],
        # "t": [1.0, 1.5, 1.65, 4.5]}
    # _liquid_Density = {
        # "eq": 1,
        # "n": [0.14533e2, -0.49804e2, 0.83748e2, -0.70321e2, 0.24283e2],
        # "t": [0.584, 0.8, 1.02, 1.26, 1.5]}
    # _vapor_Density = {
        # "eq": 2,
        # "n": [-0.35719e1, -0.14740e3, 0.40699e3, -0.69676e3, 0.12541e4,
              # -0.91199e3],
        # "t": [0.373, 2.15, 2.6, 3.3, 4.2, 4.6]}
