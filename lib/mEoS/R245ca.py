...
class R245ca(MEoS):
    """Ecuación de estado de multiparametros para el R245ca
    ...
    _surface={"sigma": [0.060002, 0.039781, -0.051002], "exp": [1.26, 1.76, 2.26]}
    _vapor_Pressure={ "eq": 5, "ao": [-0.77617e1, 0.15867e1, -0.48984e2, 0.12055e3, -0.77763e2], "exp": [1.0, 1.5, 3.5, 3.8, 4.0]}
    _liquid_Density={ "eq": 1, "ao": [-0.57615e3, 0.20016e4, -0.30523e4, 0.33777e4, -0.29692e4, 0.12236e4], "exp": [0.79, 0.91, 1.1, 1.4, 1.7, 1.9]}
    _vapor_Density={ "eq": 3, "ao": [0.67777, -0.53374e1, -0.11240e2, -0.13244e2, 0.38054e2, -0.10678e3], "exp": [0.082, 0.41, 2.0, 3.0, 5.0, 6.0]}
