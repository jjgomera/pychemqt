...
#    id=1674
    ...
    CP1={ "ao": 468.7,
                ...
                "ao_exp": [],
                "exp": [],
                "ao_hyp": [425104546.6, 0, 3151243909.0, 0],"hyp": [786.8, 0, 1792.1, 0]}
    ...
    helmholtz1={
        ...
        "nr1": [1.69156186, -3.37962568, 0.38609039, 0.64598995e-1, 0.10589012, 0.45456825e-4],
        "d1": [1, 1, 1, 2, 3, 7],
        "t1": [0.25, 1.125, 1.5, 1.375, 0.25, 0.875],
 
        "nr2": [0.74169279, -0.88102648e-1, -0.17373336, -0.10951368, -0.62695695e-1, 0.37459986e-1],
        "d2": [2, 5, 1, 4, 3, 4],
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.96557e1, 0.62155, 0.17863e1, -0.10496e2, -0.84102e1], "exp": [1.0, 1.5, 1.72, 3.18, 11.0]}
    _liquid_Density={ "eq": 1, "ao": [0.42563e2, -0.15707e3, 0.29502e3, -0.24191e3, 0.65145e2], "exp": [0.537, 0.68, 0.85, 1.0, 1.2]}
    _vapor_Density={ "eq": 3, "ao": [-0.20930e1, -0.94442e1, -0.44731e2, -0.57898e2 , -0.35144e2, -0.29661e3], "exp": [0.338, 1.02, 3.46, 7.1, 7.4, 15.0]}
