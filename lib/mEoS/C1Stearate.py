...
class C1Stearate(MEoS):
    """Ecuación de estado de multiparametros para el metil estearato

    >>> metilciclohexano=C1Stearate(T=300, P=0.1)
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.14597e2, 0.13836e2, -0.14484e2, -0.51856e1, -0.27076e1], "exp": [1.0, 1.5, 2.12, 4.7, 8.0]}
    _liquid_Density={ "eq": 1, "ao": [-0.11202e2, 0.78636e2 , -0.12554e3, 0.72942e2, -0.11524e2], "exp": [0.439, 0.59, 0.73, 0.9, 1.2]}
    _vapor_Density={ "eq": 3, "ao": [-0.18187e2, 0.81619e2, -0.90210e2, -0.52888e3, 0.11270e4, -0.84453e3], "exp": [0.71, 1.3, 1.5, 6.0, 7.0, 8.0]}
    ...
    thermo0={"eq": 1,
                ...
                "nb": [-0.410106e-1, 0.328443e-1, -0.418506e-2, 0.0, 0.0, 0.606657e-1, -0.498407e-1, 0.121752e-1, 0.0, 0.0],
