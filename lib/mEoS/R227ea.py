...
class R227ea(MEoS):
    """Ecuación de estado de multiparametros para el R227ea
...
#    id=1872
    ...
    helmholtz1={
        ...
        "nr2": [-1.02461, 0.6247065, 0.2997521, -0.353917, -1.232043, -0.8824483],
        "d2": [1, 3, 6, 6, 2, 3],
        "t2": [2.82, 2.1, 0.9, 1.13, 3.8, 2.75],
        "c2": [1, 1, 1, 1, 2, 2],
        "gamma2": [1]*6,

        "nr3": [0.1349661, -0.2662928, 0.1764733, 0.01536163, -0.004667185, -11.70854, 0.9114512],
        "d3": [1, 2, 1, 1, 4, 2, 1],
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.77961e1, 0.21366e1, -0.26023e1, -0.57444e1, 0.23982e1], "exp": [1.0, 1.5, 2.2, 4.8, 6.2]}
    _liquid_Density={ "eq": 1, "ao": [0.20032e1, 0.49235, 0.13738, 0.21057, -0.12834], "exp": [0.345, 0.74, 1.2, 2.6, 7.2]}
    _vapor_Density={ "eq": 3, "ao": [-0.21350e1, -0.68425e1, -0.21447e2, -0.20457e3, 0.51795e3, -0.45908e3], "exp": [0.324, 1.03, 3.0, 7.4, 9.0, 10.0]}
