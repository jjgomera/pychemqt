...
class R142b(MEoS):
    """Ecuación de estado de multiparametros para el R142b
    ...
    helmholtz1={
        ...
        "nr2": [0.48246, 0.75542, -0.007430, -0.41460 , -0.016558, -0.10644, -0.021704],
        "d2": [1, 2, 5, 1, 1, 4, 2],
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.73074e1, 0.23186e1, -0.23278e1, -0.32761e1, 0.42103], "exp": [1.0, 1.5, 2.2, 4.8, 6.2]}
    _liquid_Density={ "eq": 1, "ao": [0.17162e2, -0.47495e2, 0.57171e2, -0.25404e2, 0.15855e1], "exp": [0.53, 0.71, 0.9, 1.1, 2.3]}
    _vapor_Density={ "eq": 3, "ao": [-0.31460e1, -0.65221e1, -0.18006e2, -0.46694e2, -0.26087e1, -0.11020e3], "exp": [0.408, 1.28, 3.2, 6.6, 7.0, 14.0]}
