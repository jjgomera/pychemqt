...
class iC4(MEoS):
    """Ecuación de estado de multiparametros para el isobutano
    ...
    CP4={  "ao": -1.7231723278e1,
                "an": [1.7027919006e7, -4.7269724737e5, 4.7301406581e3, 5.8491344291e-2, 8.9440351886e-6, -1.8274599197e-8],
                "pow": [-3, -2, -1.001, 1, 2, 3],
    ...
    CP6={  "ao": 0.397893/8.3143*58.124,
                "an": [0.412501e-2/8.3143*58.124, -0.196195e-6/8.3143*58.124, 0.380185e-8/8.3143*58.124, -0.523950e-11/8.3143*58.124],
                "pow": [1, 2, 3, 4],
                "ao_exp": [], "exp": [],
                "ao_hyp": [], "hyp": []}
    ...
    helmholtz1={
        ...
        "nr1":  [0.20686820727966e1, -0.36400098615204e1, 0.51968754427244, 0.17745845870123, -0.12361807851599, 0.45145314010528e-1, 0.30476479965980e-1],
        "d1": [1, 1, 1, 2, 3, 4, 4],
        "t1": [0.50, 1.00, 1.50, 0.00, 0.50, 0.50, 0.75],
        "nr2": [0.75508387706302, -0.85885381015629, 0.36324009830684e-1, -0.19548799450550e-1, -0.44452392904960e-2, 0.46410763666460e-2, -0.71444097992825e-1, -0.80765060030713e-1, 0.15560460945053, 0.20318752160332e-2, -0.10624883571689, 0.39807690546305e-1, 0.16371431292386e-1, 0.53212200682628e-3, -0.78681561156387e-2, -0.30981191888963e-2],
        "d2": [1, 1, 2, 7, 8, 8, 1, 2, 3, 3, 4, 5, 5, 10, 2, 6],
        "t2": [2.00, 2.50, 2.50, 1.50, 1.00, 1.50, 4.00, 7.00, 3.00, 7.00, 3.00, 1.00, 6.00, 0.00, 6.00, 13.00],
    ...
    MBWR={
        ...
        "b": [None, 0.1307325972e-1, 0.3927802742, -0.3185427394e2, 0.7608825192e4, -0.1753919859e7, -0.2090019755e-2, 0.8959557971e1, -0.6816710130e4, -0.1111271045e7, 0.3248737572e-3, -0.1046526456e1, 0.6536598969e3, 0.3726503734e-1 , 0.8553649395e1, 0.2109987236e4, -0.1401267363e1, 0.5213089327e-1, -0.1925026382e2, 0.7640067895, 0.3425854273e7, -0.3373475924e9, 0.1180683444e6 , 0.1529683738e10, 0.3323837416e4, 0.6423169487e5, 0.3891706042e2, -0.1494755736e7, -0.1720240173e-1, 0.2894195375e3, 0.2005086329e-2, -0.4448393005 , 0.8028488415e2]}
    ...
    GERG={
        ...
        "nr1":  [0.10429331589100e1, -0.28184272548892e1, 0.86176232397850, -0.10613619452487, 0.98615749302134e-1, 0.23948208682322e-3],
        "d1": [1, 1, 1, 2, 3, 7],
        "t1": [0.25, 1.125, 1.5, 1.375, 0.25, 0.875],

        "nr2": [0.30330004856950, -0.41598156135099e-1, -0.29991937470058, -0.80369342764109e-1, -0.29761373251151e-1, 0.13059630303140e-1],
        "d2": [2, 5, 1, 4, 3, 4],
    ...
    helmholtz3={
        ...
        "nr1":  [2.892737e-1, -1.342570, -7.976713e-3, 2.025793e-1, -4.241612e-2, 2.617971e-3, 5.068955e-5, -1.144596e-6],
        "d1": [1, 1, 2, 2, 3, 5, 8, 8],
        "t1": [-0.25, 1.5, -0.75, 0, 1.25, 1.5, 0.5, 2.5],

        "nr2": [-1.930153, 1.982609, 2.076533e-3, -4.958752e-3, 1.377372e-3, -1.582662e-1, -4.961892e-2, 9.451030e-4, -3.037276e-2, -1.382675e-2, 8.876254e-5],
    ...
    helmholtz4={
        ...
        "nr1":  [0.10429332e1, -0.28184273e1, 0.86176232, -0.10613619, 0.986157490e-1, 0.23948209e-3],
        "d1": [1, 1, 1, 2, 3, 7],
        "t1": [0.25, 1.125, 1.5, 1.375, 0.25, 0.875],

        "nr2": [0.30330005, -0.41598156e-1, -0.29991937, -0.80369343e-1, -0.29761373e-1, 0.1305963e-1],
        "d2": [2, 5, 1, 4, 3, 4],
        "t2": [0.625, 1.75, 3.625, 3.625, 14.5, 12.],
        "c2": [1, 1, 2, 2, 3, 3],
        "gamma2": [1]*6}
    ...
    helmholtz5={
        ...
        "nr1":  [-0.958589873652, 0.818846326211, -0.115814967179, 0.345513148715, -0.168751721524e1, 0.936693300209, -0.106644545724e1, 0.980958295776e-1, 0.495941129005, -0.261313404262, 0.485109471188, -0.177275820736, -0.209415485311e-1, 0.788178884079e-1, -0.102751671767, 0.178645875838e-1],
        "d1": [0, 0, 0, 1, 1, 1, 1, 1, 2, 2, 2, 3, 3, 4, 4, 5],
        "t1": [3, 4, 5, 0, 1, 2, 3, 4, 0, 1, 2, 0, 1, 0, 1, 1],

        "nr2": [0.958589873652, -0.818846326211, 0.115814967179, 0.537585249054, -0.71942446879, 0.245830118086],
        "d2": [0, 0, 0, 2, 2, 2],
        "t2": [3, 4, 5, 3, 4, 5],
        "c2": [2]*6,
        "gamma2": [1.0071072]*6}
    ...
    _dielectric={"eq": 3, "Tref": 273.16, "rhoref": 1000.,
                            ...
                            "a2": [126.25, 52.91, -7501.4, -2672.9], "expt2": [0, 1, 0, 1], "expd2": [2, 2, 2.9, 2.9]}
    _melting={"eq": 1, "Tref": Tt, "Pref": 0.000022891, "a1": [-1953637129., 1953637130.], "exp1": [0, 6.12], "a2": [], "exp2": [], "a3": [], "exp3": []}
    _vapor_Pressure={ "eq": 5, "ao": [-6.85093103, 1.36543198, -1.32542691, -2.56190994], "exp": [1, 1.5, 2.5, 4.5]}
    _liquid_Density={ "eq": 2, "ao": [2.04025104, 0.850874089, -0.479052281, 0.348201252], "exp": [1.065, 3, 4, 7]}
    _vapor_Density={ "eq": 6, "ao": [-2.12933323, -2.93790085, -0.89441086, -3.46343707], "exp": [1.065, 2.5, 9.5, 13]}
    ...
    visco0={"eq": 1, "omega": 1,
                ...
                "t_packed": [0, 0.5],
                "n_poly": [0.103511763411e3, -0.312670896234e3, 0.145253750239e3, -0.210649894193e3, 0.386269696509e3, -0.214963015527e3, 0.112580360920e3, -0.223242033154e3, 0.119114788598e3, -0.181909745900e2, 0.360438957232e2, -0.213960184050e2, -0.194037606990e4],
    ...
    visco1={"eq": 2, "omega": 2,
                ...
                "E": [-0.2055498053e2, 0.1357076181e4, 0.1893774336e2, -0.1822277344e5, -0.4599387773e-2, 0.6305247065e2, 0.1282253921e5],
                "rhoc": 3.86}
    ...
    thermo0={"eq": 1,
                ...
                "nb": [-4.11789e-2, 4.76346e-2, 1.46805e-1, -1.28445e-1, -1.19190e-1, 1.07565e-1, 4.10226e-2, -3.85968e-2, -4.88704e-3, 5.20901e-3],
                "tb": [0, 1]*5,
    ...
    thermo1={"eq": 2, "omega": 2,
                ...
                "E": [0.4307008989e-2, -0.1509010974e1, 0.4693712392e3, -0.3554280979e-3, 0.1841552874, -0.3892338766e2, -0.9354624917e-1, 0.7114330590e1],
