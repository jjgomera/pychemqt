...
#    id=1376
    ...
    helmholtz1={
        ...
        "nr1": [1.01686012, -2.19713029, 0.75443188, -0.68003426, 0.19082162, 0.10530133e-2],
        "d1": [1, 1, 1, 2, 3, 7],
        "t1": [0.25, 1.125, 1.5, 1.375, 0.25, 0.875],
 
        "nr2": [0.6284595, 0.30903042e-1, -0.83948727, -0.20262381, -0.35131597e-1, 0.25902341e-1],
        "d2": [2, 5, 1, 4, 3, 4],
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.86671e1, 0.11649e2, -0.11484e2, -0.53256e1], "exp": [1.0, 1.5, 1.65, 4.5]}
    _liquid_Density={ "eq": 1, "ao": [0.14533e2, -0.49804e2, 0.83748e2, -0.70321e2, 0.24283e2], "exp": [0.584, 0.8, 1.02, 1.26, 1.5]}
    _vapor_Density={ "eq": 3, "ao": [-0.35719e1, -0.14740e3, 0.40699e3, -0.69676e3, 0.12541e4, -0.91199e3], "exp": [0.373, 2.15, 2.6, 3.3, 4.2, 4.6]}
