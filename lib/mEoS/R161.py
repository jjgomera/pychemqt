...
class R161(MEoS):
    """Ecuación de estado de multiparametros para el R161
    ...
    helmholtz1={
        ...
        "nr2": [0.73357, 0.67596, 0.011369, -0.56406, -0.094362, -0.1678, 0.00034215],
        "d2": [1, 2, 5, 1, 1, 4, 2],
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.75224e1, 0.29140e1, -0.30129e1, -0.44497e1, 0.24207e1], "exp": [1.0, 1.5, 2.3, 6.0, 7.0]}
    _liquid_Density={ "eq": 1, "ao": [-0.22587e2, 0.13424e3, -0.26710e3, 0.33890e3, -0.31059e3, 0.13009e3], "exp": [0.56, 0.7, 0.9, 1.2, 1.5, 1.7]}
    _vapor_Density={ "eq": 3, "ao": [-0.62548e1, 0.10499e2, -0.20353e2, -0.36709e2, -0.86781e2], "exp": [0.56, 1.3, 1.7, 5.0, 11.0]}
