...
class R116(MEoS):
    """Ecuación de estado de multiparametros para el R116
    ...
    CP2={  "ao": 27.4009901,
                "an": [-2.6057376855e-6, 9.7501305219e-10, -6559.250418, 787904.9649, -34166787.86],
                "pow": [2, 3, -1.001, -2, -3],
                "ao_exp": [], "exp": [],
                "ao_hyp": [],"hyp": []}
    ...
    helmholtz2={
        ...
        "nr1": [2.1775273, -5.5052198, -1.3675742, -8.1284229e-1, -4.0207525e-1, 2.5890073, 1.4500537, -1.0445036, 9.8965288e-1, -8.6794888e-1, 2.8240917e-1, 4.5154220e-2, -3.0294024e-2, -1.7668398e-2, 2.0592774e-3],
        "d1": [1, 1, 1, 1, 2, 2, 2, 3, 3, 4, 5, 6, 6, 7, 8],
        "t1": [0.25, 1, 3, 4, 0.25, 1, 3.5, 1.5, 2.5, 3, 3, 1, 3, 1, 1],

        "nr2": [4.2059839, 2.1500380e-1, -1.6449561e-1, -1.2396086e-1, 1.5814552e-1, -1.4362345e-1, 1.8637877e-2, 1.6342835e-2],
        "d2": [1, 1, 4, 4, 5, 5, 8, 4],
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.73997e1, 0.22554e1, -0.23385e1, -0.35244e1, 0.40350], "exp": [1.0, 1.5, 2.2, 4.8, 6.2]}
    _liquid_Density={ "eq": 1, "ao": [0.68490e2, -0.24772e3, 0.35824e3, -0.25290e3, 0.76880e2], "exp": [0.64, 0.79, 0.95, 1.14, 1.33]}
    _vapor_Density={ "eq": 3, "ao": [-0.34135e1, -0.14529e3, 0.23651e3, -0.22276e3, 0.23103e3, -0.17433e3], "exp": [0.428, 2.0, 2.24, 3.0, 4.0, 5.0]}
