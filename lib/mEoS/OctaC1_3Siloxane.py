...
#    id=1893
    ...
    CP1={ "ao": 275.1,
                ...
                "ao_exp": [],
                "exp": [],
                "ao_hyp": [266040871.9, 0, 2051643622.0, 0],"hyp": [802.6, 0, 1829.6, 0]}
    ...
    helmholtz1={
        ...
        "nr1": [1.19735372, -2.40380622, 0.3256564, -0.19971259, 0.11206277, 0.15893999e-3],
        "d1": [1, 1, 1, 2, 3, 7],
        "t1": [0.25, 1.125, 1.5, 1.375, 0.25, 0.875],
 
        "nr2": [0.51234323, -0.20660361e-1, -0.38978114, -0.1186931, -0.37203537e-1, 0.18359984e-1],
        "d2": [2, 5, 1, 4, 3, 4],
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.85589e1, 0.20278e1, -0.28501e1, -0.64397e1, -0.85460e1], "exp": [1.0, 1.5, 2.3, 4.0, 13.0]}
    _liquid_Density={ "eq": 1, "ao": [0.54145, -0.27650e-1, 0.41558e1, -0.19104e1, 0.67606], "exp": [0.12, 0.36, 0.6, 0.8, 2.5]}
    _vapor_Density={ "eq": 3, "ao": [-0.16483e1, -0.71410e1, -0.23088e2, -0.70554e2, 0.19938e1, -0.20193e3], "exp": [0.296, 0.905, 2.8, 5.9, 12.0, 13.0]}
