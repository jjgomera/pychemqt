...
class nC6(MEoS):
    """Ecuación de estado de multiparametros para el n-hexano
    ...
    helmholtz1={
        ...
        "nr1":  [0.10553238013661e1, -0.26120615890629e1, 0.76613882967260, -0.29770320622459, 0.11879907733358, 0.27922861062617e-3],
        "d1": [1, 1, 1, 2, 3, 7],
        "t1": [0.25, 1.125, 1.5, 1.375, 0.25, 0.875],

        "nr2": [0.46347589844105, 0.11433196980297e-1, -0.48256968738131, -0.93750558924659e-1, -0.67273247155994e-2, -0.51141583585428e-2],
        "d2": [2, 5, 1, 4, 3, 4],
    ...
    helmholtz3={
        ...
        "nr1":  [-0.157654494847e1, 0.178731485778e1, -0.341262936801, 0.114919468260e1, -0.381451065649e1, 0.356688884337e1, -0.274863278063e1, 0.391987699726, 0.346062554746, -0.139140552239, 0.489013943543, -0.529751545354e-1, -0.149303737787, 0.455990262306e-1, -0.564866336099e-1, 0.152437539639e-1],
        "d1": [0, 0, 0, 1, 1, 1, 1, 1, 2, 2, 2, 3, 3, 4, 4, 5],
        "t1": [3, 4, 5, 0, 1, 2, 3, 4, 0, 1, 2, 0, 1, 0, 1, 1],

        "nr2": [0.157654494847e1, -0.178731485778e1, 0.341262936801, 0.139479099785, 0.5076238131, -0.655600474113],
        "d2": [0, 0, 0, 2, 2, 2],
        "t2": [3, 4, 5, 3, 4, 5],
        "c2": [2]*6,
        "gamma2": [1.00773692]*6}
    ...
    helmholtz4={
        ...
        "nr1":  [0.261128818398e1, 0.451396780770, -0.783362300734, -0.108785843809e1, 0.124906986929, -0.155020819852e-1, 0.42399441457, -0.636532521368, -0.524764104726e-1, 0.120405133154e-1, 0.992632580157e-3],
    ...
    _surface={"sigma": [0.0522937, 0.0061685, -0.0035869], "exp": [1.25, 2.25, 3.25]}
    _dielectric={"eq": 3, "Tref": 273.16, "rhoref": 1000.,
                            "a0": [0.10924],  "expt0": [-1.], "expd0": [1.],
                            "a1": [30.18, 0.03], "expt1": [0, 1], "expd1": [1, 1],
                            "a2": [222.31, 232.62, -36872, -25733], "expt2": [0, 1, 0, 1], "expd2": [2, 2, 3, 3]}
    _vapor_Pressure={ "eq": 5, "ao": [-0.74172e1, 0.12897e1, -0.32544e1, -0.14609e1, 0.81765e-1], "exp": [1., 1.5, 3.1, 5.3, 5.6]}
    _liquid_Density={ "eq": 1, "ao": [0.14686e3, -0.26585e3, 0.12200e3], "exp": [0.75, 0.81, 0.88]}
    _vapor_Density={ "eq": 3, "ao": [-0.13309, -0.50653e1, -0.11602e2, -0.28530e2, -0.51731e2, -0.13482e3], "exp": [0.107, 0.553, 2.006, 4.46, 8.0, 16.]}
    ...
    visco0={"eq": 2, "omega": 3,
                ...
                "F": [0, 0, 0, 100.],
                "E": [-18.180936383994, 3263.1590998, 17.765176425, -53270.220915, -0.32352381766, 195.54170454, 38519.153073],
                "rhoc": 2.704}
    ...
    thermo0={"eq": 1,
                ...
                "nb": [15.275017704, 11.2896277792, -8.61369853497, 0.697714450907, 2.1687378215, -0.326193379046],
                "tb": [0, 0, 0, -1, 0, -1],
                "db": [1, 3, 4, 4, 5, 5],
                "cb": [0]*6,
