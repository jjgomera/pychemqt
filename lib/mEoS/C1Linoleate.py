...
class C1Linoleate(MEoS):
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.10946e2, 0.48849e1, -0.46773e1, -0.80201e1, -0.89572e1], "exp": [1.0, 1.5, 2.22, 3.6, 8.0]}
    _liquid_Density={ "eq": 1, "ao": [0.22705e3, -0.66763e3, 0.72323e3, -0.49244e3, 0.21391e3], "exp": [0.83, 0.98, 1.17, 1.5, 1.7]}
    _vapor_Density={ "eq": 3, "ao": [-0.85880e1, 0.14766e2, -0.24195e2, -0.37474e3, 0.32689e3, -0.19125e3], "exp": [0.568, 1.08, 1.4, 4.8, 5.0, 9.0]}
    ...
    thermo0={"eq": 1,
                ...
                "nb": [-0.713126e-1, 0.466421e-1, -0.557406e-2, 0.0, 0.0, 0.989415e-1, -0.65785e-1, 0.128922e-1, 0.0, 0.0],
