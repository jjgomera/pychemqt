...
class C5F12(MEoS):
    """Ecuación de estado de multiparametros para el perfluoropentano
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.86275e1, 0.13120e2, -0.12690e2, -0.63017e1, -0.65096e2], "exp": [1.0, 1.5, 1.6, 4.0, 15.0]}
    _liquid_Density={ "eq": 1, "ao": [0.44087, 0.10672e2, -0.95203e1, 0.18688e1, -0.31782e1], "exp": [0.09, 0.75, 0.9, 2.0, 8.0]}
    _vapor_Density={ "eq": 3, "ao": [-0.57928, -0.60202e1, -0.16560e2, -0.67528e2, -0.55108e3], "exp": [0.13, 0.7, 2.3, 5.5, 15.0]}
