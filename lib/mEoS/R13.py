...
class R13(MEoS):
    """Ecuación de estado de multiparametros para el R13
    ...
    CP1={  "ao": 1.86012334,
                "an": [8.07314520, -1.87713639, 3.17242858e-2],
                "pow": [1, 2, 3],
                "ao_exp": [], "exp": [],
                "ao_hyp": [],"hyp": []}
    ...
    helmholtz1={
        ...
        "nr1": [-0.628346559920, 0.792797111341, -0.134038992692, 0.761143010172, -0.194465098795e1, 0.940938700406, -0.108107050239e1, 0.117501564976, 0.228305167217, -0.403338888789, 0.375585713420, -0.617543677315e-1, 0.170326226881, 0.536612457231e-1, -0.151603010301, 0.252033265074e-1],
        "d1": [0, 0, 0, 1, 1, 1, 1, 1, 2, 2, 2, 3, 3, 4, 4, 5],
        "t1": [3, 4, 5, 0, 1, 2, 3, 4, 0, 1, 2, 0, 1, 0, 1, 1],

        "nr2": [0.628346559920, -0.792797111341, 0.134038992692, -0.399863840975e-1, 0.436410910529, -0.448724904991],
        "d2": [0, 0, 0, 2, 2, 2],
        "t2": [3, 4, 5, 3, 4, 5],
        "c2": [2]*6,
        "gamma2": [0.98230055]*6}
    ...
    _surface={"sigma": [0.0506], "exp": [1.28]}
    _vapor_Pressure={ "eq": 5, "ao": [-0.69311e1, 0.18281e1, -0.21901e1, -0.38177e1, 0.20803e1], "exp": [1.0, 1.5, 2.5, 6.0, 8.0]}
    _liquid_Density={ "eq": 1, "ao": [0.95469e1, -0.24017e2, 0.33365e2, -0.26837e2, 0.10638e2], "exp": [0.51, 0.72, 0.94, 1.2, 1.4]}
    _vapor_Density={ "eq": 3, "ao": [-0.31949e1, -0.73425e1, -0.21966e2, -0.51459e2, -0.85359e2], "exp": [0.414, 1.41, 3.7, 7.7, 15.0]}
