...
class R507A(MEoS):
    """Ecuación de estado de multiparametros para el R507A
    50% R125, 50% R143a
    ...
    helmholtz1={
        ...
        "nr1": [0.624982e1, -0.807855e1, 0.264843e-1, 0.286215, -0.507076e-2, 0.109552e-1, 0.116124e-2],
        "d1": [1, 1, 1, 2, 2, 4, 6],
        "t1": [0.692, 0.943, 5.8, 0.77, 5.84, 0.24, 0.69],

        "nr2": [0.138469e1, -0.922473, -0.503562e-1, 0.822098, -0.277727, 0.358172, -0.126426e-1, -0.607010e-2, -0.815653e-1, -0.233323e-1, 0.352952e-1, 0.159566e-1, 0.755927e-1, -0.542007e-1, 0.170451e-1],
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-7.5459, 2.338, -2.237, -4.1535], "exp": [1, 1.5, 2.1, 4.7]}
    _liquid_Pressure={ "eq": 5, "ao": [-7.4853, 2.0115, -2.0141, -3.7763], "exp": [1, 1.5, 2., 4.6]}
