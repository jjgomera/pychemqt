...
#        "eq": "MBWR", 
    ...
    _surface={"sigma": [0.049561, 0.055607, -0.067899], "exp": [1.26, 1.76, 2.26]}
    _vapor_Pressure={ "eq": 5, "ao": [-0.22360e2, 0.60938e3, -0.15037e4, 0.10657e4, -0.16142e3], "exp": [1, 1.5, 1.65, 1.8, 2.2]}
    _liquid_Density={ "eq": 1, "ao": [0.20433e1, -0.66050e1, 0.10613e2, -0.38994e1, 0.88965], "exp": [0.11, 0.3, 0.5, 0.8, 2.1]}
    _vapor_Density={ "eq": 3, "ao": [-0.83044, -0.99128e1, 0.12790e3, -0.27390e4, 0.88175e4, -0.85578e4], "exp": [0.08, 1.0, 5.0, 6.0, 7.0, 8.0]}
