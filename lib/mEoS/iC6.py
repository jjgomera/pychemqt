...
class iC6(MEoS):
    """Ecuación de estado de multiparametros para el  iso-hexano
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.74130e1, 0.16267e1, -0.22311e1, -0.26040e1, -0.29490e1], "exp": [1.0, 1.5, 2.62, 4.56, 16.3]}
    _liquid_Density={ "eq": 1, "ao": [0.18489e2, -0.43541e2, 0.43985e2 , -0.16581e2, 0.64563], "exp": [0.59, 0.77, 0.96, 1.15, 3.2]}
    _vapor_Density={ "eq": 3, "ao": [-0.41180e1, -0.61956e1, -0.21190e2, -0.58972e2, -0.15824e3], "exp": [0.4824, 1.418, 3.32, 7.1, 16.1]}
    ...
    visco0={"eq": 2, "omega": 3,
                ...
                "F": [0, 0, 0, 100.],
                "E": [-13.294469653994, -466.41004563, 15.438316998, -3363.2028894, -0.11398677788, 171.32077134, 2849.7100897],
                "rhoc": 2.727}
    ...
    thermo0={"eq": 1, "critical": 0,
                ...
                "nb": [13.747515904, 10.1607102792, -7.75232868497, 0.627943006907, 1.9518640415, -0.293574041046],
                "tb": [0, 0, 0, -1, 0, -1],
                "db": [1, 3, 4, 4, 5, 5],
                "cb": [0]*6}
