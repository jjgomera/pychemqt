...
class CF3I(MEoS):
    """Ecuación de estado de multiparametros para el trifluoroiodometano
    ...
    helmholtz1={
        ...
        "nr1": [0.112191e1, -0.308087e1, 0.111307e1, -0.184885, 0.110971, 0.325005e-3],
        "d1": [1, 1, 1, 2, 3, 7],
        "t1": [0.23, 1.125, 1.5, 1.375, 0.25, 0.875],

        "nr2": [0.333357, -0.288288e-1, -0.371554, -0.997985e-1, -0.333205e-1, 0.207882e-1],
        "d2": [2, 5, 1, 4, 3, 4],
