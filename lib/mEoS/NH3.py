...
class NH3(MEoS):
    """Ecuación de estado de multiparametros para el amoniaco
    ...
    CP1={  "ao": 0,
                "an": [2.54985265683/405.40**-0.333, 4.86079045595/405.40**1.5, -2.74637680305/405.40**1.75],
                "pow": [-1./3, 1.5, 1.75],
                "ao_exp": [], "exp": [],
                "ao_hyp": [], "hyp": []}

    CP2={  "ao": 5.111814,
                "an": [-0.42966650e2, -0.10243792e-1, 0.38750775e-4, -0.46406097e-7, 0.20268561e-10 ],
                "pow": [-1.001, 1, 2, 3, 4],
                "ao_exp": [], "exp": [],
                "ao_hyp": [], "hyp": []}
    ...
    helmholtz1={
        ...
        "nr1":  [-0.1858814e01, 0.4554431e-1, 0.7238548 , 0.1229470e-1, 0.2141882e-10],
        "d1": [1, 2, 1, 4, 15],
        "t1": [1.5, -0.5, 0.5, 1., 3.],

        "nr2": [-0.1430020e-1, 0.3441324, -0.2873571, 0.2352589e-4, -0.3497111e-1, 0.1831117e-2, 0.2397852e-1, -0.4085375e-1, 0.2379275, -0.3548972e-1, -0.1823729, 0.2281556e-1, -0.6663444e-2, -0.8847486e-2, 0.2272635e-2, -0.5588655e-3],
    ...
    helmholtz3={
        ...
        "nr2": [-0.56216175e-1, 0.44935601, 0.29897121e-1, -0.18181684, -0.9841666e-1, -0.55083744e-1, -0.88983219e-2],
        "d2": [1, 2, 5, 1, 1, 4, 2],
    ...
    _melting={"eq": 1, "Tref": Tt, "Pref": 1000, "a1": [], "exp1": [], "a2": [], "exp2": [], "a3": [0.2533125e4], "exp3": [1]}
    _surface={"sigma": [0.12190, 0.04015], "exp": [1.26, 2.26]}
    _vapor_Pressure={ "eq": 5, "ao": [-0.70993e1, -0.24330e1, 0.87591e1, -0.64091e1, -0.21185e1], "exp": [1., 1.5, 1.7, 1.95, 4.2]}
    _liquid_Density={ "eq": 1, "ao": [0.34488e2, -0.12849e3, 0.17382e3, -0.10699e3, 0.30339e2], "exp": [0.58, 0.75, 0.9, 1.1, 1.3]}
    _vapor_Density={ "eq": 3, "ao": [-0.38435, -0.40846e1, -0.66634e1, -0.31881e2, 0.21306e3, -0.24648e3], "exp": [0.218, 0.55, 1.5, 3.7, 5.5, 5.8]}
    ...
    visco0={"eq": 1, "omega": 1,
                ...
                "n_poly": [2.19664285e-1, -0.83651107e-1, 0.17366936e-2, -0.64250359e-2, 1.67668649e-4, -1.49710093e-4, 0.77012274e-4],
