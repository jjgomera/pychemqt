...
class R407C(MEoS):
    """Ecuación de estado de multiparametros para el R407C
    ...
    helmholtz1={
        ...
        "nr2": [-0.175725e1, -0.112009e1, 0.277353e-1, 0.898881, -0.117591e1, 0.818591e-1, -0.794097e-1, -0.104047e-4, 0.233779, -0.291790, 0.154776e-1, -0.314579e-1, -0.442552e-2, -0.101254e-1, 0.915953e-2, -0.361575e-2],
        "d2": [1, 2, 2, 3, 3, 5, 5, 5, 1, 1, 4, 4, 2, 4, 5, 6],
        "t2": [2.15, 2.43, 5.3, 0.76, 1.48, 0.24, 2.86, 8., 3.3, 4.7, 0.45, 8.4, 16.2, 26, 16, 8.7],
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.086077, -6.6364, -2.4648, -3.4776], "exp": [0.4, 0.965, 3.1, 5.]}
    _liquid_Pressure={ "eq": 5, "ao": [0.48722, -6.6959, -1.4165, -2.5109], "exp": [0.54, 0.925, 2.7, 4.7]}
