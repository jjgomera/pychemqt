...
class R1234ze(MEoS):
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.76813e1, 0.31759e1, -0.26397e1, -0.35234e1], "exp": [1.0, 1.5, 1.8, 3.9]}
    _liquid_Density={ "eq": 1, "ao": [0.16130e1, 0.46976e1, -0.68759e1, 0.34227e1], "exp": [0.31, 0.94, 1.2, 1.5]}
    _vapor_Density={ "eq": 3, "ao": [-0.24897e1, -0.63324e1 , -0.20262e2, -0.62612e2], "exp": [0.36, 1.07, 3.0, 6.8]}
    ...
    thermo0={"eq": 1,
                ...
                "nb": [-0.10750600e-2, -0.11560800e-1, 0.76230400e-2, 0.0, 0.0, 0.0, 0.10181100e-1, -0.22450100e-2, 0.0, 0.0],
