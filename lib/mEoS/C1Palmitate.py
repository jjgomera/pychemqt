...
class C1Palmitate(MEoS):
    """Ecuación de estado de multiparametros para el metilpalmitate
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.13378e2, 0.12258e2, -0.12205e2, -0.58118e1, -0.25451e1], "exp": [1.0, 1.5, 2.04, 4.3, 8.0]}
    _liquid_Density={ "eq": 1, "ao": [-0.54203, 0.13191e2, -0.20107e2, 0.11328e2, -0.60761], "exp": [0.18, 0.5, 0.7, 0.9, 1.5]}
    _vapor_Density={ "eq": 3, "ao": [-0.11612e2, 0.16300e3, -0.47913e3, 0.72986e3, -0.48202e3, -0.18198e3], "exp": [0.65, 1.78, 2.15, 2.7, 3.1, 9.8]}
