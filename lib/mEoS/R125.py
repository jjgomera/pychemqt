...
class R125(MEoS):
    """Ecuación de estado de multiparametros para el R125
...
#    id=1231
    ...
    CP3={  "ao": 4.3987,
                "an": [0.0242728, -0.4099e-5],
                "pow": [1, 2],
                "ao_exp": [], "exp": [],
                "ao_hyp": [],"hyp": []}

    CP4={  "ao": 25.87069,
                "an": [0.2690914, -1.331388e-4, 4.10133e-9],
                "pow": [1, 2, 3],
                "ao_exp": [], "exp": [],
                "ao_hyp": [],"hyp": []}
    ...
    helmholtz1={
        ...
        "nr2": [0.4777189e1, -0.3330988e1, 0.3775673e1, -0.2290919e1, 0.8888268, -0.6234864, -0.4127263e-1, -0.8455389e-1, -0.1308752, 0.8344962e-2],
    ...
    helmholtz2={
        ...
        "nr2": [0.1225177e1, -0.2147964e1, -0.298138, 0.3391211, -0.6322995e-3, 0.1271747e-3, 0.5026962e-5, -0.1667058, -0.733275e-1, -0.637878e-1, 0.683311e-5, -0.1995426e-1, 0.1260026e-1],
    ...
    helmholtz3={
        ...
        "nr1": [0.85393382372e-1, -0.133260499658, 0.257817782488, -0.735018179542, -0.787454743426, -0.190320468891e-1, 0.388329449013, -0.631901774641, 0.623842653447, 0.109925047828, -0.993099630896e-1, -0.104601585904e-1, -0.769998709731e-1, 0.149829594347e-1, 0.166640927925e-1, -0.181492321758e-2],
    ...
    helmholtz4={
        ...
        "nr1": [0.11290996e1, -0.28349269e1, 0.29968733, 0.87282204e-1, 0.26347747e-3],
        "d1": [1, 1, 1, 3, 7],
        "t1": [0.25, 1.25, 1.5, 0.25, 0.875],

        "nr2": [0.61056963, 0.90073581, -0.68788457e-2, -0.44211186, -0.35041493e-1, -0.1269863, -0.25185874e-1],
        "d2": [1, 2, 5, 1, 1, 4, 2],
    ...
    helmholtz5={
        ...
        "nr1": [1.51628822, -1.4959805, -1.2893965, 1.47295195, -2.22976436, 1.02082011, -9.61695881e-3, 4.14142522e-2],
        "d1": [1, 1, 1, 2, 2, 2, 3, 4],
        "t1": [0.5, 0.75, 2.25, 0.5, 0.875, 2, 3, 0.5],

        "nr2": [1.46217490e-1, -6.56486371e-2, -9.18319727e-2, -2.90343386e-2, -1.74343357e-2, -8.77406498e-4, -5.10648362e-3, 3.52425947e-3, 4.98022850e-4],
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-7.5295, 1.9026, -2.2966, -3.448], "exp": [1, 1.5, 2.3, 4.6]}
    _liquid_Density={ "eq": 2, "ao": [1.6684, 0.88415, 0.44383], "exp": [1, 1.8, 8.7]}
    _vapor_Density={ "eq": 3, "ao": [-2.8403, -7.2738, -21.89, -58.825], "exp": [0.38, 1.22, 3.3, 6.9]}
    ...
    thermo0={"eq": 1,
                ...
                "nb": [-0.729410e-2, 0.110497e-1, 0.416339e-1, -0.289236e-1, -0.311487e-1, 0.278399e-1, 0.112682e-1, -0.121100e-1, -0.138322e-2, 0.211196e-2],
                "tb": [0, 1]*5,
