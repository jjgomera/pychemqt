...
class R41(MEoS):
    """Ecuación de estado de multiparametros para el R41
    ...
    helmholtz1={
        ...
        "nr2": [-0.22189, 0.55021, 0.04610, -0.056405, -0.17005, -0.032409, -0.012276],
        "d2": [1, 2, 5, 1, 1, 4, 2],
    ...
    helmholtz2={
        ...
        "nr2": [-0.37093, 0.33920, -0.0017413, -0.095417, -0.078852, -0.030729, -0.011497],
        "d2": [1, 2, 5, 1, 1, 4, 2],
    ...
    MBWR={
        ...
        "R": 8.314471,
        "cp": CP2,
        "b": [None, -0.326441485138e-1, 0.338620074694e1, -0.831696847103e2, 0.139589938388e5, -0.156113972752e7, -0.165160386413e-2, 0.118821153813e1, -0.137311604695e3, 0.176999573025e6, 0.164945271187e-4, 0.595329911829e-1, -0.341969857376e2, -0.168552064750e-2, -0.758216269071e-2, -0.134800586220e2, 0.311348265418e-2, -0.651499088798e-4, 0.184033192190e-1, -0.281459127843e-3, -0.186344956951e6, 0.110422095705e8, -0.147526754027e4, 0.261603025982e8 , -0.744431617418e1, 0.782355157170e3, -0.562784094508e-2, -0.843317187588e3, -0.600934897964e-4, 0.145050417148e-1 , 0.222324172533e-7, -0.204419971811e-4, 0.245556593457e-3]}

    eq=helmholtz1, MBWR, helmholtz2

    _surface={"sigma": [0.0633], "exp": [1.26]}
    _vapor_Pressure={ "eq": 5, "ao": [-0.70970e1, 0.17409e1, -0.11668e1, -0.31830e1, 0.93827], "exp": [1.0, 1.5, 2.2, 4.8, 6.2]}
    _liquid_Density={ "eq": 1, "ao": [0.18181e2, -0.62193e2, 0.85171e2, -0.66958e2, 0.28790e2], "exp": [0.58, 0.8, 1.0, 1.3, 1.5]}
    _vapor_Density={ "eq": 3, "ao": [-0.26966e2, 0.54303e2, -0.36361e2, -0.17816e2, -0.48535e2, -0.86727e2], "exp": [0.59, 0.72, 0.86, 3.2, 7.0, 15.0]}
