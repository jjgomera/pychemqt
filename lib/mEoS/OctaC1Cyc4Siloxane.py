...
#    id=1430
    ...
    CP1={ "ao": -18.256,
                "an": [1427.2e-3, -990.20e-6, 300.0e-9],
                "pow": [1, 2, 3],
                "ao_exp": [],
                "exp": [],
                "ao_hyp": [],"hyp": []}
    ...
    helmholtz1={
        ...
        "nr1": [1.05392408, -2.22981918, 0.77573923, -0.6937405, 0.18721557, 0.42193330e-3],
        "d1": [1, 1, 1, 2, 3, 7],
        "t1": [0.25, 1.125, 1.5, 1.375, 0.25, 0.875],
 
        "nr2": [0.70301835, 0.47851888e-1, -0.8025348, -0.18968872, -0.22211781e-1, 0.60103354e-2],
        "d2": [2, 5, 1, 4, 3, 4],
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.87935e1, 0.27204e1, -0.48174e1, -0.69086e1], "exp": [1.0, 1.5, 2.2, 4.4]}
    _liquid_Density={ "eq": 1, "ao": [0.14563e1, -0.94215, 0.45065e1, -0.27688e1, 0.8745], "exp": [0.24, 0.5, 0.75, 1.0, 2.0]}
    _vapor_Density={ "eq": 3, "ao": [-0.16204e1, -0.57888e1, -0.24291e2, 0.53567e2, -0.12135e3, -0.10976e4], "exp": [0.31, 0.78, 2.5, 4.4, 5.0, 15.0]}
