...
#        "Pmin": 0.61166, "rhomin": 55.497,
    ...
    _vapor_Pressure = {
        "eq": 3,
        "n": [-0.72217e1, -0.18886e2, 0.47288e2, -0.29794e2, -0.50457e1],
        "t": [1.0, 1.5, 1.65, 1.8, 4.8]}
    _liquid_Density = {
        "eq": 1,
        "n": [0.36787e1, -0.20581e1, 0.98945, 0.60478e-1],
        "t": [0.4, 0.6, 0.8, 2.0]}
    _vapor_Density = {
        "eq": 2,
        "n": [-0.42967e1, -0.10715e2, -0.33457e2, -0.72206e2],
        "t": [0.486, 1.7, 4.2, 8.0]}
