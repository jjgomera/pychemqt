...
class Cyclopentane(MEoS):
    ...
    CP1={  "ao": 3.263,
                "an": [], "pow": [],
                "ao_exp": [2.151, 19.55, 14.45, 3.594], "exp": [179.0, 1336.0, 2911.0, 6420.0],
                "ao_hyp": [],"hyp": []}
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.64587e1, -0.12785e1, 0.35385e1, -0.24397e1, -0.29460e1], "exp": [1.0, 1.5, 1.83, 2.3, 4.3]}
    _liquid_Density={ "eq": 1, "ao": [0.27702e1, -0.17446, -0.11490e1, 0.13386e1, -0.36109e-1], "exp": [0.44, 0.7, 1.7, 2.0, 4.0]}
    _vapor_Density={ "eq": 3, "ao": [-0.32453e1, -0.58511e1, -0.19268e2, -0.11351e3, 0.33499e3, -0.34655e3], "exp": [0.458, 1.22, 3.28, 7.7, 10.0, 11.0]}
