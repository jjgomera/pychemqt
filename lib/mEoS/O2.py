...
class O2(MEoS):
    """Ecuación de estado de multiparametros para el oxígeno
    ...
    CP1={"ao": 3.51808732, 
                "an": [], "pow": [], 
                "ao_exp": [0.102323928e1, 0.784357918 , 0.337183363e-2, -.170864084e-1, 0.463751562e-1], "exp": [2246.32440, 11259.9763, 1201.26209, 69.0089445, 5328.05445],
                "ao_hyp": [], "hyp": []}
    CP2={"ao": 3.521876773671, 
                "an": [-0.4981998537119e4, 0.2302477799952e3, -0.3455653235107e1, 0.3521876773671e1, -0.4354202160244e-4, 0.1346353450132e-7, 0.1620598259591e-10], "pow": [-3, -2, -1.001, 1, 2, 3], 
    ...
    helmholtz1={
        ...
        "nr1":  [0.39837687490, -0.18461574540e1, 0.41834731970, 0.23706207110e-1, 0.97717305730e-1, 0.30178912940e-1, 0.22733532120e-1, 0.13572540860e-1, -0.40526989430e-1, 0.54546285150e-3, 0.51131822770e-3, 0.29534668830e-6 , -0.86876450720e-4],
        "d1": [1, 1, 1, 2, 2, 2, 3, 3, 3, 6, 7, 7, 8],
        "t1": [0, 1.5, 2.5, -0.5, 1.5, 2, 0, 1, 2.5, 0, 2, 5, 2],

        "nr2": [-0.21270825890, 0.87359419580e-1, 0.12755091900, -0.90677010640e-1, -0.35400842060e-1, -0.36232780590e-1, 0.13276992900e-1, -0.32541118650e-3, -0.83135829320e-2, 0.21245705590e-2, -0.83252062320e-3, -0.26261732760e-4, 0.25995814820e-2, 0.99846496630e-2, 0.21999231530e-2, -0.25913504860e-1, -0.12596308480, 0.14783556370, -0.10112510780e-1],
    ...
    GERG={
        ...
        "nr1": [0.88878286369701, -0.24879433312148e1, 0.59750190775886, 0.96501817061881e-2, 0.71970428712770e-1, 0.22337443000195e-3],
        "d1": [1, 1, 1, 2, 3, 7],
        "t1": [0.25, 1.125, 1.5, 1.375, 0.25, 0.875],

        "nr2": [0.18558686391474, -0.38129368035760e-1, -0.15352245383006, -0.26726814910919e-1, -0.25675298677127e-1, 0.95714302123668e-2],
        "d2": [2, 5, 1, 4, 3, 4],
    ...
    MBWR={
        ...
        "b": [None, -0.4365859650e-3, 0.2005820677, -0.4197909916e1, 0.1878215317e3, -0.1287473398e5, 0.1556745888e-4, 0.1343639359e-2, -0.2228415518e1, 0.4767792275e4, 0.4790846641e-6, 0.2462611107e-2, -0.1921891680, -0.6978320847e-5, -0.6214145909e-3, -0.1860852567, 0.2609791417e-4, -0.2447611408e-6, 0.1457743352e-3, -0.1726492873e-5, -0.2384892520e4, -0.2301807796e6, -0.2790303526e2, 0.9400577575e5, -0.4169449637e-1, 0.2008497853e1, -0.1256076520e-3, -0.6406362964, -0.2475580168e-7, 0.1346309703e-4, -0.1161502470e-9, -0.1034699798e-7, 0.2365936964e-6]}
    ...
    _dielectric={"eq": 3, "Tref": 273.16, "rhoref": 1000.,
                            ...
                            "a2": [0.575, 1.028, -8.96, -5.15], "expt2": [0, 1, 0, 1], "expd2": [2, 2, 2.5, 2.5]}
    _melting={"eq": 2, "Tref": Tt, "Pref": 0.14633, "a1": [], "exp1": [], "a2": [-0.32463539e2, 0.14278011e3, -0.14702341e3, 0.520012e2], "exp2": [0.0625, 0.125, 0.1875, 0.25], "a3": [], "exp3": []}
    _sublimation={"eq": 3, "Tref": Tt, "Pref": 0.14633, "a1": [], "exp1": [], "a2": [-20.714], "exp2": [1.06], "a3": [], "exp3": []}
    _vapor_Pressure={ "eq": 5, "ao": [-0.60595e1, 0.13050e1, -0.54178, -0.19410e1, 0.35514], "exp": [1., 1.5, 2.2, 4.8, 6.2]}
    _liquid_Density={ "eq": 1, "ao": [0.16622e1, 0.76846, -0.10041, 0.20480, 0.11551e-1], "exp": [0.345, 0.74, 1.2, 2.6, 7.2]}
    _vapor_Density={ "eq": 3, "ao": [-0.22695e1, -0.46578e1, -0.99480e1, -0.22845e2, -0.45190e2, -0.25101e2], "exp": [0.3785, 1.07, 2.7, 5.5, 10., 20.]}
    ...
    visco1={"eq": 2, "omega": 2,
                "collision": [-67.2093902106092, 277.148660965491, -399.192753863192, 166.828729537446, 143.163477478684, -191.767060368781, 98.4332230147836, -22.9410694301649, 2.12402264924749],
                ...
                "E": [-14.45497211, 243.40689667, 12.9006761056004, -1949.07966423848, -5.62078436742e-2 , 21.3075467849104, 48.9965711691056 ],
    ...
    visco3={"eq": 1, "omega": 1,
                ...
                "Tref": 1., "etaref": 1,
                "ek": 88.23, "sigma": 0.3553,
                "n_chapman": 0.1510114/M**0.5,

                "Tref_res": 154.581, "rhoref_res": 13.63*M, "etaref_res": 1,
                "n_poly": [0.103809798626e2, 0.403390706685e1, 0.769190803355e1, 0.708616708447, -0.294875160018e1, 0.195703358963e1],
                "t_poly": [-0.4781, -2.5395, -0.2470, -3.6591, -1.7659, -0.5906],
                "d_poly": [1, 2, 3, 3, 4, 9],
                "g_poly": [0, 0, 0, 0, 0, 0],
                "c_poly": [0, 0, 0, 0, 0, 0]}
    ...
    thermo1={"eq": 3,
                ...
                "tchapman": 0,
                "b": [-1.41202117453516, 8.06267523869911, -19.44147946395, 25.78193316324, -20.5167203343277, 10.0087040966906, -2.90450673487991, 0.459605807669332, -3.01906029521e-2],
                "F": [0.00097916328, 0.00089116658, 1.12, 100],
                "E": [-21.520741137, 473.50508788, 11.9072051301147, -2122.44247203833, 0, 0, 0],
    ...
    thermo3={"eq": 1,
                ...
                "Trefb": 154.581, "rhorefb": 13.63, "krefb": 1e-3,
                "nb": [8.14209592824, 0.434593624281e2, -0.70435226917, -0.968827184599e2, 0.108596324161e2, 0.276237290848e2],
                "tb": [-0.1741, -0.2976, -0.4782, -0.5835, 0.061, -6.9683],
                "db": [1, 2, 7, 3, 3, 5],
                "cb": [0, 0, 1, 1, 2, 2],

                "critical": 3,
                "gnu": 0.63, "gamma": 1.2415, "R0": 1.01,
                "Xio": 0.26629434e-9, "gam0": 0.055, "qd": 0.54637186e-9, "Tcref": 309.162}
