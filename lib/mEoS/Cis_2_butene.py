...
class Cis_2_butene(MEoS):
    """Ecuación de estado de multiparametros para el cis-2-buteno
    ...
    eq=helmholtz1,
    _vapor_Pressure={ "eq": 5, "ao": [-0.70022e1, 0.13695e1, -0.30509e1, 0.10012, -0.15577e1], "exp": [1.0, 1.5, 3.2, 3.46, 6.4]}
    _liquid_Density={ "eq": 1, "ao": [0.46849e1, -0.54614e1, 0.34718e1, 0.50511e1, -0.50389e1], "exp": [0.402, 0.54, 0.69, 6.6, 7.0]}
    _vapor_Density={ "eq": 3, "ao": [-0.28918e1, -0.58582e1, -0.17443e2, -0.24566e2, -0.29413e2, -0.11392e3], "exp": [0.4098, 1.174, 3.11, 6.1, 7.6, 14.8]}
