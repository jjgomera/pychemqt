...
class neoC5(MEoS):
    """Ecuación de estado de multiparametros para el neo-pentano
    ...
    CP2={  "ao": -0.435375/8.3143*72.151,
                "an": [0.96766e-2/8.3143*72.151, -0.11533e-4/8.3143*72.151, 0.108006e-7/8.3143*72.151,  -0.44851e-11/8.3143*72.151],
                "pow": [1, 2, 3, 4],
                "ao_exp": [], "exp": [],
                "ao_hyp": [], "hyp": []}
    ...
    helmholtz2={
        ...
        "nr1":  [-0.146552261671e1, 0.199230626557e1, -0.500821886276, 0.119809758161e1, -0.363135896710e1, 0.312770556886e1, -0.237405105853e1, 0.473735725047, 0.101500881659, 0.184937708516, -0.290527628579e-1, -0.258919377284e-1, 0.748831217999e-1, 0.216569936506e-1, -0.100375687935, 0.234924630013e-1],
        "d1": [0, 0, 0, 1, 1, 1, 1, 1, 2, 2, 2, 3, 3, 4, 4, 5],
        "t1": [3, 4, 5, 0, 1, 2, 3, 4, 0, 1, 2, 0, 1, 0, 1, 1],


        "nr2": [0.146552261671e1, -0.199230626557e1, 0.500821886276, -0.834410647812, 0.262918341468e1, -0.188136966583e1],
        "d2": [0, 0, 0, 2, 2, 2],
        "t2": [3, 4, 5, 3, 4, 5],
        "c2": [2]*6,
        "gamma2": [0.968832]*6}
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.70262e1, 0.20090e1, -0.19932e1, -0.28503e1, -0.53760], "exp": [1.0, 1.5, 2.2, 4.8, 6.2]}
    _liquid_Density={ "eq": 1, "ao": [0.56080e1, -0.13549e2, 0.29912e2, -0.28143e2, 0.89021e1], "exp": [0.45, 0.7, 1.0, 1.25, 1.6]}
    _vapor_Density={ "eq": 3, "ao": [-0.25177e1, -0.63565e1, -0.11985e3, 0.43740e3, -0.10749e4, 0.74007e3], "exp": [0.366, 1.14, 4.0, 5.0, 6.0, 6.5]}
