...
class R141b(MEoS):
    """Ecuación de estado de multiparametros para el R141b
...
#    id=1633
    ...
    helmholtz1={
        ...
        "nr2": [0.32720, 0.46946, -0.029829, -0.31621, -0.026219 , -0.078043, -0.020498],
        "d2": [1, 2, 5, 1, 1, 4, 2],
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.73784e1, 0.52955e1, -0.46639e1, -0.31122e1, -0.18972e1], "exp": [1.0, 1.5, 1.7, 4.2, 9.0]}
    _liquid_Density={ "eq": 1, "ao": [0.10443e2, -0.24726e2, 0.27718e2, -0.11220e2, 0.75848], "exp": [0.49, 0.68, 0.88, 1.1, 2.9]}
    _vapor_Density={ "eq": 3, "ao": [-0.31177e1, -0.68872e1, -0.18566e2, -0.40311e2, -0.95472e1, -0.12482e3], "exp": [0.398, 1.33, 3.3, 6.7, 7.0, 14.0]}
