...
class D6(MEoS):
    ...
    trnECS = {"__name__": "Huber (2018)",
              ...
              "psi": [1.06991, 0.00448715], "psi_d": [0, 1],
              "fint": [0.00132], "fint_t": [0],
              "chi": [1.38744, 0.127827], "chi_d": [0, 1],

              "critical": 3,
              "gnu": 0.63, "gamma": 1.239, "R0": 1.02,
              "Xio": 0.341e-9, "gam0": 0.072, "qd": 1.17e-9, "Tcref": 1.5*Tc}
...
class Test(TestCase):
    ...
    def test_Huber(self):
        """Table 7, pag 266"""
        st = D6(T=581.2, rhom=1.371)
        self.assertEqual(round(st.mu.muPas, 4), 124.8445)
        self.assertEqual(round(st.k.mWmK, 4), 55.3611)
