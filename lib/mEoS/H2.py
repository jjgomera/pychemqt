...
class H2(MEoS):
    """Ecuación de estado de multiparametros para el hidrógeno (normal)
    ...
    CP1={"ao": 2.5, 
                "an": [],"pow": [], 
                "ao_exp": [1.616, -0.4117, -0.792, 0.758, 1.217], "exp": [531., 751., 1989., 2484., 6859.], 
                "ao_hyp": [],"hyp": []}

    CP2={"ao": 0.72480209e3, 
                "an": [0.12155215e11, -0.36396763e10, 0.43375265e9, -0.23085817e8, -0.38680927e4, 0.88240136e5, -0.78587085e4, -0.18426806e3, 0.21801550e2, -0.13051820e1, 0.21003175e-1, 0.23911604e-2, -0.18240547e-3, 0.56149561e-5, -0.73803310e-7, 0.66357755e-11],"pow": [-7, -6, -5, -4, -3, -2, -1.001, 0.5, 1, 1.5, 2, 2.5, 3, 3.5, 4, 5], 
                "ao_exp": [], "exp": [], 
                "ao_hyp": [],"hyp": []}
    ...
    MBWR={
        ...
        "b": [None, 0.4675528393416e-3, 0.4289274251454e-1, -0.5164085596504, 0.2961790279801e1, -0.3027194968412e2, 0.1908100320379e-4, -0.1339776859288e-2, 0.3056473115421, 0.5161197159532e2, 0.1999981550224e-6, 0.2896367059356e-3, -0.2257803939041e-1, -0.2287392761826e-5, 0.2446261478645e-4, -0.1718181601119e-2, -0.5465142603459e-6, 0.4051941401315e-8, 0.1157595123961e-5, -0.1269162728389e-7, -0.4983023605519e2, -0.1606676092098e3, -0.1926799185310, 0.9319894638928e1, -0.3222596554434e-3, 0.1206839307669e-2, -0.3841588197470e-6, -0.4036157453608e-4, -0.1250868123513e-9, 0.1976107321888e-8, -0.2411883474011e-12, -0.4127551498251e-12, 0.8917972883610e-11]}
    ...
    GERG={
        ...
        "nr1":  [ 0.53579928451252e1, -0.62050252530595e1,  0.13830241327086, -0.71397954896129e-1,  0.15474053959733e-1],
        "d1": [1, 1, 2, 2, 4],
        "t1": [0.5, 0.625, 0.384, 0.625, 1.125],

        "nr2": [-0.14976806405771, -0.26368723988451e-1 ,  0.56681303156066e-1, -0.60063958030436e-1, -0.45043942027132,  0.42478840244500, -0.21997640827139e-1, -0.10499521374530e-1, -0.28955902866816e-2],
    ...
    helmholtz3={
        ...
        "nr1": [0.133442326203e1, -0.104116843433e1, 0.227202245707, 0.300374270906, -0.463984214813, -0.178010492282e1, 0.100460103605e1, -0.187200622541, 0.980276957749e-2, 0.543224866339e-1, -0.263496312610e-1, 0.315432315759e-1, -0.525788294155e-1, -0.685380627808e-2, 0.344540276656e-1, -0.555747275982e-3],
        "d1": [0, 0, 0, 1, 1, 1, 1, 1, 2, 2, 2, 3, 3, 4, 4, 5],
        "t1": [3, 4, 5, 0, 1, 2, 3, 4, 0, 1, 2, 0, 1, 0, 1, 1],

        "nr2": [-0.133442326203e1, 0.104116843433e1, -0.227202245707, -0.378598758038, 0.249888797892, -0.498847982876e-1],
        "d2": [0, 0, 0, 2, 2, 2],
        "t2": [3, 4, 5, 3, 4, 5],
        "c2": [2]*6,
    ...
    _dielectric={"eq": 3, "Tref": 273.16, "rhoref": 1000.,
                            ...
                            "a2": [0.181, 0.021, -7.4], "expt2": [0, 1, 0], "expd2": [2, 2, 3]}
    _melting={"eq": 1, "Tref": Tt, "Pref": 7.3578, "a1": [1], "exp1": [0], "a2": [5626.3, 2717.2], "exp2": [1, 1.83], "a3": [], "exp3": []}
    _sublimation={"eq": 3, "Tref": Tt, "Pref": 7.7, "a1": [], "exp1": [], "a2": [-8.065], "exp2": [0.93], "a3": [], "exp3": []}
    _vapor_Pressure={ "eq": 5, "ao": [-0.489789e1, 0.988558, 0.349689, 0.499356], "exp": [1.0, 1.5, 2.0, 2.85]}
    _liquid_Density={ "eq": 1, "ao": [0.15456e2, -0.41720e2, 0.50276e2, -0.27947e2, 0.56718e1], "exp": [0.62, 0.83, 1.05, 1.3, 1.6]}
    _vapor_Density={ "eq": 3, "ao": [-0.29962e1, -0.16724e2, 0.15819e2, -0.16852e2, 0.34586e2, -0.53754e2], "exp": [0.466, 2, 2.4, 4., 7., 8.]}
    ...
    def _visco0(self):
        ...
        def DILV(T):
            b=[-0.1841091042788e2, 0.3185762039455e2, -0.2308233586574e2, 0.9129812714730e1, -0.2163626387630e1, 0.3175128582601, -0.2773173035271e-1, 0.1347359367871e-2, -0.2775671778154e-4]
            suma=0
            for i, b in enumerate(b):
                suma+=b*T**((-3.+i)/3)
            return suma*100
        def EXCESV(rho, T):
            c=[-0.1324266117873e2, 0.1895048470537e2, 0.2184151514282e2, 0.9771827164811e5, -0.1157010275059e4, 0.1911147702539e3, -0.3186427506942e4, 0.0705565000000]
