...
class R23(MEoS):
    """Ecuación de estado de multiparametros para el R23
    ...
    CP2={  "ao": 3.999509244,
                "an": [], "pow": [],
                "ao_exp": [1.070326018, 1.566866769, 0.848051597, 1.847243699, 1.649657530, 2.043965290],
                "exp": [4368.102594, 1607.104940, 1007.138279, 1973.991027, 1657.461854, 729.455868],
                "ao_hyp": [],"hyp": []}

    CP3={  "ao": 4.0101431,
                "an": [-0.55274742e-2, 0.74008258e-4, -0.12590943e-6, 0.69472178e-10],
                "pow": [1, 2, 3, 4],
                "ao_exp": [], "exp": [],
                "ao_hyp": [],"hyp": []}
    ...
    helmholtz1={
        ...
        "nr1": [0.7041529e1, -0.8259512e1, 0.8053040e-2, -0.8617615e-1, 0.6333410e-2],
        "d1": [1, 1, 1, 2, 5],
        "t1": [0.744, 0.94, 4.3, 1.46, 0.68],

        "nr2": [-0.1863285, 0.3280510, 0.5191023, 0.6916144e-1, -0.5045875e-2, -0.1744221e-1 , -0.5003972e-1, 0.4729813e-1, -0.6164031e-1, 0.1583585e-1, -0.1795790e-2, -0.1099007e-2],
    ...
    helmholtz2={
        ...
        "nr1": [ 0.350093635099, -0.131185838025e1, -0.254118065769,  0.104275296122, -0.205326997924,  0.256040993750,  0.118078220087e-1,  0.532850915621e-3,  0.956700157221e-3, -0.118990410423e-5],
        "d1": [1, 1, 1, 2, 2, 2, 3, 4, 6, 8],
        "t1": [-0.14, 1.49, 2.41, 0.05, 1.59, 2.04, -0.27, 2.76, -0.06, 3.25],

        "nr2": [-0.180609172794,  0.138077199166,  0.507828500811e-1,  0.439772083175e-1, -0.723557234469e-1,  0.256500006055e-2,  0.263213487134e-1,  0.139266509424e-1, -0.105325247813e-1,  0.136475671500e-2, -0.592653649931e-2, -0.644925101471e-1, -0.227635186710e-1,  0.122367812706,  0.318153208563e-1,  0.146725272055e-1, -0.923639585566e-1],
        "d2": [1, 2, 2, 3, 3, 6, 6, 7, 7, 10, 2, 3, 4, 4, 5, 5, 5],
        "t2": [5.36, 5.28, 4.23, 3.35, 6.93, 8.48, 6.01, 3.34, 7.1, 5.46, 16.06, 19.37, 10.81, 22.79, 34.95, 9.94, 29.16],
    ...
    helmholtz3={
        ...
        "nr1": [-0.133234251368e1, 0.210373595421e1, -0.376198728030, 0.881622087335, -0.272053790906e1, 0.247468024356e1, -0.234010064393e1, 0.303959507238, 0.317372750273e-1, 0.329392142221e-1, 0.20583853186, 0.133550139894, -0.181698216766, -0.245123269882e-1, 0.247477874180e-1, 0.589916583383e-2],
        "d1": [0, 0, 0, 1, 1, 1, 1, 1, 2, 2, 2, 3, 3, 4, 4, 5],
        "t1": [3, 4, 5, 0, 1, 2, 3, 4, 0, 1, 2, 0, 1, 0, 1, 1],

        "nr2": [0.133234251368e1, -0.210373595421e1, 0.376198728030, 0.574267667948, -0.762218931280, 0.472710395636e-1],
        "d2": [0, 0, 0, 2, 2, 2],
        "t2": [3, 4, 5, 3, 4, 5],
        "c2": [2]*6,
        "gamma2": [0.70304082]*6}
    ...
    _surface={"sigma": [0.06562], "exp": [1.29]}
    _vapor_Pressure={ "eq": 5, "ao": [-7.2631,  1.3140, -0.78507, -3.1991], "exp": [1, 1.5, 2.4, 3.9]}
    _liquid_Density={ "eq": 1, "ao": [2.2636, 0.47007, 0.28660], "exp": [0.37, 0.94, 3.1]}
    _vapor_Density={ "eq": 3, "ao": [-3.5136, -7.7491, -24.871, -65.637], "exp": [0.43, 1.4, 3.7, 8]}
    ...
    visco0={"eq": 0, "omega": 1,
                    ...
                    "collision": [0.4425728, -0.5138403, 0.1547566, -0.02821844, 0.001578286]}
