...
class R143a(MEoS):
    """Ecuación de estado de multiparametros para el R143a
    ...
    helmholtz1={
        ...
        "nr1": [0.77736443e1, -0.87018500e1, -0.27779799, 0.14609220, 0.89581616e-2],
        "d1": [1, 1, 1, 2, 5],
        "t1": [0.67, 0.833, 1.7, 1.82, 0.35],

        "nr2": [-0.20552116, 0.10653258, 0.23270816e-1, -0.13247542e-1, -0.42793870e-1, 0.36221685, -0.25671899, -0.92326113e-1, 0.83774837e-1, 0.17128445e-1, -0.17256110e-1, 0.49080492e-2],
    ...
    MBWR={
        ...
        "b": [None, -0.240561786316e-1 , 0.262345913719e1, -0.650858041394e2, 0.995952053681e4, -0.147536464961e7, 0.135498153308e-2, -0.281726617426e1, 0.134371062574e4, 0.850286316514e6, -0.180516636446e-3, 0.618889066246 , -0.223083798271e3, -0.119095922349e-1, -0.173933336877e1, -0.420847601180e3, 0.213502079796, -0.565708555185e-2, 0.185442296800e1, -0.520377059921e-1, -0.846735696108e6 , -0.207964483848e8, -0.349977290513e5, 0.576427827667e9, -0.389131863941e3, 0.103074054089e5, -0.447627052215e1, -0.106673161101e6, -0.219511369081e-1, 0.642186519493e1, -0.938317030843e-4, -0.478594713528e-1, -0.206555883874e1]}
    ...
    helmholtz2={
        ...
        "nr1": [0.1606645e-1, 0.4163515e1, -0.5031058e1, -0.1920208e-1, 0.1470093e-2],
        "d1": [5, 1, 1, 2, 4],
        "t1": [0, 0.5, 0.75, 2.5, 2.5],

        "nr2": [0.1775429, -0.7316069e-2, -0.9555916e-1, -0.5822518, -0.4211022e-3, -0.2059847e-1, 0.3711325e-1, 0.1799723e-3, -0.4145922e-1, 0.7682566e-4, -0.2089695e-2, 0.1958633e-2, -0.3198325e-5, -0.5376561e-2],
    ...
    helmholtz3={
        ...
        "nr1": [0.10306886e1, -0.29497307e1, 0.69435230, 0.71552102e-1, 0.19155982e-3],
        "d1": [1, 1, 1, 3, 7],
        "t1": [0.25, 1.25, 1.5, 0.25, 0.875],

        "nr2": [0.79764936e-1, 0.56859424, -0.90946566e-2, -0.24199452, -0.70610813e-1, -0.75041709e-1, -0.16411241e-1],
        "d2": [1, 2, 5, 1, 1, 4, 2],
    ...
    _vapor_Pressure={ "eq": 5, "ao": [-0.73938e1, 0.19948e1, -0.18487e1, -0.41927e1, 0.14862e1], "exp": [1.0, 1.5, 2.2, 4.8, 6.2]}
    _liquid_Density={ "eq": 1, "ao": [0.21135e1, 0.10200e2, -0.30836e2, 0.39909e2, -0.18557e2], "exp": [0.348, 1.6, 2.0, 2.4, 2.7]}
    _vapor_Density={ "eq": 3, "ao": [-0.28673e1, -0.63818e1, -0.16314e2, -0.45947e2, -0.13956e1, -0.24671e3], "exp": [0.384, 1.17, 3.0, 6.2, 7.0, 15.0]}
