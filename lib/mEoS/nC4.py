...
class nC4(MEoS):
    """Ecuación de estado de multiparametros para el n-butano
    ...
    CP4={  "ao": -1.3491511376e1,
                "an": [3.8802310194e5, -1.5444296890e5, 2.8455082239e3, 6.6142595353e-2, -2.4307965028e-5, 1.5044248429e-10],
                "pow": [-3, -2, -1.001, 1, 2, 3],
    ...
    CP6={  "ao": 0.801601/8.3143*58.124,
                "an": [0.655936e-3/8.3143*58.124, 0.12277e-4/8.3143*58.124, -0.165626e-7/8.3143*58.124, 0.67736e-11/8.3143*58.124],
                "pow": [1, 2, 3, 4],
                "ao_exp": [], "exp": [],
                "ao_hyp": [], "hyp": []}
    ...
    helmholtz1={
        ...
        "nr1":  [0.25536998241635e1, -0.44585951806696e1, 0.82425886369063, 0.11215007011442, -0.35910933680333e-1, 0.16790508518103e-1, 0.32734072508724e-1],
        "d1": [1, 1, 1, 2, 3, 4, 4],
        "t1": [0.50, 1.00, 1.50, 0.00, 0.50, 0.50, 0.75],
        "nr2": [0.95571232982005, -0.10003385753419e1, 0.85581548803855e-1, -0.25147918369616e-1, -0.15202958578918e-2, 0.47060682326420e-2, -0.97845414174006e-1, -0.48317904158760e-1, 0.17841271865468, 0.18173836739334e-1, -0.11399068074953, 0.19329896666669e-1, 0.11575877401010e-2, 0.15253808698116e-3, -0.43688558458471e-1, -0.82403190629989e-2],
    ...
    MBWR={
        ...
        "b": [None, 0.153740104603e-1, -0.160980034611, -0.979782459010e1, 0.499660674504e3, -0.102115607687e7, 0.236032147756e-2, -0.137475757093e1, -0.907038733865e3, 0.385421748213e6, -0.349453710700e-4, 0.157361122714, 0.102301474068e3, 0.182335737331e-1, -0.404114307787e1, 0.187979855783e1, 0.362088795040, -0.738762248266e-2, -0.218618590563e1, 0.118802729027, 0.706854198713e6, -0.219469885796e9, -0.182454361268e5, 0.206790377277e10, 0.111757550145e3, 0.558779925986e5, -0.159579054026e2, -0.148034214622e7, -0.245206328201, 0.218305259309e3, -0.923990627338e-4, -0.205267776639e1, 0.387639044820e2]}
    ...
    GERG={
        ...
        "nr1":  [0.10626277411455e1, -0.28620951828350e1, 0.88738233403777, -0.12570581155345, 0.10286308708106, 0.25358040602654e-3],
        "d1": [1, 1, 1, 2, 3, 7],
        "t1": [0.25, 1.125, 1.5, 1.375, 0.25, 0.875],

        "nr2": [0.32325200233982, -0.37950761057432e-1, -0.32534802014452, -0.79050969051011e-1, -0.20636720547775e-1, 0.57053809334750e-2],
        "d2": [2, 5, 1, 4, 3, 4],
    ...
    helmholtz3={
        ...
        "nr1":  [2.952054e-1, -1.32636, -2.031317e-3, 2.240301e-1, -3.635425e-2, 1.905841e-3, 7.409154e-5, -1.401175e-6],
        "d1": [1, 1, 2, 2, 3, 5, 8, 8],
        "t1": [-0.25, 1.5, -0.75, 0, 1.25, 1.5, 0.5, 2.5],

        "nr2": [-2.492172, 2.386920, 1.424009e-3, -9.393388e-3, 2.616590e-3, -1.977323e-1, -3.809534e-2, 1.523948e-3, -2.391345e-2, -9.535229e-3, 3.928384e-5],
    ...
    helmholtz4={
        ...
        "nr1":  [0.10626277e1, -0.28620952e1, 0.88738233, -0.12570581, 0.10286309, 0.25358041e-3],
        "d1": [1, 1, 1, 2, 3, 7],
        "t1": [0.25, 1.125, 1.5, 1.375, 0.25, 0.875],

        "nr2": [0.323252, -0.37950761e-1, -0.32534802, -0.79050969e-1, -0.20636721e-1, 0.57053809e-2],
        "d2": [2, 5, 1, 4, 3, 4],
        "t2": [0.625, 1.75, 3.625, 3.625, 14.5, 12.],
        "c2": [1, 1, 2, 2, 3, 3],
        "gamma2": [1]*6}
    ...
    helmholtz5={
        ...
        "nr1": [-0.504188295325, 0.541067401063, -0.760421383062e-1, 0.846035653528, -0.191317317203e1, 0.521441860186, -0.783511318207, 0.689697797175e-1, 0.947825461055e-1, -0.141401831669, 0.382675021672, -0.423893176684e-1, 0.677591792029e-1, 0.567943363340e-1, -0.131517698401, 0.221136942526e-1],
        "d1": [0, 0, 0, 1, 1, 1, 1, 1, 2, 2, 2, 3, 3, 4, 4, 5],
        "t1": [3, 4, 5, 0, 1, 2, 3, 4, 0, 1, 2, 0, 1, 0, 1, 1],

        "nr2": [0.504188295325, -0.541067401063, 0.760421383062e-1, -0.619109535460e-1, 0.423035373804, -0.390505508895],
        "d2": [0, 0, 0, 2, 2, 2],
        "t2": [3, 4, 5, 3, 4, 5],
        "c2": [2]*6,
        "gamma2": [1.08974964]*6}
    ...
    _dielectric={"eq": 3, "Tref": 273.16, "rhoref": 1000.,
                            ...
                            "a2": [66.64, 24.44, -7461.2, -1983.6], "expt2": [0, 1, 0, 1], "expd2": [2, 2, 3, 3]}
    _melting={"eq": 1, "Tref": Tt, "Pref": 0.00066566, "a1": [-558558235.4, 558558236.4], "exp1": [0, 2.206], "a2": [], "exp2": [], "a3": [], "exp3": []}
    _surface={"sigma": [0.05418], "exp": [1.26]}
    _vapor_Pressure={ "eq": 5, "ao": [-0.71897e1, 0.26122e1, -0.21729e1, -0.27230e1], "exp": [1, 1.5, 2., 4.5]}
    _liquid_Density={ "eq": 1, "ao": [0.52341e1, -0.62011e1, 0.36063e1, 0.22137], "exp": [0.44, 0.6, 0.76, 5.0]}
    _vapor_Density={ "eq": 3, "ao": [-0.27390e1, -0.57347e1, -0.16408e2, -0.46986e2, -0.10090e3], "exp": [0.39, 1.14, 3.0, 6.5, 14.0]}
    ...
    visco0={"eq": 1, "omega": 1,
                ...
                "t_packed": [0, 0.5],
                "n_poly": [-54.7737770846, 58.0898623034, 0, 35.2658446259, -39.6682203832, 0, -1.83729542151, 0, 0, -0.833262985358, 1.93837020663, 0, -188.075903903],
    ...
    visco1={"eq": 2, "omega": 2,
                ...
                "E": [-0.2724386845e2, 0.8012766611e3, 0.2503978646e2, -0.1309704275e5, -0.8313305258e-1, 0.6636975027e2, 0.9849317662e4],
                "rhoc": 3.920}
    ...
    thermo0={"eq": 1,
                ...
                "nb": [-3.04337e-2, 4.18357e-2, 1.65820e-1, -1.47163e-1, -1.48144e-1, 1.33542e-1, 5.25500e-2, -4.85489e-2, -6.29367e-3, 6.44307e-3],
    ...
    thermo1={"eq": 2, "omega": 2,
                ...
                "E": [0.4024170074e-2, 0.1561435847e1, -0.6004381127e3, -0.7547260841e-3, -0.2069676662e-1, 0.9382534978e2, -0.1711371457, 0.3647724935e2],
