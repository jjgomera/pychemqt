...
class CO(MEoS):
    """Ecuación de estado de multiparametros para el monoxido de carbono
    ...
    CP3={  "ao": 0.36028218e1,
                "an": [-0.20871594e5, 0.89208708e3, -0.14157993e2, -0.34021345e-3, 0.44616091e-6, -0.15154703e-9],
                "pow": [-3, -2, -1.001, 1, 2, 3],
    ...
    GERG={
        ...
        "nr1":  [0.92310041400851, -0.248858452058e1, 0.58095213783396, 0.28859164394654e-1, 0.70256257276544e-1, 0.21687043269488e-3],
        "d1": [1, 1, 1, 2, 3, 7],
        "t1": [0.25, 0.125, 1.5, 1.375, 0.25, 0.875],

        "nr2": [0.13758331015182, -0.51501116343466e-1, -0.14865357483379, -0.38857100886810e-1, -0.29100433948943e-1, 0.14155684466279e-1],
        "d2": [2, 5, 1, 4, 3, 4],
    ...
    _surface={"sigma": [0.0350998, -0.0093076, -0.0017393], "exp": [1.25, 2.25, 3.25]}
    _melting={"eq": 1, "Tref": 1, "Pref": 1000, "a1": [-142.941, 0.0195608], "exp1": [0, 2.10747], "a2": [], "exp2": [], "a3": [], "exp3": []}
    _vapor_Pressure={ "eq": 5, "ao": [-0.61192e1, 0.10411e1, -0.62162e1, 0.10437e2, -0.76813e1], "exp": [1.0, 1.5, 3.9, 4.6, 5.4]}
    _liquid_Density={ "eq": 1, "ao": [0.29570e1, -0.42880e1, 0.87643e1, -0.84001e1, 0.36372e1], "exp": [0.398, 0.735, 1.08, 1.5, 1.9]}
    _vapor_Density={ "eq": 3, "ao": [-0.25439e1, -0.55601e1, -0.85276e1, -0.51163e1, -0.17701e2, -0.29858e2], "exp": [0.395, 1.21, 3.0, 3.5, 6.0, 8.0]}
    ...
    visco0={"eq": 2, "omega": 2,
                ...
                "F": [0, 0, 0, 100.],
                "E": [-8.89560281339404, -507.15174441, 9.03858480666, 5287.58110665, 0.322741446715, -49.2143622937, -23.7275041203],
                "rhoc": 10.85}
    ...
    thermo0={"eq": 1,
                ...
                "nb": [4.57815545028, 62.5180582967, -2.52594417152, -65.0403809001, 4.06956197472, 18.0214260963],
                "tb": [0, 0, 0, -1, 0, -1],
                "db": [1, 3, 4, 4, 5, 5],
                "cb": [0]*6,
