...
class Test(TestCase):
    ...
    def test_mccarty(self):
        ...
        self.assertEqual(round(st.Liquido.rhoM, 3), 23.388)
        self.assertEqual(round(st.Liquido.dpdrho_T.MPakgm3*st.M, 3), 45.926)
        self.assertEqual(round(st.Liquido.dpdT_rho.MPaK, 3), 2.904)
        self.assertEqual(round(st.Liquido.uM.Jmol, 2), 6615.99)
        self.assertEqual(round(st.Liquido.hM.Jmol, 2), 6616.00)
        self.assertEqual(round(st.Liquido.sM.JmolK, 1), 84.4)
        self.assertEqual(round(st.Liquido.cvM.JmolK, 2), 39.48)
        self.assertEqual(round(st.Liquido.cpM.JmolK, 2), 74.38)
        self.assertEqual(round(st.Liquido.w, 0), 1756)
        ...
        self.assertEqual(round(st.Gas.uM.Jmol, 2), 21685.97)
        self.assertEqual(round(st.Gas.hM.Jmol, 2), 22550.46)
        ...
        self.assertEqual(round(st.Liquido.dpdrho_T.MPakgm3*st.M, 3), 47.333)
        self.assertEqual(round(st.Liquido.dpdT_rho.MPaK, 3), 2.133)
        self.assertEqual(round(st.Liquido.uM.Jmol, 2), 8067.87)
        self.assertEqual(round(st.Liquido.hM.Jmol, 2), 8067.99)
        self.assertEqual(round(st.Liquido.sM.JmolK, 1), 97.1)
        self.assertEqual(round(st.Liquido.cvM.JmolK, 2), 43.18)
        self.assertEqual(round(st.Liquido.cpM.JmolK, 2), 67.25)
        self.assertEqual(round(st.Liquido.w, 0), 1621)
        self.assertEqual(round(st.Gas.rhoM, 6), 0.002432)
        self.assertEqual(round(st.Gas.dpdrho_T.MPakgm3*st.M, 3), 1.034)
        self.assertEqual(round(st.Gas.dpdT_rho.MPaK, 3), 0.000)
        self.assertEqual(round(st.Gas.uM.Jmol, 2), 22204.75)
        self.assertEqual(round(st.Gas.hM.Jmol, 2), 23241.56)
        ...
        self.assertEqual(round(st.Liquido.rhoM, 3), 21.201)
        self.assertEqual(round(st.Liquido.dpdrho_T.MPakgm3*st.M, 3), 35.414)
        self.assertEqual(round(st.Liquido.dpdT_rho.MPaK, 3), 1.685)
        self.assertEqual(round(st.Liquido.uM.Jmol, 2), 9738.55)
        self.assertEqual(round(st.Liquido.hM.Jmol, 2), 9739.84)
        self.assertEqual(round(st.Liquido.sM.JmolK, 1), 109.3)
        self.assertEqual(round(st.Liquido.cvM.JmolK, 2), 40.14)
        self.assertEqual(round(st.Liquido.cpM.JmolK, 2), 66.89)
        self.assertEqual(round(st.Liquido.w, 0), 1450)
        self.assertEqual(round(st.Gas.rhoM, 4), 0.0222)
        self.assertEqual(round(st.Gas.dpdrho_T.MPakgm3*st.M, 3), 1.213)
        self.assertEqual(round(st.Gas.dpdT_rho.MPaK, 3), 0.000)
        self.assertEqual(round(st.Gas.uM.Jmol, 2), 22798.72)
        self.assertEqual(round(st.Gas.hM.Jmol, 2), 24029.06)
        ...
        self.assertEqual(round(st.P.MPa, 5), 0.13955)
        self.assertEqual(round(st.Liquido.rhoM, 3), 19.954)
        self.assertEqual(round(st.Liquido.dpdrho_T.MPakgm3*st.M, 3), 24.895)
        self.assertEqual(round(st.Liquido.dpdT_rho.MPaK, 3), 1.315)
        self.assertEqual(round(st.Liquido.uM.Jmol, 2), 11424.24)
        self.assertEqual(round(st.Liquido.hM.Jmol, 2), 11431.23)
        self.assertEqual(round(st.Liquido.sM.JmolK, 1), 119.7)
        self.assertEqual(round(st.Liquido.cvM.JmolK, 2), 37.83)
        self.assertEqual(round(st.Liquido.cpM.JmolK, 2), 68.36)
        self.assertEqual(round(st.Liquido.w, 0), 1266)
        self.assertEqual(round(st.Gas.rhoM, 6), 0.100132)
        self.assertEqual(round(st.Gas.dpdrho_T.MPakgm3*st.M, 3), 1.332)
        self.assertEqual(round(st.Gas.dpdT_rho.MPaK, 3), 0.001)
        self.assertEqual(round(st.Gas.uM.Jmol, 2), 23341.13)
        self.assertEqual(round(st.Gas.hM.Jmol, 2), 24734.82)
        ...
        self.assertEqual(round(st.P.MPa, 4), 1.1276)
        self.assertEqual(round(st.Liquido.rhoM, 3), 17.003)
        self.assertEqual(round(st.Liquido.dpdrho_T.MPakgm3*st.M, 3), 9.958)
        self.assertEqual(round(st.Liquido.dpdT_rho.MPaK, 3), 0.720)
        self.assertEqual(round(st.Liquido.uM.Jmol, 2), 14968.77)
        self.assertEqual(round(st.Liquido.hM.Jmol, 2), 15035.09)
        self.assertEqual(round(st.Liquido.sM.JmolK, 1), 137.5)
        self.assertEqual(round(st.Liquido.cvM.JmolK, 2), 37.13)
        self.assertEqual(round(st.Liquido.cpM.JmolK, 2), 77.64)
        self.assertEqual(round(st.Liquido.w, 0), 861)
        self.assertEqual(round(st.Gas.rhoM, 5), 0.73301)
        self.assertEqual(round(st.Gas.dpdrho_T.MPakgm3*st.M, 3), 1.209)
        self.assertEqual(round(st.Gas.dpdT_rho.MPaK, 3), 0.007)
        self.assertEqual(round(st.Gas.uM.Jmol, 2), 24130.70)
        self.assertEqual(round(st.Gas.hM.Jmol, 2), 25669.02)
        self.assertEqual(round(st.Gas.sM.JmolK, 1), 184.8)
        self.assertEqual(round(st.Gas.cvM.JmolK, 2), 33.20)
        self.assertEqual(round(st.Gas.cpM.JmolK, 2), 52.14)
        self.assertEqual(round(st.Gas.w, 0), 260)

        # Table B-2, pag 81, single phase region
        st = Ethylene(T=150, P=5e4, eq="mccarty")
        self.assertEqual(round(st.rhoM, 3), 21.202)
        self.assertEqual(round(st.dpdrho_T.MPakgm3*st.M, 3), 35.423)
        self.assertEqual(round(st.dpdT_rho.MPaK, 3), 1.685)
        self.assertEqual(round(st.uM.Jmol, 2), 9738.19)
        self.assertEqual(round(st.hM.Jmol, 2), 9740.55)
        self.assertEqual(round(st.sM.JmolK, 1), 109.3)
        self.assertEqual(round(st.cvM.JmolK, 2), 40.14)
        self.assertEqual(round(st.cpM.JmolK, 2), 66.88)
        ...
        self.assertEqual(round(st.uM.Jmol, 2), 27165.86)
        ...
        self.assertEqual(round(st.rhoM, 5), 0.27071)
        self.assertEqual(round(st.dpdrho_T.MPakgm3*st.M, 3), 3.646)
        self.assertEqual(round(st.dpdT_rho.MPaK, 5), 0.00232)
        self.assertEqual(round(st.uM.Jmol, 2), 33363.36)
        self.assertEqual(round(st.hM.Jmol, 2), 37057.29)
        ...
        self.assertEqual(round(st.rhoM, 3), 23.251)
        self.assertEqual(round(st.dpdrho_T.MPakgm3*st.M, 3), 49.238)
        self.assertEqual(round(st.dpdT_rho.MPaK, 2), 2.63)
        self.assertEqual(round(st.uM.Jmol, 2), 6939.75)
        self.assertEqual(round(st.hM.Jmol, 2), 7369.84)
        ...
        self.assertEqual(round(st.w, 0), 1704)
