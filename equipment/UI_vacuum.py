...
class UI_equipment(parents.UI_equip):
    ...
    def __init__(self, entrada=None, parent=None):
        ...
        self.tabWidget.insertTab(1, self.Rendimientos,QtCore.QCoreApplication.translate("equipment", "Rendimientos", None))

        #Cálculo
        gridLayout_Calculo = QtWidgets.QGridLayout(self.tabCalculo)
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtCore.QCoreApplication.translate("equipment", "Tipo de cálculo:", None)), 1, 1, 1, 1)
        self.TipoCalculo=QtWidgets.QComboBox()
        self.TipoCalculo.addItem(QtCore.QCoreApplication.translate("equipment", "Calcular caída de presión", None))
        self.TipoCalculo.addItem(QtCore.QCoreApplication.translate("equipment", "Calcular tiempo de filtración", None))
        self.TipoCalculo.addItem(QtCore.QCoreApplication.translate("equipment", "Calcular número de filtros", None))
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtCore.QCoreApplication.translate("equipment", "Nº de filtros:", None)), 3, 1, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtCore.QCoreApplication.translate("equipment", "Tiempo de filtración:", None)), 4, 1, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtCore.QCoreApplication.translate("equipment", "Pérdida de presión:", None)), 5, 1, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtCore.QCoreApplication.translate("equipment", "Membranas por filtro:", None)), 7, 1, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtCore.QCoreApplication.translate("equipment", "Diametro de membrana:", None)), 8, 1, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtCore.QCoreApplication.translate("equipment", "Area por membrana:", None)), 9, 1, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtCore.QCoreApplication.translate("equipment", "Resistencia filtro:", None)), 7, 4, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtCore.QCoreApplication.translate("equipment", "Resistencia torta:", None)), 8, 4, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtCore.QCoreApplication.translate("equipment", "Filtros en limpieza:", None)), 9, 4, 1, 1)
        ...
        self.groupBox_Calculo = QtWidgets.QGroupBox(QtCore.QCoreApplication.translate("equipment", "Datos calculados", None))
        gridLayout_Calculo.addWidget(self.groupBox_Calculo,11,1,1,5)
        self.gridLayout_1 = QtWidgets.QGridLayout(self.groupBox_Calculo)
        self.gridLayout_1.addWidget(QtWidgets.QLabel(QtCore.QCoreApplication.translate("equipment", "V<sub>gas</sub>:", None)),0,1,1,1)
        self.Vgas=Entrada_con_unidades(unidades.Speed, retornar=False, readOnly=True)
        self.gridLayout_1.addWidget(self.Vgas,0,2,1,1)
        self.gridLayout_1.addWidget(QtWidgets.QLabel(QtCore.QCoreApplication.translate("equipment", "Rendimiento:", None)),1,1,1,1)
        ...
        self.gridLayout_1.addWidget(QtWidgets.QLabel(QtCore.QCoreApplication.translate("equipment", "Superficie:", None)),2,1,1,1)
    ...
    def rellenarTablaRendimientos(self):
        ...
        self.Rendimientos.setHorizontalHeaderLabels([QtCore.QCoreApplication.translate("equipment", "Diámetro, µm", None), QtCore.QCoreApplication.translate("equipment", "Rendimiento", None)])
    ...
    def calculo(self):
        if self.todos_datos():
            if self.Limpieza.value==self.numFiltros.value:
                self.status.setState(5, QtCore.QCoreApplication.translate("equipment", "Todos los filtros en limpieza", None))
            else:
                ...
                self.rellenoSalida()
                if self.rendimientos==[]:
                    self.status.setState(3, QtCore.QCoreApplication.translate("equipment", "Usando rendimiento por defecto", None))
                else:
