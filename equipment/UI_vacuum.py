...
class UI_equipment(parents.UI_equip):
    ...
    def __init__(self, entrada=None, parent=None):
        ...
        self.tabWidget.insertTab(1, self.Rendimientos,QtWidgets.QApplication.translate("equipment", "Rendimientos", None))

        #Cálculo
        gridLayout_Calculo = QtWidgets.QGridLayout(self.tabCalculo)
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("equipment", "Tipo de cálculo:", None)), 1, 1, 1, 1)
        self.TipoCalculo=QtWidgets.QComboBox()
        self.TipoCalculo.addItem(QtWidgets.QApplication.translate("equipment", "Calcular caída de presión", None))
        self.TipoCalculo.addItem(QtWidgets.QApplication.translate("equipment", "Calcular tiempo de filtración", None))
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("equipment", "Tiempo de filtración:", None)), 4, 1, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("equipment", "Pérdida de presión:", None)), 5, 1, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("equipment", "Diametro de membrana:", None)), 8, 1, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("equipment", "Area por membrana:", None)), 9, 1, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("equipment", "Resistencia filtro:", None)), 7, 4, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("equipment", "Resistencia torta:", None)), 8, 4, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("equipment", "Filtros en limpieza:", None)), 9, 4, 1, 1)
        ...
        self.gridLayout_1.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("equipment", "V<sub>gas</sub>:", None)),0,1,1,1)
        self.Vgas=Entrada_con_unidades(unidades.Speed, retornar=False, readOnly=True)
        self.gridLayout_1.addWidget(self.Vgas,0,2,1,1)
        self.gridLayout_1.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("equipment", "Rendimiento:", None)),1,1,1,1)
    ...
    def calculo(self):
        if self.todos_datos():
            if self.Limpieza.value==self.numFiltros.value:
                self.status.setState(5, QtWidgets.QApplication.translate("equipment", "Todos los filtros en limpieza", None))
            else:
                ...
                self.rellenoSalida()
                if self.rendimientos==[]:
                    self.status.setState(3, QtWidgets.QApplication.translate("equipment", "Usando rendimiento por defecto", None))
                else:
