...
class UI_equipment(parents.UI_equip):
    ...
    def __init__(self, entrada=None, parent=None):
        ...
        self.tabWidget.insertTab(1, self.Rendimientos,tr("equipment", "Rendimientos", None))

        #Cálculo
        gridLayout_Calculo = QtWidgets.QGridLayout(self.tabCalculo)
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(tr("equipment", "Tipo de cálculo:", None)), 1, 1, 1, 1)
        self.TipoCalculo=QtWidgets.QComboBox()
        self.TipoCalculo.addItem(tr("equipment", "Calcular caída de presión", None))
        self.TipoCalculo.addItem(tr("equipment", "Calcular tiempo de filtración", None))
        self.TipoCalculo.addItem(tr("equipment", "Calcular número de filtros", None))
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(tr("equipment", "Nº de filtros:", None)), 3, 1, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(tr("equipment", "Tiempo de filtración:", None)), 4, 1, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(tr("equipment", "Pérdida de presión:", None)), 5, 1, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(tr("equipment", "Membranas por filtro:", None)), 7, 1, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(tr("equipment", "Diametro de membrana:", None)), 8, 1, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(tr("equipment", "Area por membrana:", None)), 9, 1, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(tr("equipment", "Resistencia filtro:", None)), 7, 4, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(tr("equipment", "Resistencia torta:", None)), 8, 4, 1, 1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(tr("equipment", "Filtros en limpieza:", None)), 9, 4, 1, 1)
        ...
        self.gridLayout_1.addWidget(QtWidgets.QLabel(tr("equipment", "V<sub>gas</sub>:", None)),0,1,1,1)
        self.Vgas=Entrada_con_unidades(unidades.Speed, retornar=False, readOnly=True)
        self.gridLayout_1.addWidget(self.Vgas,0,2,1,1)
        self.gridLayout_1.addWidget(QtWidgets.QLabel(tr("equipment", "Rendimiento:", None)),1,1,1,1)
        ...
        self.gridLayout_1.addWidget(QtWidgets.QLabel(tr("equipment", "Superficie:", None)),2,1,1,1)
    ...
    def rellenarTablaRendimientos(self):
        ...
        self.Rendimientos.setHorizontalHeaderLabels([tr("equipment", "Diámetro, µm", None), tr("equipment", "Rendimiento", None)])
    ...
    def calculo(self):
        if self.todos_datos():
            if self.Limpieza.value==self.numFiltros.value:
                self.status.setState(5, tr("equipment", "Todos los filtros en limpieza", None))
            else:
                ...
                self.rellenoSalida()
                if self.rendimientos==[]:
                    self.status.setState(3, tr("equipment", "Usando rendimiento por defecto", None))
                else:
