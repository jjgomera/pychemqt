...
class UI_equipment(parents.UI_equip):
    ...
    def __init__(self, entrada=None, parent=None):
        ...
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Material:", None)), 1, 1, 1, 1)
        ...
        self.material.addItem(tr("equipment", "Acero inoxidable 347", None))
        self.material.addItem(tr("equipment", "Niquel", None))
        self.material.addItem(tr("equipment", "Monel", None))
        self.material.addItem(tr("equipment", "Inconel", None))
        self.material.addItem(tr("equipment", "Zirconio", None))
        self.material.addItem(tr("equipment", "Titanio", None))
        self.material.addItem(tr("equipment", "Ladrillo y caucho o ladrillo y acero recubierto de poliester", None))
        self.material.addItem(tr("equipment", "Caucho o acero recubierto de plomo", None))
        self.material.addItem(tr("equipment", "Poliester reforzado con fiberglass", None))
        self.material.addItem(tr("equipment", "Aluminio", None))
        self.material.addItem(tr("equipment", "Cobre", None))
        self.material.addItem(tr("equipment", "Hormigón", None))
        self.material.currentIndexChanged.connect(self.calcularCostos)
        gridLayout_Costos.addWidget(self.material, 1, 2, 1, 4)
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Densidad:", None)), 2, 4, 1, 1)
        self.Densidad=Entrada_con_unidades(unidades.Density, "DenLiq")
        gridLayout_Costos.addWidget(self.Densidad,2,5,1,1)
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Diametro:", None)), 2, 1, 1, 1)
        self.Diametro=Entrada_con_unidades(unidades.Length)
        gridLayout_Costos.addWidget(self.Diametro,2,2,1,1)
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Longitud:", None)), 3, 1, 1, 1)
        self.Longitud=Entrada_con_unidades(unidades.Length)
        gridLayout_Costos.addWidget(self.Longitud,3,2,1,1)
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Espesor:", None)), 4, 1, 1, 1)
        self.Espesor=Entrada_con_unidades(unidades.Length, "Thickness")
        gridLayout_Costos.addWidget(self.Espesor,4,2,1,1)
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Cabeza:", None)), 5, 1, 1, 1)
        self.Cabeza=QtWidgets.QComboBox()
        self.Cabeza.addItem(tr("equipment", "Elipsoidal", None))
        self.Cabeza.addItem(tr("equipment", "Semiesférico", None))
        self.Cabeza.addItem(tr("equipment", "Bumped", None))
        self.Cabeza.addItem(tr("equipment", "Liso", None))
        self.Cabeza.currentIndexChanged.connect(self.calcularCostos)
        gridLayout_Costos.addWidget(self.Cabeza, 5, 2, 1, 1)
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Espesor (cabeza):", None)), 6, 1, 1, 1)
        self.EspesorCabeza=Entrada_con_unidades(unidades.Length, "Thickness")
        gridLayout_Costos.addWidget(self.EspesorCabeza,6,2,1,1)
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Longitud reborde recto:", None)), 7, 1, 1, 1)
        self.LongitudReborde=Entrada_con_unidades(unidades.Length)
        gridLayout_Costos.addWidget(self.LongitudReborde,7,2,1,1)
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Volumen:", None)), 6, 4, 1, 1)
        self.Volumen=Entrada_con_unidades(unidades.Volume, "VolLiq", readOnly=True)
        gridLayout_Costos.addWidget(self.Volumen,6,5,1,1)
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Peso:", None)), 7, 4, 1, 1)
        ...
        self.tabWidget.insertTab(2, self.Salida,tr("equipment", "Salida", None))
