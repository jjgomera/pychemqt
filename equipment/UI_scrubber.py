...
class UI_equipment(UI_equip):
    ...
    def __init__(self, equipment=None, parent=None):
        ...
        self.entrada.addTab(self.entradaGas, QtWidgets.QApplication.translate("equipment", "Gas"))
        ...
        self.entrada.addTab(self.entradaLiquido, QtWidgets.QApplication.translate("pychemqt", "Liquid"))

        # Pestaña calculo
        gridLayout_Calculo = QtWidgets.QGridLayout(self.tabCalculo)
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Mode")),1,1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Method")),2,1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "ΔP method", None)),3,1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Diameter")),5,1)
        ...
        gridLayout_Calculo.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Efficiency")),6,1)
        ...
        JohnstoneLayout.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Ventury Constant")))
        ...
        CalvertLayout.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "f parameter")))
        ...
        LtLayout.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Length throat")))
        ...
        self.groupBox_Calculo = QtWidgets.QGroupBox(QtWidgets.QApplication.translate("pychemqt", "Results"))
        gridLayout_Calculo.addWidget(self.groupBox_Calculo,9,1,1,5)
        gridLayout_1 = QtWidgets.QGridLayout(self.groupBox_Calculo)
        gridLayout_1.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Efficiency")),1,1)
        ...
        gridLayout_1.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "DeltaP")),2,1)
        ...
        self.Salida.addTab(self.SalidaGas,QtWidgets.QApplication.translate("pychemqt", "Clean Gas"))
        self.SalidaLiquido= UI_corriente.Ui_corriente(readOnly=True)
        self.Salida.addTab(self.SalidaLiquido,QtWidgets.QApplication.translate("pychemqt", "Liquid"))
