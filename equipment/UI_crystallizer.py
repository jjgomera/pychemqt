...
class UI_equipment(parents.UI_equip):
    ...
    def __init__(self, entrada=None, parent=None):
        ...
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Tipo:", None)), 1, 1)
        self.tipo=QtWidgets.QComboBox()
        self.tipo.addItem(tr("equipment", "Recirculación externa forzada", None))
        self.tipo.addItem(tr("equipment", "Internos de tubo forzado", None))
        self.tipo.addItem(tr("equipment", "Discontinuos a vacío", None))
        ...
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Material:", None)), 2, 1)
        self.materialvacio=QtWidgets.QComboBox()
        self.materialvacio.addItem(tr("equipment", "Acero dulce", None))
        self.materialvacio.addItem(tr("equipment", "Acero recubierto de caucho", None))
        self.materialvacio.addItem(tr("equipment", "Acero inoxidable 304", None))
        ...
        self.materialotros.addItem(tr("equipment", "Acero dulce", None))
        self.materialotros.addItem(tr("equipment", "Acero inoxidable 304", None))
        self.materialotros.currentIndexChanged.connect(self.calcularCostos)
        gridLayout_Costos.addWidget(self.materialotros, 2, 2, 1, 3)
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Volumen:", None)), 4, 4)
        ...
        self.label4.setText(tr("equipment", "Caudal calculado:", None))
        ...
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Caudal de diseño:", None)), 5, 1)
