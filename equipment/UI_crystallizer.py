...
class UI_equipment(parents.UI_equip):
    ...
    def __init__(self, entrada=None, parent=None):
        ...
        gridLayout_Costos.addWidget(QtWidgets.QLabel(self.tr("Tipo:", None)), 1, 1)
        self.tipo=QtWidgets.QComboBox()
        self.tipo.addItem(self.tr("Recirculación externa forzada", None))
        self.tipo.addItem(self.tr("Internos de tubo forzado", None))
        self.tipo.addItem(self.tr("Discontinuos a vacío", None))
        ...
        gridLayout_Costos.addWidget(QtWidgets.QLabel(self.tr("Material:", None)), 2, 1)
        self.materialvacio=QtWidgets.QComboBox()
        self.materialvacio.addItem(self.tr("Acero dulce", None))
        self.materialvacio.addItem(self.tr("Acero recubierto de caucho", None))
        self.materialvacio.addItem(self.tr("Acero inoxidable 304", None))
        ...
        self.materialotros.addItem(self.tr("Acero dulce", None))
        self.materialotros.addItem(self.tr("Acero inoxidable 304", None))
        self.materialotros.currentIndexChanged.connect(self.calcularCostos)
        gridLayout_Costos.addWidget(self.materialotros, 2, 2, 1, 3)
        gridLayout_Costos.addWidget(QtWidgets.QLabel(self.tr("Volumen:", None)), 4, 4)
        ...
        self.label4.setText(self.tr("Caudal calculado:", None))
        ...
        gridLayout_Costos.addWidget(QtWidgets.QLabel(self.tr("Caudal de diseño:", None)), 5, 1)
