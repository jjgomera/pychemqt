...
#        self.tabWidget.addTab(self.Entrada, tr("equipment", "Entrada", None, QtGui.QApplication.UnicodeUTF8))
        ...
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Proceso:", None)), 1, 1, 1, 1)
        self.proceso=QtWidgets.QComboBox()
        self.proceso.addItem(tr("equipment", "Destilación", None))
        self.proceso.addItem(tr("equipment", "Absorción", None))
        self.proceso.currentIndexChanged.connect(self.calcularCostos)
        gridLayout_Costos.addWidget(self.proceso, 1, 2, 1, 1)
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Tipo de columna:", None)), 2, 1, 1, 1)
        self.tipo=QtWidgets.QComboBox()
        self.tipo.addItem(tr("equipment", "De pisos", None))
        self.tipo.addItem(tr("equipment", "De relleno", None))
        ...
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Material:", None)), 3, 1, 1, 1)
        self.material=QtWidgets.QComboBox()
        self.material.addItem(tr("equipment", "Acero al carbon", None))
        self.material.addItem(tr("equipment", "Acero inoxidable 304", None))
        self.material.addItem(tr("equipment", "Acero inoxidable 316", None))
        self.material.addItem(tr("equipment", "Carpenter 20CB-3", None))
        self.material.addItem(tr("equipment", "Niquel 200", None))
        self.material.addItem(tr("equipment", "Monel 400", None))
        self.material.addItem(tr("equipment", "Inconel 600", None))
        self.material.addItem(tr("equipment", "Incoloy 825", None))
        self.material.addItem(tr("equipment", "Titanio", None))
        ...
        self.groupBox_Pisos = QtWidgets.QGroupBox(tr("equipment", "Torre de pisos", None))
        gridLayout_Costos.addWidget(self.groupBox_Pisos,1,4,4,2)
        gridLayout_1 = QtWidgets.QGridLayout(self.groupBox_Pisos)
        gridLayout_1.addWidget(QtWidgets.QLabel(tr("equipment", "Tipo:", None)), 1, 1, 1, 1)
        self.tipoPisos=QtWidgets.QComboBox()
        self.tipoPisos.addItem(tr("equipment", "De válvula", None))
        self.tipoPisos.addItem(tr("equipment", "De rejilla", None))
        self.tipoPisos.addItem(tr("equipment", "De borboteo", None))
        self.tipoPisos.addItem(tr("equipment", "De tamiz", None))
        self.tipoPisos.currentIndexChanged.connect(self.calcularCostos)
        gridLayout_1.addWidget(self.tipoPisos, 1, 2, 1, 1)
        gridLayout_1.addWidget(QtWidgets.QLabel(tr("equipment", "Material:", None)), 2, 1, 1, 1)
        self.materialPisos=QtWidgets.QComboBox()
        self.materialPisos.addItem(tr("equipment", "Acero al carbon", None))
        self.materialPisos.addItem(tr("equipment", "Acero inoxidable 304", None))
        self.materialPisos.addItem(tr("equipment", "Acero inoxidable 316", None))
        self.materialPisos.addItem(tr("equipment", "Carpenter 20CB-3", None))
        self.materialPisos.addItem(tr("equipment", "Niquel 200", None))
        self.materialPisos.addItem(tr("equipment", "Monel 400", None))
        self.materialPisos.addItem(tr("equipment", "Inconel 600", None))
        self.materialPisos.addItem(tr("equipment", "Incoloy 825", None))
        self.materialPisos.addItem(tr("equipment", "Titanio", None))
        ...
        gridLayout_1.addWidget(QtWidgets.QLabel(tr("equipment", "Diametro:", None)), 4, 1, 1, 1)
        self.diametroPisos=Entrada_con_unidades(unidades.Length)
        gridLayout_1.addWidget(self.diametroPisos,4,2,1,1)
        gridLayout_1.addWidget(QtWidgets.QLabel(tr("equipment", "Número:", None)), 5, 1, 1, 1)
        ...
        self.groupBox_relleno = QtWidgets.QGroupBox(tr("equipment", "Torre de relleno", None))
        gridLayout_Costos.addWidget(self.groupBox_relleno,1, 4, 4, 2)
        gridLayout_2 = QtWidgets.QGridLayout(self.groupBox_relleno)
        gridLayout_2.addWidget(QtWidgets.QLabel(tr("equipment", "Volumen:", None)), 1, 1, 1, 1)
        self.VolumenRelleno=Entrada_con_unidades(unidades.Volume, "VolLiq")
        gridLayout_2.addWidget(self.VolumenRelleno,1,2,1,1)
        gridLayout_2.addWidget(QtWidgets.QLabel(tr("equipment", "Coste unitario:", None)),2,1,1,1)
        ...
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Diametro:", None)),5,1,1,1)
        self.Dc=Entrada_con_unidades(unidades.Length)
        gridLayout_Costos.addWidget(self.Dc,5,2,1,2)
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Altura:", None)), 6, 1, 1, 1)
        self.Hc=Entrada_con_unidades(unidades.Length)
        gridLayout_Costos.addWidget(self.Hc,6,2,1,2)
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Espesor (Tapa):", None)), 7, 1, 1, 1)
        ...
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Espesor (Fondo):", None)), 8, 1, 1, 1)
        ...
        gridLayout_Costos.addWidget(QtWidgets.QLabel(tr("equipment", "Densidad:", None)), 9, 1, 1, 1)
        ...
        gridLayout_5.addWidget(QtWidgets.QLabel(tr("equipment", "Coste Pisos:", None)),0,1,1,1)
        ...
        gridLayout_5.addWidget(QtWidgets.QLabel(tr("equipment", "Coste Carcasa:", None)),1,1,1,1)
        ...
        gridLayout_5.addWidget(QtWidgets.QLabel(tr("equipment", "Coste Accesorios:", None)),2,1,1,1)
        ...
        gridLayout_5.addWidget(QtWidgets.QLabel(tr("equipment", "Coste Columna:", None)),0,4,1,1)
        ...
        gridLayout_5.addWidget(QtWidgets.QLabel(tr("equipment", "Coste Adquisición:", None)),1,4,1,1)
        self.C_adq=Entrada_con_unidades(unidades.Currency, retornar=False, readOnly=True)
        gridLayout_5.addWidget(self.C_adq,1,5,1,1)
        gridLayout_5.addWidget(QtWidgets.QLabel(tr("equipment", "Coste Instalación:", None)),2,4,1,1)
...
#        self.tabWidget.addTab(self.pSalida,tr("equipment", "Salida", None, QtGui.QApplication.UnicodeUTF8))
