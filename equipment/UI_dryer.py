...
class UI_equipment(UI_equip):
    ...
    def __init__(self, equipment=None, parent=None):
        ...
        # Input tab
        self.addEntrada(QtCore.QCoreApplication.translate("pychemqt", "Humid Solid"),
                        "entradaSolido")
        self.addEntrada(QtCore.QCoreApplication.translate("pychemqt", "Air"),
        ...
        lyt.addWidget(QtWidgets.QLabel(
            QtCore.QCoreApplication.translate("pychemqt", "Heat Duty")), 6, 1)
        ...
        lyt.addWidget(QtWidgets.QLabel(
            QtCore.QCoreApplication.translate("pychemqt", "Pressure Drop")), 7, 1)
        ...
        layout.addWidget(QtWidgets.QLabel(
            QtCore.QCoreApplication.translate("pychemqt", "Air Flow")), 2, 1)
        ...
        # Output Tab
        self.addSalida(QtCore.QCoreApplication.translate("pychemqt", "Air"), psychro=True)
        self.addSalida(QtCore.QCoreApplication.translate("pychemqt", "Dry solid"))
