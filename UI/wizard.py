...
class Wizard(QtGui.QWizard):
    ...
    def __init__(self, config=None, parent=None):
        ...
        self.setOptions(QtGui.QWizard.ExtendedWatermarkPixmap |
                        QtGui.QWizard.IndependentPages |
                        QtGui.QWizard.HaveCustomButton1)

        botonAuto = QtGui.QPushButton(
            QtGui.QApplication.translate("pychemqt", "Auto"))
        botonAuto.setToolTip(QtGui.QApplication.translate(
...
#        self.setButtonLayout(layout)
        ...
        page1_welcome.setTitle(QtGui.QApplication.translate("pychemqt",
                                                            "Welcome"))
        page1_welcome.setSubTitle(QtGui.QApplication.translate("pychemqt",
            "That's the configuration wizard of a new project from pychemqt"))
        page1_welcome.setPixmap(QtGui.QWizard.LogoPixmap, QtGui.QPixmap(
            os.environ["pychemqt"]+"/images/pychemqt_98.png"))
        page1_welcome.setPixmap(QtGui.QWizard.WatermarkPixmap, QtGui.QPixmap(
...
<body></html>""")))
        ...
        page2_components.setTitle(QtGui.QApplication.translate(
            "pychemqt", "Define components"))
        page2_components.setSubTitle(QtGui.QApplication.translate(
            "pychemqt", "Add componentes from database"))
        page2_components.setPixmap(QtGui.QWizard.LogoPixmap, QtGui.QPixmap(
            os.environ["pychemqt"]+"/images/pychemqt_98.png"))
        ...
        page4_transport.setTitle(QtGui.QApplication.translate(
        ...
        page5_units.setTitle(QtGui.QApplication.translate(
    ...
    def checkComponents(self, id):
        ...
        if id == 1:
            self.button(QtGui.QWizard.NextButton).setEnabled(len(
