...
class SpinEditor(QtGui.QItemDelegate):
    """Clase que define el spinbos usado para editar índices en tablas """
    def __init__(self, parent=None):
...
class comboLine(QtGui.QComboBox):
    def __init__(self, parent = None):
        ...
        lineas=[os.environ["pychemqt"]+"/images/button/solid_line.png", os.environ["pychemqt"]+"/images/button/dot_line.png", os.environ["pychemqt"]+"/images/button/dash_line.png", os.environ["pychemqt"]+"/images/button/dash_dot_line.png", os.environ["pychemqt"]+"/images/button/dash_dot_dot_line.png"]
        for i in lineas:
