...
class TextEditor(QtGui.QWidget):
    ...
    def __init__(self, texto="", parent=None):
        ...
        self.fontComboBox.setToolTip(QtGui.QApplication.translate("pychemqt", "Font name"))
        ...
        self.FontColor.setToolTip(QtGui.QApplication.translate("pychemqt", "Font color"))
        ...
        self.FontSize.setToolTip(QtGui.QApplication.translate("pychemqt", "Font size"))
        self.FontSize.activated[str].connect(self.PointSize)
        toolbar.addWidget(self.FontSize)

        self.actionNegrita = createAction(icon=os.environ["pychemqt"]+"/images/button/format-text-bold.png", text=QtGui.QApplication.translate("pychemqt", "Bold"), slot=self.Negrita, checkable=True)
        toolbar.addAction(self.actionNegrita)
        self.actionCursiva = createAction(icon=os.environ["pychemqt"]+"/images/button/format-text-italic.png", text=QtGui.QApplication.translate("pychemqt", "Italic"), slot=self.Cursiva, checkable=True)
        toolbar.addAction(self.actionCursiva)
        self.actionSubrayado = createAction(icon=os.environ["pychemqt"]+"/images/button/format-text-underline.png", text=QtGui.QApplication.translate("pychemqt", "Underline"), slot=self.Subrayado, checkable=True)
        toolbar.addAction(self.actionSubrayado)
        self.actionTachado = createAction(icon=os.environ["pychemqt"]+"/images/button/format-text-strikethrough.png", text=QtGui.QApplication.translate("pychemqt", "Strike through"), slot=self.Tachado, checkable=True)
        toolbar.addAction(self.actionTachado)
        self.actionSuperScript = createAction(icon=os.environ["pychemqt"]+"/images/button/font-superscript.png", text=QtGui.QApplication.translate("pychemqt", "Superscript"), slot=self.Superindice, checkable=True)
        toolbar.addAction(self.actionSuperScript)
        self.actionSubScript = createAction(icon=os.environ["pychemqt"]+"/images/button/font-subscript.png", text=QtGui.QApplication.translate("pychemqt", "Subscript"), slot=self.Subindice, checkable=True)
        toolbar.addAction(self.actionSubScript)
        toolbar.addSeparator()
        self.actionAlinearIzquierda = createAction(icon=os.environ["pychemqt"]+"/images/button/format-justify-left.png", text=QtGui.QApplication.translate("pychemqt", "Align left"), slot=self.izquierda, checkable=True)
        toolbar.addAction(self.actionAlinearIzquierda)
        self.actionCentrar = createAction(icon=os.environ["pychemqt"]+"/images/button/format-justify-center.png", text=QtGui.QApplication.translate("pychemqt", "Center"), slot=self.centrar, checkable=True)
        toolbar.addAction(self.actionCentrar)
        self.actionJustificar = createAction(icon=os.environ["pychemqt"]+"/images/button/format-justify-fill.png", text=QtGui.QApplication.translate("pychemqt", "Justify"), slot=self.justificar, checkable=True)
        toolbar.addAction(self.actionJustificar)
        self.actionAlinearDerecha = createAction(icon=os.environ["pychemqt"]+"/images/button/format-justify-right.png", text=QtGui.QApplication.translate("pychemqt", "Align right"), slot=self.derecha, checkable=True)
    ...
    def updateUI(self):
        self.fontComboBox.setCurrentIndex(self.fontComboBox.findText(self.notas.fontFamily()))
        self.FontColor.setPalette(QtGui.QPalette(self.notas.textColor()))
        self.FontSize.setCurrentIndex(self.FontSize.findText(QtCore.QString.number(self.notas.fontPointSize())))
        self.actionNegrita.setChecked(self.notas.fontWeight()==QtGui.QFont.Bold)
        ...
        self.actionAlinearIzquierda.setChecked(self.notas.alignment() == QtCore.Qt.AlignLeft)
        self.actionCentrar.setChecked(self.notas.alignment() == QtCore.Qt.AlignHCenter)
        self.actionJustificar.setChecked(self.notas.alignment() == QtCore.Qt.AlignJustify)
        self.actionAlinearDerecha.setChecked(self.notas.alignment() == QtCore.Qt.AlignRight)
