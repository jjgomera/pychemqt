...
class View_Component(QtWidgets.QDialog):
    ...
    def fill(self, index):
        ...
        self.cpGasDIPPR.fill(self.cmp.capacidad_calorifica_gas)
        self.cpLiquidDIPPR.fill(self.cmp.capacidad_calorifica_liquido)
        self.cpSolidDIPPR.fill(self.cmp.capacidad_calorifica_solido)
        self.RhoSolid.fill(self.cmp.densidad_solido)
        self.RhoLiquid.fill(self.cmp.densidad_liquido)
        self.muLiquid.fill(self.cmp.viscosidad_liquido)
        self.muGas.fill(self.cmp.viscosidad_gas)
        self.Hv.fill(self.cmp.calor_vaporizacion)
        self.PvDIPPR.fill(self.cmp.presion_vapor)
        self.ThermalLiquid.fill(self.cmp.conductividad_liquido)
        self.ThermalGas.fill(self.cmp.conductividad_gas)
        self.SigmaDIPPR.fill(self.cmp.tension_superficial)
