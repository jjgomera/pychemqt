...
class DIPPR_widget(QtWidgets.QGroupBox):
    ...
    def __init__(self, title, indice=0, propiedad="", parent=None):
        ...
        self.buttonPlot.setToolTip(QtWidgets.QApplication.translate("pychemqt", "Plot equation vs temperature"))
        ...
        layout.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "T min")),4,1)
        ...
        layout.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "T max")),5,1)
...
#            self.parent.compuesto.Tc=dialogo.tc.value
            ...
            if ajuste[1] in range(1, 5):
                ...
                aviso=QtWidgets.QMessageBox.warning(self, QtWidgets.QApplication.translate("pychemqt", "Warning"), QtWidgets.QApplication.translate("pychemqt", "Fit unsuccessfully"))
            dialog.exec_()
...
class Parametric_widget(QtWidgets.QGroupBox):
    ...
    def regresion(self):
        dialogo=Entrada_Datos(title=self.title, horizontalHeader=["T, K", QtWidgets.QApplication.translate("pychemqt", "Property")+", "+self.unit], tc=self.imagen=="tensionsuperficial", tcValue=self.parent.tempCritica.value)
        if dialogo.exec_():
            t=dialogo.tabla.getColumn(0, fill=False)
            p=dialogo.tabla.getColumn(1, fill=False)
            self.parent.tempCritica.setValue(dialogo.tc.value)
...
class View_Component(QtWidgets.QDialog):
    ...
    def __init__(self, indice=0, parent=None):
        ...
        if indice == 0:
            self.setWindowTitle(QtWidgets.QApplication.translate("pychemqt", "Define New Component"))
            layoutTitle.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Name")+": ", self))
            ...
            if indice > 1000:
                self.setWindowTitle(QtWidgets.QApplication.translate("pychemqt", "Custom Component Properties"))
            else:
                self.setWindowTitle(QtWidgets.QApplication.translate("pychemqt", "Component Properties"))
            self.buttonFirst=QtWidgets.QToolButton(self)
            self.buttonFirst.setToolTip(QtWidgets.QApplication.translate("pychemqt", "Go to first element"))
            ...
            self.buttonPrevious.setToolTip(QtWidgets.QApplication.translate("pychemqt", "Go to previous element"))
            ...
            self.buttonNext.setToolTip(QtWidgets.QApplication.translate("pychemqt", "Go to next element"))
            ...
            self.buttonLast.setToolTip(QtWidgets.QApplication.translate("pychemqt", "Go to last element"))
        ...
        gridLayout_General.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Formula")),1,1)
        ...
        gridLayout_General.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "CAS Number")),2,1)
        ...
        gridLayout_General.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Alternative Name")),3,1)
        ...
        self.labelFormula2=QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Expanded Formula"))
        ...
        gridLayout_General.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "T critic ")),2,4)
        ...
        gridLayout_General.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "P critic")),3,4)
        ...
        gridLayout_General.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "V critic")),4,4)
        ...
        gridLayout_General.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Acentric factor")),5,4)
        ...
        gridLayout_General.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "SG 60ºF", None)),6,4)
        self.SG = Entrada_con_unidades(float)
        self.SG.valueChanged.connect(self.setDirty)
        gridLayout_General.addWidget(self.SG,6,5)
        gridLayout_General.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Melting Point")),7,4)
        ...
        gridLayout_General.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Boiling Point")),8,4)
        ...
        group_CpGasIdeal = QtWidgets.QGroupBox(QtWidgets.QApplication.translate("pychemqt", "Cp ideal gas")+", cal/mol·K")
        ...
        self.cpLiquidoDIPPR = DIPPR_widget(QtWidgets.QApplication.translate("pychemqt", "Cp liquid DIPPR")+", cal/mol K", indice, "Cp_l", parent=self)
        self.cpLiquidoDIPPR.valueChanged.connect(self.setDirty)
        gridLayout_cp.addWidget(self.cpLiquidoDIPPR,2,1)
        self.cpSolidoDIPPR = DIPPR_widget(QtWidgets.QApplication.translate("pychemqt", "Cp solid DIPPR")+", cal/mol K", indice, "Cp_s", parent=self)
        ...
        self.RhoLiquido = DIPPR_widget(QtWidgets.QApplication.translate("pychemqt", "Liquid Density DIPPR")+", kmol/m^3", indice, "\\rho_l", parent=self)
        ...
        tabWidget.addTab(tab4,QtWidgets.QApplication.translate("pychemqt", "&Viscosity"))
        gridLayout_mu = QtWidgets.QGridLayout(tab4)

        self.muLiquido = DIPPR_widget(QtWidgets.QApplication.translate("pychemqt", "Liquid Viscosity DIPPR")+", Pa s", indice, "\\mu_l", parent=self)
        self.muLiquido.valueChanged.connect(self.setDirty)
        gridLayout_mu.addWidget(self.muLiquido,1,1)
        self.muGas = DIPPR_widget(QtWidgets.QApplication.translate("pychemqt", "Gas Viscosity DIPPR")+", Pa s", indice, "\\mu_g", parent=self)
        self.muGas.valueChanged.connect(self.setDirty)
        gridLayout_mu.addWidget(self.muGas,1,2)
        self.muParametric = Parametric_widget(QtWidgets.QApplication.translate("pychemqt", "Viscosity")+", cP", indice, "\\mu_g", 2, "viscosidad", parent=self)
        ...
        self.boilingHeat = DIPPR_widget(QtWidgets.QApplication.translate("pychemqt", "Heat of vaporization DIPPR")+", J/kmol", indice, "H_v", parent=self)
        self.boilingHeat.valueChanged.connect(self.setDirty)
        gridLayout_vapor.addWidget(self.boilingHeat,1,1)
        self.vaporPressure = DIPPR_widget(QtWidgets.QApplication.translate("pychemqt", "Vapor Pressure DIPPR")+", Pa", indice, "P_v", parent=self)
        self.vaporPressure.valueChanged.connect(self.setDirty)
        gridLayout_vapor.addWidget(self.vaporPressure,1,2)
        self.PvAntoine = Parametric_widget(QtWidgets.QApplication.translate("pychemqt", "Antoine Vapor Pressure")+", mmHg", indice, "P_v", 3, "antoine", parent=self)
        ...
        tabWidget.addTab(tab6,QtWidgets.QApplication.translate("pychemqt", "&Tension && Conductivity"))
        gridLayout_conductividad = QtWidgets.QGridLayout(tab6)

        self.conductivityLiquido = DIPPR_widget(QtWidgets.QApplication.translate("pychemqt", "Liquid Thermal Conductivity DIPPR")+", W/m K", indice, "\\lambda_l", parent=self)
        ...
        self.conductivityGas = DIPPR_widget(QtWidgets.QApplication.translate("pychemqt", "Gas Thermal Conductivity DIPPR")+", W/m K", indice, "\lambda_v", parent=self)
        self.conductivityGas.valueChanged.connect(self.setDirty)
        gridLayout_conductividad.addWidget(self.conductivityGas,1,2)
        self.tension = DIPPR_widget(QtWidgets.QApplication.translate("pychemqt", "Surface Tension DIPPR")+", N/m", indice, "\sigma", parent=self)
        self.tension.valueChanged.connect(self.setDirty)
        gridLayout_conductividad.addWidget(self.tension,2,1)
        self.tensionParametrica = Parametric_widget(QtWidgets.QApplication.translate("pychemqt", "Surface Tension")+", N/m", indice, "\sigma", 2, "tensionsuperficial", parent=self)
        ...
        tabWidget.addTab(tab7,QtWidgets.QApplication.translate("pychemqt", "&Parametrics"))
        gridLayout_Parametricos=QtWidgets.QGridLayout(tab7)

        self.Henry = Parametric_widget(QtWidgets.QApplication.translate("pychemqt", "Henry Costant")+", psia/Xg", indice, "K_H", 4, "henry", parent=self)
        self.Henry.valueChanged.connect(self.setDirty)
        gridLayout_Parametricos.addWidget(self.Henry,1,1,2,1)

        group_MSRK = QtWidgets.QGroupBox(QtWidgets.QApplication.translate("pychemqt", "MSRK Coefficients"))
        ...
        gridLayout_Otros.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Dipole Moment")),2,1)
        ...
        gridLayout_Otros.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Molecular Diameter")),3,1)
        ...
        gridLayout_Otros.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Net calorific value")),4,1)
        ...
        gridLayout_Otros.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Gross calorific value")),5,1)
        ...
        gridLayout_Otros.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Liquid Volume Costant")),6,1)
        ...
        gridLayout_Otros.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "API Gravity")),7,1)
        ...
        gridLayout_Otros.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Modified acentric factor")),8,1)
        ...
        gridLayout_Otros.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "UNIQUAC area")),1,4)
        ...
        gridLayout_Otros.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "UNIQUAC volume")),2,4)
        ...
        gridLayout_Otros.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Watson volume")),3,4)
        ...
        gridLayout_Otros.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Stiehl polar factor")),4,4)
        ...
        gridLayout_Otros.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Rackett constant")),5,4)
        ...
        gridLayout_Otros.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Polar parameter")),6,4)
        ...
        gridLayout_Otros.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Eps/k")),7,4)
        self.EpsK = Entrada_con_unidades(float)
        self.EpsK.valueChanged.connect(self.setDirty)
        gridLayout_Otros.addWidget(self.EpsK,7,5)
        gridLayout_Otros.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Watson factor")),8,4)
        ...
        lyt_electrolitos.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Heat of solution")),1,1)
        self.calorDisolucion = Entrada_con_unidades(unidades.MolarEnthalpy)
        lyt_electrolitos.addWidget(self.calorDisolucion,1,2)
        lyt_electrolitos.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Solubility, 20ºC", None)),2,1)
        ...
        lyt_electrolitos.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Acid-Base Characteristic")),1,4)
        self.tipo_ph = QtWidgets.QComboBox()
        self.tipo_ph.addItem(QtWidgets.QApplication.translate("pychemqt", "Neutral"))
        self.tipo_ph.addItem(QtWidgets.QApplication.translate("pychemqt", "Strong acid"))
        self.tipo_ph.addItem(QtWidgets.QApplication.translate("pychemqt", "Weak acid"))
        self.tipo_ph.addItem(QtWidgets.QApplication.translate("pychemqt", "Strong base"))
        self.tipo_ph.addItem(QtWidgets.QApplication.translate("pychemqt", "Weak base"))
        self.tipo_ph.addItem(QtWidgets.QApplication.translate("pychemqt", "Amphoteric"))
        ...
        lyt_electrolitos.addWidget(QtWidgets.QLabel(QtWidgets.QApplication.translate("pychemqt", "Electrolitic charge")),4,4)
