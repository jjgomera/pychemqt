...
class View_Petro(QtGui.QDialog):
    ...
    def __init__(self, petroleo=None, parent=None):
        ...
        self.setWindowTitle(QtGui.QApplication.translate("pychemqt", "Petrol assay characteristics"))
        layout = QtGui.QGridLayout(self)
        self.nombre=QtGui.QLabel()
        layout.addWidget(self.nombre,1,1,1,5)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Molecular Weight")),2,1)
        self.M=Entrada_con_unidades(float, readOnly=True, textounidad="g/mol")
        layout.addWidget(self.M,2,2)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Boiling Point")),3,1)
        self.Tb=Entrada_con_unidades(unidades.Temperature, readOnly=True)
        layout.addWidget(self.Tb,3,2)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "SG 60ºF", None, QtGui.QApplication.UnicodeUTF8)),4,1)
        self.gravity=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.gravity,4,2)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "API gravity")),5,1)
        self.API=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.API,5,2)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Watson Factor")),6,1)
        self.watson=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.watson,6,2)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Refractive Index")),7,1)
        self.n=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.n,7,2)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Huang Parameter")),8,1)
        self.I=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.I,8,2)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "v100")),9,1)
        self.v100=Entrada_con_unidades(unidades.Diffusivity, readOnly=True)
        layout.addWidget(self.v100,9,2)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "v210")),10,1)
        ...
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Vc")),4,4)
        self.Vc=Entrada_con_unidades(unidades.SpecificVolume, readOnly=True)
        layout.addWidget(self.Vc,4,5)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Zc")),5,4)
        self.Zc=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.Zc,5,5)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Acentric factor")),6,4)
        self.f_acent=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.f_acent,6,5)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Refractivity Intercept")),7,4)
        self.refractivity=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.refractivity,7,5)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "C-H ratio")),8,4)
        self.CH=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.CH,8,5)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "% Sulfur")),9,4)
        self.S=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.S,9,5)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "%H")),10,4)
        self.H=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.H,10,5)

        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "VGC")),2,7)
        self.VGC=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.VGC,2,8)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Cetane index")),3,7)
        self.cetane=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.cetane,3,8)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Pour point")),4,7)
        self.pour=Entrada_con_unidades(unidades.Temperature, readOnly=True)
        layout.addWidget(self.pour,4,8)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Aniline point")),5,7)
        self.aniline=Entrada_con_unidades(unidades.Temperature, readOnly=True)
        layout.addWidget(self.aniline,5,8)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Freezing point")),6,7)
        self.freezing=Entrada_con_unidades(unidades.Temperature, readOnly=True)
        layout.addWidget(self.freezing,6,8)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Cloud point")),7,7)
        self.cloud=Entrada_con_unidades(unidades.Temperature, readOnly=True)
        layout.addWidget(self.cloud,7,8)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Smoke point")),8,7)
        self.smoke=Entrada_con_unidades(unidades.Length, readOnly=True)
        layout.addWidget(self.smoke,8,8)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Flash point (open)")),9,7)
        self.flashOpen=Entrada_con_unidades(unidades.Temperature, readOnly=True)
        layout.addWidget(self.flashOpen,9,8)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Flash point (closed)")),10,7)
        self.flashClosed=Entrada_con_unidades(unidades.Temperature, readOnly=True)
        layout.addWidget(self.flashClosed,10,8)
        
        layout.addItem(QtGui.QSpacerItem(20,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Expanding),15,3,1,1)
        self.boton = QtGui.QDialogButtonBox(QtGui.QDialogButtonBox.Close)
...
class View_Contribution(QtGui.QDialog):
    ...
    def __init__(self, petroleo=None, parent=None):
        ...
        self.setWindowTitle(QtGui.QApplication.translate("pychemqt", "Group Contribution new component"))
        layout = QtGui.QGridLayout(self)
        ...
        self.Tb=Entrada_con_unidades(unidades.Temperature, readOnly=True)
        layout.addWidget(self.Tb,3,2)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Melting Point")),4,1)
        self.Tf=Entrada_con_unidades(unidades.Temperature, readOnly=True)
        layout.addWidget(self.Tf,4,2)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Tc")),5,1)
        self.Tc=Entrada_con_unidades(unidades.Temperature, readOnly=True)
        layout.addWidget(self.Tc,5,2)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Pc")),6,1)
        self.Pc=Entrada_con_unidades(unidades.Pressure, readOnly=True)
        layout.addWidget(self.Pc,6,2)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Vc")),7,1)
        self.Vc=Entrada_con_unidades(unidades.SpecificVolume, readOnly=True)
        layout.addWidget(self.Vc,7,2)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "ΔHf", None, QtGui.QApplication.UnicodeUTF8)),8,1)
        self.Hf=Entrada_con_unidades(unidades.Enthalpy, readOnly=True)
        layout.addWidget(self.Hf,8,2)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "ΔGf", None, QtGui.QApplication.UnicodeUTF8)),9,1)
        self.Gf=Entrada_con_unidades(unidades.Enthalpy, readOnly=True)
        layout.addWidget(self.Gf,9,2)

        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "ΔHm", None, QtGui.QApplication.UnicodeUTF8)),2,4)
        self.Hm=Entrada_con_unidades(unidades.Enthalpy, readOnly=True)
        layout.addWidget(self.Hm,2,5)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "ΔHv", None, QtGui.QApplication.UnicodeUTF8)),3,4)
        self.Hv=Entrada_con_unidades(unidades.Enthalpy, readOnly=True)
        layout.addWidget(self.Hv,3,5)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Cpa")),4,4)
        self.cpa=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.cpa,4,5)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Cpb")),5,4)
        self.cpb=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.cpb,5,5)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Cpc")),6,4)
        self.cpc=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.cpc,6,5)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Cpd")),7,4)
        self.cpd=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.cpd,7,5)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "μa", None, QtGui.QApplication.UnicodeUTF8)),8,4)
        self.mua=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.mua,8,5)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "μb", None, QtGui.QApplication.UnicodeUTF8)),9,4)
        self.mub=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.mub,9,5)

        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "SG 60ºF", None, QtGui.QApplication.UnicodeUTF8)),2,7)
        self.gravity=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.gravity,2,8)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "API gravity")),3,7)
        self.API=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.API,3,8)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Watson Factor")),4,7)
        self.watson=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.watson,4,8)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Acentric factor")),5,7)
        self.f_acent=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.f_acent,5,8)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Rackett")),6,7)
        self.rackett=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.rackett,6,8)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Volume Liquid Constant")),7,7)
        self.Vliq=Entrada_con_unidades(float, readOnly=True)
        layout.addWidget(self.Vliq,7,8)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Solubility Parameter")),8,7)
...
class DIPPR_widget(QtGui.QGroupBox):
    ...
    def __init__(self, title, indice=0, propiedad="", parent=None):
        ...
        layout = QtGui.QGridLayout(self)
        self.buttonRegression = QtGui.QToolButton()
        self.buttonRegression.setToolTip(QtGui.QApplication.translate("pychemqt", "Fit parameters from experimental data"))
        ...
        self.buttonPlot = QtGui.QToolButton()
        self.buttonPlot.setToolTip(QtGui.QApplication.translate("pychemqt", "Plot equation vs temperature"))
        ...
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "T min")),4,1)
        ...
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "T max")),5,1)
        ...
        self.entradas=[]
        for i in range(5):
            layout.addWidget(QtGui.QLabel(txt[i]),1+i,4)
        ...
        layout.addItem(QtGui.QSpacerItem(0,0,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Expanding),6,3)

        self.eq=eqDIPPR(1)
        layout.addWidget(self.eq,0,0,1,6)
        self.eqformula = QtGui.QLabel()
        self.eqformula.setFrameShape(QtGui.QFrame.NoFrame)
        self.eqformula.setFrameShadow(QtGui.QFrame.Plain)
    ...
    def regresion(self):
        dialogo=Entrada_Datos(title=self.title, DIPPR=True, horizontalHeader=["T, K", QtGui.QApplication.translate("pychemqt", "Property")+", "+self.unit], tc=True, tcValue=self.parent.tempCritica.value, t=self.t, property=self.data, eq=self.eq.value())
        if dialogo.exec_():
...
#            self.parent.compuesto.Tc=dialogo.tc.value
            ...
            if ajuste[1] in range(1, 5):
                ...
                aviso=QtGui.QMessageBox.warning(self, QtGui.QApplication.translate("pychemqt", "Warning"), QtGui.QApplication.translate("pychemqt", "Fit unsuccessfully"))
            dialog.exec_()


class Parametric_widget(QtGui.QGroupBox):
    """Clase que define los widgets comunes"""
    valueChanged = QtCore.pyqtSignal()
    def __init__(self, title, indice=0, propiedad="", numero=2, imagen="", parent=None):
        ...
        self.formula.setFrameShape(QtGui.QFrame.NoFrame)
        self.formula.setFrameShadow(QtGui.QFrame.Plain)
        ...
        for i in range(numero):
            ...
            self.entradas[-1].valueChanged.connect(self.valueChanged.emit)
            layout.addWidget(self.entradas[-1],1+i,5)
        layout.addItem(QtGui.QSpacerItem(0,0,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Expanding),2+numero,3)
    ...
    def regresion(self):
        dialogo=Entrada_Datos(title=self.title, horizontalHeader=["T, K", QtGui.QApplication.translate("pychemqt", "Property")+", "+self.unit], tc=self.imagen=="tensionsuperficial", tcValue=self.parent.tempCritica.value)
        if dialogo.exec_():
            t=dialogo.tabla.getColumn(0, fill=False)
            p=dialogo.tabla.getColumn(1, fill=False)
            self.parent.tempCritica.setValue(dialogo.tc.value)
...
class View_Component(QtGui.QDialog):
    ...
    def __init__(self, indice=0, parent=None):
        ...
        if indice == 0:
            self.setWindowTitle(QtGui.QApplication.translate("pychemqt", "Define New Component"))
            layoutTitle.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Name")+": ", self))
            self.nombre = QtGui.QLineEdit(self)
            self.nombre.editingFinished.connect(self.setDirty)
            layoutTitle.addWidget(self.nombre)
            layoutTitle.addItem(QtGui.QSpacerItem(20,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Fixed))
        else:
            if indice > 1000:
                self.setWindowTitle(QtGui.QApplication.translate("pychemqt", "Custom Component Properties"))
            else:
                self.setWindowTitle(QtGui.QApplication.translate("pychemqt", "Component Properties"))
            self.buttonFirst=QtGui.QToolButton(self)
            self.buttonFirst.setToolTip(QtGui.QApplication.translate("pychemqt", "Go to first element"))
            ...
            self.buttonPrevious=QtGui.QToolButton(self)
            self.buttonPrevious.setToolTip(QtGui.QApplication.translate("pychemqt", "Go to previous element"))
            ...
            layoutTitle.addWidget(self.nombre)
            self.buttonNext=QtGui.QToolButton(self)
            self.buttonNext.setToolTip(QtGui.QApplication.translate("pychemqt", "Go to next element"))
            ...
            self.buttonLast=QtGui.QToolButton(self)
            self.buttonLast.setToolTip(QtGui.QApplication.translate("pychemqt", "Go to last element"))
        ...
        self.buttonBox = QtGui.QDialogButtonBox(QtGui.QDialogButtonBox.Discard|QtGui.QDialogButtonBox.Save|QtGui.QDialogButtonBox.Apply|QtGui.QDialogButtonBox.Close)
        self.buttonBox.clicked.connect(self.buttonClicked)
        gridLayout.addWidget(self.buttonBox,3,1,1,3)
        
        #Pestaña general
        tab1 = QtGui.QWidget()
        tabWidget.addTab(tab1,QtGui.QApplication.translate("pychemqt", "&General"))
        gridLayout_General=QtGui.QGridLayout(tab1)
        gridLayout_General.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Formula")),1,1)
        self.formula1 = QtGui.QLineEdit()
        self.formula1.editingFinished.connect(self.setDirty)
        gridLayout_General.addWidget(self.formula1,1,2)
        gridLayout_General.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "CAS Number")),2,1)
        self.CAS_number = QtGui.QLineEdit()
        self.CAS_number.editingFinished.connect(self.setDirty)
        gridLayout_General.addWidget(self.CAS_number,2,2)
        gridLayout_General.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Alternative Name")),3,1)
        self.nombre_alternativo = QtGui.QLineEdit()
        self.nombre_alternativo.editingFinished.connect(self.setDirty)
        gridLayout_General.addWidget(self.nombre_alternativo,3,2)
        
        self.labelSmile=QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Smile Code"))
        gridLayout_General.addWidget(self.labelSmile,4,1,1,1)
        self.smile=QtGui.QLineEdit()
        self.smile.editingFinished.connect(self.setDirty)
        gridLayout_General.addWidget(self.smile,4,2,1,1)
        self.labelFormula2=QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Expanded Formula"))
        gridLayout_General.addWidget(self.labelFormula2,5,1,1,1)
        self.formula2 = QtGui.QLabel()
        self.formula2.setFrameShape(QtGui.QFrame.NoFrame)
        self.formula2.setFrameShadow(QtGui.QFrame.Plain)
        ...
        label_UNIFAC=QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "UNIFAC Groups" ))
        label_UNIFAC.setAlignment(QtCore.Qt.AlignTop)
        gridLayout_General.addWidget(label_UNIFAC,9,1,1,1)
        
        self.UNIFAC=Tabla(2, filas=1, horizontalHeader=[QtGui.QApplication.translate("pychemqt", "Group" ), QtGui.QApplication.translate("pychemqt", "Contribution")], verticalHeader=False, dinamica=True, readOnly=indice)
        ...
        gridLayout_General.addItem(QtGui.QSpacerItem(30,30,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Expanding),9,3,3,1)
        
        gridLayout_General.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Molecular Weight")),1,4)
        ...
        gridLayout_General.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "T critic ")),2,4)
        ...
        gridLayout_General.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "P critic")),3,4)
        ...
        gridLayout_General.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "V critic")),4,4)
        ...
        gridLayout_General.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Acentric factor")),5,4)
        ...
        gridLayout_General.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "SG 60ºF", None, QtGui.QApplication.UnicodeUTF8)),6,4)
        self.SG = Entrada_con_unidades(float)
        self.SG.valueChanged.connect(self.setDirty)
        gridLayout_General.addWidget(self.SG,6,5)
        gridLayout_General.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Melting Point")),7,4)
        ...
        gridLayout_General.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Boiling Point")),8,4)
        ...
        gridLayout_General.addWidget(QtGui.QLabel(u"ΔH<sub>f</sub>"),9,4)
        ...
        gridLayout_General.addWidget(QtGui.QLabel(u"ΔG<sub>f</sub>"),10,4)
        ...
        gridLayout_General.addItem(QtGui.QSpacerItem(20,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Expanding),11,4,1,2)
        gridLayout_General.addItem(QtGui.QSpacerItem(20,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Expanding),13,1,1,6)
        
        
        #pestaña cp
        tab2 = QtGui.QWidget()
        tabWidget.addTab(tab2,QtGui.QApplication.translate("pychemqt", "&Cp"))
        gridLayout_cp = QtGui.QGridLayout(tab2)
        group_CpGasIdeal = QtGui.QGroupBox(QtGui.QApplication.translate("pychemqt", "Cp ideal gas")+u", cal/mol·K")
        gridLayout_cp.addWidget(group_CpGasIdeal,1,1,1,1)
        lyt_cpGasIdeal = QtGui.QGridLayout(group_CpGasIdeal)
        self.eqCpGasIdeal = QtGui.QLabel()
        self.eqCpGasIdeal.setFrameShape(QtGui.QFrame.NoFrame)
        self.eqCpGasIdeal.setFrameShadow(QtGui.QFrame.Plain)
        ...
        lyt_cpGasIdeal.addWidget(QtGui.QLabel("A"),1,1)
        self.cpa = Entrada_con_unidades(float)
        self.cpa.valueChanged.connect(self.setDirty)
        lyt_cpGasIdeal.addWidget(self.cpa,1,2)
        lyt_cpGasIdeal.addWidget(QtGui.QLabel("B"),2,1)
        self.cpb = Entrada_con_unidades(float)
        self.cpb.valueChanged.connect(self.setDirty)
        lyt_cpGasIdeal.addWidget(self.cpb,2,2)
        lyt_cpGasIdeal.addWidget(QtGui.QLabel("C"),3,1)
        self.cpc = Entrada_con_unidades(float)
        self.cpc.valueChanged.connect(self.setDirty)
        lyt_cpGasIdeal.addWidget(self.cpc,3,2)
        lyt_cpGasIdeal.addWidget(QtGui.QLabel("D"),1,4)
        self.cpd = Entrada_con_unidades(float)
        self.cpd.valueChanged.connect(self.setDirty)
        lyt_cpGasIdeal.addWidget(self.cpd,1,5)
        lyt_cpGasIdeal.addWidget(QtGui.QLabel("E"),2,4)
        self.cpe = Entrada_con_unidades(float)
        self.cpe.valueChanged.connect(self.setDirty)
        lyt_cpGasIdeal.addWidget(self.cpe,2,5)
        lyt_cpGasIdeal.addWidget(QtGui.QLabel("F"),3,4)
        self.cpf = Entrada_con_unidades(float)
        self.cpf.valueChanged.connect(self.setDirty)
        lyt_cpGasIdeal.addWidget(self.cpf,3,5)
        lyt_cpGasIdeal.addItem(QtGui.QSpacerItem(0,0,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Expanding),4,1,1,4)
        
        self.cpgasDIPPR = DIPPR_widget(QtGui.QApplication.translate("pychemqt", "Cp ideal gas DIPPR")+", cal/mol K", indice, "Cp_g", parent=self)
        self.cpgasDIPPR.valueChanged.connect(self.setDirty)
        gridLayout_cp.addWidget(self.cpgasDIPPR,1,2)
        self.cpLiquidoDIPPR = DIPPR_widget(QtGui.QApplication.translate("pychemqt", "Cp liquid DIPPR")+", cal/mol K", indice, "Cp_l", parent=self)
        self.cpLiquidoDIPPR.valueChanged.connect(self.setDirty)
        gridLayout_cp.addWidget(self.cpLiquidoDIPPR,2,1)
        self.cpSolidoDIPPR = DIPPR_widget(QtGui.QApplication.translate("pychemqt", "Cp solid DIPPR")+", cal/mol K", indice, "Cp_s", parent=self)
        self.cpSolidoDIPPR.valueChanged.connect(self.setDirty)
        gridLayout_cp.addWidget(self.cpSolidoDIPPR,2,2)
        gridLayout_cp.addItem(QtGui.QSpacerItem(0,0,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Expanding),3,1)


        #pestaña densidad
        tab3 = QtGui.QWidget()
        tabWidget.addTab(tab3,QtGui.QApplication.translate("pychemqt", "&Density"))
        gridLayout_rho = QtGui.QGridLayout(tab3)
        
        self.RhoSolido = DIPPR_widget(QtGui.QApplication.translate("pychemqt", "Solid Density DIPPR")+u", kmol/m^3", indice, "\\rho_s", parent=self)
        self.RhoSolido.valueChanged.connect(self.setDirty)
        gridLayout_rho.addWidget(self.RhoSolido,1,1)
        self.RhoLiquido = DIPPR_widget(QtGui.QApplication.translate("pychemqt", "Liquid Density DIPPR")+u", kmol/m^3", indice, "\\rho_l", parent=self)
        self.RhoLiquido.valueChanged.connect(self.setDirty)
        gridLayout_rho.addWidget(self.RhoLiquido,1,2)
        gridLayout_rho.addItem(QtGui.QSpacerItem(20,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Expanding),2,1)


        #Pestaña viscosidad
        tab4 = QtGui.QWidget()
        tabWidget.addTab(tab4,QtGui.QApplication.translate("pychemqt", "&Viscosity"))
        gridLayout_mu = QtGui.QGridLayout(tab4)

        self.muLiquido = DIPPR_widget(QtGui.QApplication.translate("pychemqt", "Liquid Viscosity DIPPR")+", Pa s", indice, "\\mu_l", parent=self)
        self.muLiquido.valueChanged.connect(self.setDirty)
        gridLayout_mu.addWidget(self.muLiquido,1,1)
        self.muGas = DIPPR_widget(QtGui.QApplication.translate("pychemqt", "Gas Viscosity DIPPR")+", Pa s", indice, "\\mu_g", parent=self)
        self.muGas.valueChanged.connect(self.setDirty)
        gridLayout_mu.addWidget(self.muGas,1,2)
        self.muParametric = Parametric_widget(QtGui.QApplication.translate("pychemqt", "Viscosity")+", cP", indice, "\\mu_g", 2, "viscosidad", parent=self)
        self.muParametric.valueChanged.connect(self.setDirty)
        gridLayout_mu.addWidget(self.muParametric,2,1)
        gridLayout_mu.addItem(QtGui.QSpacerItem(20,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Expanding),3,1)

        
        #Pestaña Pv, Hv
        tab5 = QtGui.QWidget()
        tabWidget.addTab(tab5,QtGui.QApplication.translate("pychemqt", "P&v && Hv"))
        gridLayout_vapor = QtGui.QGridLayout(tab5)

        self.boilingHeat = DIPPR_widget(QtGui.QApplication.translate("pychemqt", "Heat of vaporization DIPPR")+", J/kmol", indice, "H_v", parent=self)
        self.boilingHeat.valueChanged.connect(self.setDirty)
        gridLayout_vapor.addWidget(self.boilingHeat,1,1)
        self.vaporPressure = DIPPR_widget(QtGui.QApplication.translate("pychemqt", "Vapor Pressure DIPPR")+", Pa", indice, "P_v", parent=self)
        self.vaporPressure.valueChanged.connect(self.setDirty)
        gridLayout_vapor.addWidget(self.vaporPressure,1,2)
        self.PvAntoine = Parametric_widget(QtGui.QApplication.translate("pychemqt", "Antoine Vapor Pressure")+", mmHg", indice, "P_v", 3, "antoine", parent=self)
        self.PvAntoine.valueChanged.connect(self.setDirty)
        gridLayout_vapor.addWidget(self.PvAntoine,2,1)
        gridLayout_vapor.addItem(QtGui.QSpacerItem(20,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Expanding),3,1)


        #Pestaña conductividad térmica y tension
        tab6 = QtGui.QWidget()
        tabWidget.addTab(tab6,QtGui.QApplication.translate("pychemqt", "&Tension && Conductivity"))
        gridLayout_conductividad = QtGui.QGridLayout(tab6)

        self.conductivityLiquido = DIPPR_widget(QtGui.QApplication.translate("pychemqt", "Liquid Thermal Conductivity DIPPR")+", W/m K", indice, "\\lambda_l", parent=self)
        ...
        self.conductivityGas = DIPPR_widget(QtGui.QApplication.translate("pychemqt", "Gas Thermal Conductivity DIPPR")+", W/m K", indice, "\lambda_v", parent=self)
        self.conductivityGas.valueChanged.connect(self.setDirty)
        gridLayout_conductividad.addWidget(self.conductivityGas,1,2)
        self.tension = DIPPR_widget(QtGui.QApplication.translate("pychemqt", "Surface Tension DIPPR")+", N/m", indice, "\sigma", parent=self)
        self.tension.valueChanged.connect(self.setDirty)
        gridLayout_conductividad.addWidget(self.tension,2,1)
        self.tensionParametrica = Parametric_widget(QtGui.QApplication.translate("pychemqt", "Surface Tension")+", N/m", indice, "\sigma", 2, "tensionsuperficial", parent=self)
        self.tensionParametrica.valueChanged.connect(self.setDirty)
        gridLayout_conductividad.addWidget(self.tensionParametrica,2,2)
        gridLayout_conductividad.addItem(QtGui.QSpacerItem(20,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Expanding),3,1)

        #Pestaña parametricos
        tab7 = QtGui.QWidget()
        tabWidget.addTab(tab7,QtGui.QApplication.translate("pychemqt", "&Parametrics"))
        gridLayout_Parametricos=QtGui.QGridLayout(tab7)

        self.Henry = Parametric_widget(QtGui.QApplication.translate("pychemqt", "Henry Costant")+", psia/Xg", indice, "K_H", 4, "henry", parent=self)
        self.Henry.valueChanged.connect(self.setDirty)
        gridLayout_Parametricos.addWidget(self.Henry,1,1,2,1)

        group_MSRK = QtGui.QGroupBox(QtGui.QApplication.translate("pychemqt", "MSRK Coefficients"))
        gridLayout_Parametricos.addWidget(group_MSRK,1,2)
        lyt_MSRK = QtGui.QGridLayout(group_MSRK)
        lyt_MSRK.addWidget(QtGui.QLabel("A"),1,1)
        self.MSRKa = Entrada_con_unidades(float)
        self.MSRKa.valueChanged.connect(self.setDirty)
        lyt_MSRK.addWidget(self.MSRKa,1,2)
        lyt_MSRK.addWidget(QtGui.QLabel("B"),2,1)
        self.MSRKb = Entrada_con_unidades(float)
        self.MSRKb.valueChanged.connect(self.setDirty)
        lyt_MSRK.addWidget(self.MSRKb,2,2)
        gridLayout_Parametricos.addItem(QtGui.QSpacerItem(20,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Fixed),1,3)
        gridLayout_Parametricos.addItem(QtGui.QSpacerItem(20,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Expanding),3,1)


        #Pestaña otras
        tab8 = QtGui.QWidget()
        tabWidget.addTab(tab8,QtGui.QApplication.translate("pychemqt", "&Others"))
        gridLayout_Otros=QtGui.QGridLayout(tab8)
                
        gridLayout_Otros.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Solubility Parameter")),1,1)
        ...
        gridLayout_Otros.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Dipole Moment")),2,1)
        ...
        gridLayout_Otros.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Molecular Diameter")),3,1)
        self.diametroMolecular = Entrada_con_unidades(float, textounidad=u"Å")
        self.diametroMolecular.valueChanged.connect(self.setDirty)
        gridLayout_Otros.addWidget(self.diametroMolecular,3,2)
        gridLayout_Otros.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Net calorific value")),4,1)
        ...
        gridLayout_Otros.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Gross calorific value")),5,1)
        ...
        gridLayout_Otros.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Liquid Volume Costant")),6,1)
        ...
        gridLayout_Otros.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "API Gravity")),7,1)
        ...
        gridLayout_Otros.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Modified acentric factor")),8,1)
        ...
        gridLayout_Otros.addItem(QtGui.QSpacerItem(20,20,QtGui.QSizePolicy.Fixed,QtGui.QSizePolicy.Fixed),1,3)
        gridLayout_Otros.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "UNIQUAC area")),1,4)
        ...
        gridLayout_Otros.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "UNIQUAC volume")),2,4)
        ...
        gridLayout_Otros.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Watson volume")),3,4)
        ...
        gridLayout_Otros.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Stiehl polar factor")),4,4)
        ...
        gridLayout_Otros.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Rackett constant")),5,4)
        ...
        gridLayout_Otros.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Polar parameter")),6,4)
        ...
        gridLayout_Otros.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Eps/k")),7,4)
        self.EpsK = Entrada_con_unidades(float)
        self.EpsK.valueChanged.connect(self.setDirty)
        gridLayout_Otros.addWidget(self.EpsK,7,5)
        gridLayout_Otros.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Watson factor")),8,4)
        ...
        gridLayout_Otros.addItem(QtGui.QSpacerItem(20,20,QtGui.QSizePolicy.Fixed,QtGui.QSizePolicy.Fixed),9,1)
        
        group_electrolitos = QtGui.QGroupBox(QtGui.QApplication.translate("pychemqt", "Electrolitics properties"))
        gridLayout_Otros.addWidget(group_electrolitos,10,1,1,5)
        lyt_electrolitos=QtGui.QGridLayout(group_electrolitos)
        lyt_electrolitos.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Heat of solution")),1,1)
        self.calorDisolucion = Entrada_con_unidades(unidades.MolarEnthalpy)
        lyt_electrolitos.addWidget(self.calorDisolucion,1,2)
        lyt_electrolitos.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Solubility, 20ºC", None, QtGui.QApplication.UnicodeUTF8)),2,1)
        self.solubilidad = Entrada_con_unidades(float, textounidad="%pp")
        lyt_electrolitos.addWidget(self.solubilidad,2,2)
        lyt_electrolitos.addItem(QtGui.QSpacerItem(20,20,QtGui.QSizePolicy.Fixed,QtGui.QSizePolicy.Fixed),1,3)
        lyt_electrolitos.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Acid-Base Characteristic")),1,4)
        self.tipo_ph = QtGui.QComboBox()
        self.tipo_ph.addItem(QtGui.QApplication.translate("pychemqt", "Neutral"))
        self.tipo_ph.addItem(QtGui.QApplication.translate("pychemqt", "Strong acid"))
        self.tipo_ph.addItem(QtGui.QApplication.translate("pychemqt", "Weak acid"))
        self.tipo_ph.addItem(QtGui.QApplication.translate("pychemqt", "Strong base"))
        self.tipo_ph.addItem(QtGui.QApplication.translate("pychemqt", "Weak base"))
        self.tipo_ph.addItem(QtGui.QApplication.translate("pychemqt", "Amphoteric"))
        lyt_electrolitos.addWidget(self.tipo_ph,1,5)
        lyt_electrolitos.addWidget(QtGui.QLabel("pKa"),2,4)
        self.pka = Entrada_con_unidades(float)
        lyt_electrolitos.addWidget(self.pka,2,5)
        lyt_electrolitos.addWidget(QtGui.QLabel("pKb"),3,4)
        self.pkb = Entrada_con_unidades(float)
        lyt_electrolitos.addWidget(self.pkb,3,5)
        lyt_electrolitos.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Electrolitic charge")),4,4)
        self.cargaElectrolitica = Entrada_con_unidades(float)
        lyt_electrolitos.addWidget(self.cargaElectrolitica,4,5)
        gridLayout_Otros.addItem(QtGui.QSpacerItem(20,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Expanding),11,1)
    ...
    def change(self, indice):            
        ...
        if indice == 0:
            self.buttonBox.button(QtGui.QDialogButtonBox.Discard).setVisible(True)
            self.buttonBox.button(QtGui.QDialogButtonBox.Save).setVisible(True)
            self.buttonBox.button(QtGui.QDialogButtonBox.Apply).setVisible(False)
            self.buttonBox.button(QtGui.QDialogButtonBox.Close).setVisible(False)
        elif indice < 1000:
            self.buttonBox.button(QtGui.QDialogButtonBox.Discard).setVisible(False)
            self.buttonBox.button(QtGui.QDialogButtonBox.Save).setVisible(False)
            self.buttonBox.button(QtGui.QDialogButtonBox.Apply).setVisible(False)
            self.buttonBox.button(QtGui.QDialogButtonBox.Close).setVisible(True)
        else:
            self.buttonBox.button(QtGui.QDialogButtonBox.Discard).setVisible(True)
            self.buttonBox.button(QtGui.QDialogButtonBox.Save).setVisible(False)
            self.buttonBox.button(QtGui.QDialogButtonBox.Apply).setVisible(True)
            self.buttonBox.button(QtGui.QDialogButtonBox.Close).setVisible(False)
    ...
    def rellenar(self, indice):
        ...
        if self.compuesto.UNIFAC!=[]:
            ...
            for i in range(len(self.compuesto.UNIFAC)):
                ...
                self.UNIFAC.setItem(i, 0, QtGui.QTableWidgetItem(str(self.compuesto.UNIFAC[i][0])))
                self.UNIFAC.setItem(i, 1, QtGui.QTableWidgetItem(str(self.compuesto.UNIFAC[i][1])))
    ...
    def buttonClicked(self, boton):
        ...
        if role==QtGui.QDialogButtonBox.AcceptRole:
            ...
            self.accept()
        elif role==QtGui.QDialogButtonBox.DestructiveRole:
            componente=self.getComponent()
            if self.indice==0:
