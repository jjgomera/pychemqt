...
class UI_confTransport_widget(QtGui.QWidget):
    def __init__(self, config=None, parent=None):
        ...
        layout.addWidget( QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Liquid Density:")),1,0)
        ...
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Liquid Viscosity:")),2,0)
        ...
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Gas Viscosity:")),3,0)
        ...
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Surface Tension:")),4,0)
        ...
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Liquid Thermal Conductivity:")),5,0)
        self.ThCondL = QtGui.QComboBox()
        self.ThCondL.addItem("DIPPR")
        self.ThCondL.addItem("Pachaiyappan")
        layout.addWidget(self.ThCondL,5,1)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Gas Thermal Conductivity:")),6,0)
        self.ThCondG = QtGui.QComboBox()
        self.ThCondG.addItem("DIPPR")
        self.ThCondG.addItem("Misic & Thodos")
        layout.addWidget(self.ThCondG,6,1)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Vapor Pressure:")),7,0)
        ...
        self.label_7.setText(QtGui.QApplication.translate("pychemqt", "High Pressure Corrections"))
        layout.addWidget(self.label_7,0,3)
        ...
        layout.addItem(QtGui.QSpacerItem(40,20,QtGui.QSizePolicy.Expanding,QtGui.QSizePolicy.Expanding),8,0,1,10)
...
class Dialog(QtGui.QDialog):
    def __init__(self, config, parent=None):
        ...
        self.setWindowTitle(QtGui.QApplication.translate("pychemqt", "Transport Properties Methods"))
