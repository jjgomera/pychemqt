...
class UI_confThermo_widget(QtGui.QWidget):
    def __init__(self, config=None, parent=None):
        ...
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "K values:")),0,0,1,2)
        self.K = QtGui.QComboBox()
        for eq in K:
            self.K.addItem(eq.__title__)
        layout.addWidget(self.K,0,2)
        
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Alfa function:")),1,0,1,2)
        ...
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Mix rules:")),2,0,1,2)
        ...
        layout.addItem(QtGui.QSpacerItem(20,20,QtGui.QSizePolicy.Fixed,QtGui.QSizePolicy.Fixed),3,0,1,4)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Enthalpy:")),4,0,1,2)
        self.H = QtGui.QComboBox()
        for h in H:
            self.H.addItem(h.__title__)
        layout.addWidget(self.H,4,2)
        layout.addWidget(QtGui.QLabel(QtGui.QApplication.translate("pychemqt", "Ideal heat capacity:")),5,0,1,2)
        ...
        layout.addItem(QtGui.QSpacerItem(20,20,QtGui.QSizePolicy.Fixed,QtGui.QSizePolicy.Fixed),6,0,1,4)
        self.MEoS=QtGui.QCheckBox(QtGui.QApplication.translate("pychemqt", "Use MEoS for single compounds if it's available"))
        ...
        self.GERG=QtGui.QCheckBox(QtGui.QApplication.translate("pychemqt", "Use GERG EoS for mix if it's posible"))
...
class Dialog(QtGui.QDialog):
    def __init__(self, config=None, parent=None):
        ...
        self.setWindowTitle(QtGui.QApplication.translate("pychemqt", "Define project thermodynamic methods"))
