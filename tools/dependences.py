...
class ShowDependences(QtGui.QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowIcon(QtGui.QIcon(QtGui.QPixmap(os.environ["pychemqt"]+"/images/button/showPrograms.png")))
        self.setWindowTitle(QtGui.QApplication.translate("pychemqt", "External program"))
        layout = QtGui.QVBoxLayout(self)
        self.tree=QtGui.QTreeWidget()
        header=QtGui.QTreeWidgetItem([QtGui.QApplication.translate("pychemqt", "Module"), QtGui.QApplication.translate("pychemqt", "Status")])
