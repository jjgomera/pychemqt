...
class CostData(QtWidgets.QWidget):
    ...
    def __init__(self, equipment, parent=None):
        ...
        gridLayout.addWidget(QtWidgets.QLabel(
            self.tr("Instalation factor:")), 2, 0)
        ...
        gridLayout.addWidget(QtWidgets.QLabel(self.tr("Base index:")), 2, 4)
        ...
        gridLayout.addWidget(QtWidgets.QLabel(self.tr("Current index:")), 3, 4)
